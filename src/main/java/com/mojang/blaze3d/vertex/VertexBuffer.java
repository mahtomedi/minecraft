...
public class VertexBuffer implements AutoCloseable {
    ...
    public VertexBuffer(VertexBuffer.Usage param0) {
        this.usage = param0;
    ...
    private VertexFormat uploadVertexBuffer(BufferBuilder.DrawState param0, @Nullable ByteBuffer param1) {
        boolean var0 = false;
        ...
        if (param1 != null) {
            ...
            RenderSystem.glBufferData(34962, param1, this.usage.id);
        }
    ...
    @Nullable
    private RenderSystem.AutoStorageIndexBuffer uploadIndexBuffer(BufferBuilder.DrawState param0, @Nullable ByteBuffer param1) {
        if (param1 != null) {
            GlStateManager._glBindBuffer(34963, this.indexBufferId);
            RenderSystem.glBufferData(34963, param1, this.usage.id);
            return null;
        } else {
    ...
    private void _drawWithShader(Matrix4f param0, Matrix4f param1, ShaderInstance param2) {
        ...
        if (param2.GLINT_ALPHA != null) {
            param2.GLINT_ALPHA.set(RenderSystem.getShaderGlintAlpha());
        }
