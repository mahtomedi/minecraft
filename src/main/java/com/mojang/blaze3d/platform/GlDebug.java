...
public class GlDebug {
    ...
    private static String sourceToString(int param0) {
        switch(param0) {
            case 33350:
                return "API";
            case 33351:
    ...
    private static String typeToString(int param0) {
        switch(param0) {
            case 33356:
                return "ERROR";
            case 33357:
    ...
    private static String severityToString(int param0) {
        switch(param0) {
            case 33387:
                return "NOTIFICATION";
            case 37190:
    ...
    private static void setup(int param0, String param1) {
        BY_ID.merge(param0, param1, (param0x, param1x) -> param0x + "/" + param1x);
    }
