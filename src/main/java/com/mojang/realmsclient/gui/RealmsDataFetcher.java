    ...
    public RealmsDataFetcher(RealmsClient param0) {
        this.serverListUpdateTask = this.dataFetcher
            .createTask(
                "server list",
                () -> {
                    com.mojang.realmsclient.dto.RealmsServerList var0 = param0.listWorlds();
                    return RealmsMainScreen.isSnapshot()
                        ? new RealmsDataFetcher.ServerListData(var0.servers, param0.listSnapshotEligibleRealms())
                        : new RealmsDataFetcher.ServerListData(var0.servers, List.of());
                },
