...
public class RealmsSlotOptionsScreen extends RealmsScreen {
    ...
    public void init() {
        ...
        if (this.worldType.equals(RealmsServer.WorldType.NORMAL)) {
            ...
            if (this.worldType.equals(RealmsServer.WorldType.ADVENTUREMAP)) {
                var0 = getLocalizedString("mco.configure.world.edit.subscreen.adventuremap");
            } else if (this.worldType.equals(RealmsServer.WorldType.INSPIRATION)) {
                var0 = getLocalizedString("mco.configure.world.edit.subscreen.inspiration");
            } else {
                var0 = getLocalizedString("mco.configure.world.edit.subscreen.experience");
            }
    ...
    private String difficultyTitle() {
        String var0 = getLocalizedString("options.difficulty");
        return var0 + ": " + this.difficulties[this.difficultyIndex];
    }

    private String gameModeTitle() {
        String var0 = getLocalizedString("selectWorld.gameMode");
        return var0 + ": " + this.gameModes[this.gameModeIndex];
    }
    ...
    public void render(int param0, int param1, float param2) {
        ...
        String var0 = getLocalizedString("mco.configure.world.edit.slot.name");
        this.drawString(var0, this.column1_x + this.column_width / 2 - this.fontWidth(var0) / 2, RealmsConstants.row(0) - 5, 16777215);
    ...
    class SettingsSlider extends RealmsSliderButton {
        public SettingsSlider(int param0, int param1, int param2, int param3, int param4, float param5, float param6) {
            super(param0, param1, param2, param3, param4, (double)param5, (double)param6);
        }
