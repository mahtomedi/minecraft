...
public class RealmsCreateTrialScreen extends RealmsScreen {
    ...
    public RealmsCreateTrialScreen(RealmsMainScreen param0) {
    ...
    private void createWorld() {
        if (this.valid()) {
            RealmsTasks.TrialCreationTask var0 = new RealmsTasks.TrialCreationTask(this.nameBox.getValue(), this.descriptionBox.getValue(), this.lastScreen);
