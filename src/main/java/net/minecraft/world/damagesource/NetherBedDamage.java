...
public class NetherBedDamage extends DamageSource {
    ...
    public Component getLocalizedDeathMessage(LivingEntity param0) {
        Component var0 = ComponentUtils.wrapInSquareBrackets(new TranslatableComponent("death.attack.netherBed.link"))
            .withStyle(
        ...
        return new TranslatableComponent("death.attack.netherBed.message", param0.getDisplayName(), var0);
    }
}
