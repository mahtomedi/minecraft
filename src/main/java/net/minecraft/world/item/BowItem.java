...
public class BowItem extends ProjectileWeaponItem implements Vanishable {
    ...
    public void releaseUsing(ItemStack param0, Level param1, LivingEntity param2, int param3) {
        if (param2 instanceof Player) {
            ...
            boolean var1 = var0.abilities.instabuild || EnchantmentHelper.getItemEnchantmentLevel(Enchantments.INFINITY_ARROWS, param0) > 0;
            ...
            if (!var2.isEmpty() || var1) {
                ...
                if (!((double)var4 < 0.1)) {
                    boolean var5 = var1 && var2.getItem() == Items.ARROW;
                    if (!param1.isClientSide) {
                        ...
                        if (var5 || var0.abilities.instabuild && (var2.getItem() == Items.SPECTRAL_ARROW || var2.getItem() == Items.TIPPED_ARROW)) {
                    ...
                    param1.playSound(
                        ...
                        SoundSource.PLAYERS,
                        1.0F,
                        1.0F / (random.nextFloat() * 0.4F + 1.2F) + var4 * 0.5F
                    );
                    if (!var5 && !var0.abilities.instabuild) {
                        var2.shrink(1);
                        if (var2.isEmpty()) {
                            var0.inventory.removeItem(var2);
                        }
                    }
