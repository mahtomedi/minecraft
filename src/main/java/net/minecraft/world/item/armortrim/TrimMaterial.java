...
public record TrimMaterial(
    ...
    public static final Codec<TrimMaterial> DIRECT_CODEC = RecordCodecBuilder.create(
        param0 -> param0.group(
                ...
                .apply(param0, TrimMaterial::new)
    );
    public static final Codec<Holder<TrimMaterial>> CODEC = RegistryFileCodec.create(Registries.TRIM_MATERIAL, DIRECT_CODEC);

    public static TrimMaterial create(String param0, Item param1, float param2, Component param3, Map<ArmorMaterials, String> param4) {
        return new TrimMaterial(param0, BuiltInRegistries.ITEM.wrapAsHolder(param1), param2, param4, param3);
    }
}
