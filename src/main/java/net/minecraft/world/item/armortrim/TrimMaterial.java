...
public record TrimMaterial(
    ...
    public static TrimMaterial create(String param0, Item param1, float param2, Optional<ArmorMaterials> param3, Component param4) {
        return new TrimMaterial(param0, BuiltInRegistries.ITEM.wrapAsHolder(param1), param2, param3, param4);
    }
}
