...
public class BundleItem extends Item {
    ...
    private void playRemoveOneSound(Entity param0) {
        param0.playSound(SoundEvents.BUNDLE_REMOVE_ONE, 0.8F, 0.8F + param0.level().getRandom().nextFloat() * 0.4F);
    }

    private void playInsertSound(Entity param0) {
        param0.playSound(SoundEvents.BUNDLE_INSERT, 0.8F, 0.8F + param0.level().getRandom().nextFloat() * 0.4F);
    }

    private void playDropContentsSound(Entity param0) {
        param0.playSound(SoundEvents.BUNDLE_DROP_CONTENTS, 0.8F, 0.8F + param0.level().getRandom().nextFloat() * 0.4F);
    }
}
