...
public class CreativeModeTabs {
    ...
    private static final CreativeModeTab INGREDIENTS = CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3)
        ...
        .displayItems((param0, param1) -> {
            ...
            param1.accept(Items.ANGLER_POTTERY_SHARD);
            param1.accept(Items.ARCHER_POTTERY_SHARD);
            param1.accept(Items.ARMS_UP_POTTERY_SHARD);
            param1.accept(Items.BLADE_POTTERY_SHARD);
            param1.accept(Items.BREWER_POTTERY_SHARD);
            param1.accept(Items.BURN_POTTERY_SHARD);
            param1.accept(Items.DANGER_POTTERY_SHARD);
            param1.accept(Items.EXPLORER_POTTERY_SHARD);
            param1.accept(Items.FRIEND_POTTERY_SHARD);
            param1.accept(Items.HEART_POTTERY_SHARD);
            param1.accept(Items.HEARTBREAK_POTTERY_SHARD);
            param1.accept(Items.HOWL_POTTERY_SHARD);
            param1.accept(Items.MINER_POTTERY_SHARD);
            param1.accept(Items.MOURNER_POTTERY_SHARD);
            param1.accept(Items.PLENTY_POTTERY_SHARD);
            param1.accept(Items.PRIZE_POTTERY_SHARD);
            param1.accept(Items.SHEAF_POTTERY_SHARD);
            param1.accept(Items.SHELTER_POTTERY_SHARD);
            param1.accept(Items.SKULL_POTTERY_SHARD);
            param1.accept(Items.SNORT_POTTERY_SHARD);
