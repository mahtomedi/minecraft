...
public class CreativeModeTabs {
        ...
        Registry.register(
            ...
            CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
                ...
                .displayItems((param0x, param1) -> {
                    ...
                    param1.accept(Items.TUFF_STAIRS);
                    param1.accept(Items.TUFF_SLAB);
                    param1.accept(Items.TUFF_WALL);
                    param1.accept(Items.CHISELED_TUFF);
                    param1.accept(Items.POLISHED_TUFF);
                    param1.accept(Items.POLISHED_TUFF_STAIRS);
                    param1.accept(Items.POLISHED_TUFF_SLAB);
                    param1.accept(Items.POLISHED_TUFF_WALL);
                    param1.accept(Items.TUFF_BRICKS);
                    param1.accept(Items.TUFF_BRICK_STAIRS);
                    param1.accept(Items.TUFF_BRICK_SLAB);
                    param1.accept(Items.TUFF_BRICK_WALL);
                    param1.accept(Items.CHISELED_TUFF_BRICKS);
                    ...
                    param1.accept(Items.CHISELED_COPPER);
                    param1.accept(Items.COPPER_GRATE);
                    param1.accept(Items.CUT_COPPER);
                    param1.accept(Items.CUT_COPPER_STAIRS);
                    param1.accept(Items.CUT_COPPER_SLAB);
                    param1.accept(Items.COPPER_DOOR);
                    param1.accept(Items.COPPER_TRAPDOOR);
                    param1.accept(Items.COPPER_BULB);
                    param1.accept(Items.EXPOSED_COPPER);
                    param1.accept(Items.EXPOSED_CHISELED_COPPER);
                    param1.accept(Items.EXPOSED_COPPER_GRATE);
                    ...
                    param1.accept(Items.EXPOSED_COPPER_DOOR);
                    param1.accept(Items.EXPOSED_COPPER_TRAPDOOR);
                    param1.accept(Items.EXPOSED_COPPER_BULB);
                    param1.accept(Items.WEATHERED_COPPER);
                    param1.accept(Items.WEATHERED_CHISELED_COPPER);
                    param1.accept(Items.WEATHERED_COPPER_GRATE);
                    ...
                    param1.accept(Items.WEATHERED_COPPER_DOOR);
                    param1.accept(Items.WEATHERED_COPPER_TRAPDOOR);
                    param1.accept(Items.WEATHERED_COPPER_BULB);
                    param1.accept(Items.OXIDIZED_COPPER);
                    param1.accept(Items.OXIDIZED_CHISELED_COPPER);
                    param1.accept(Items.OXIDIZED_COPPER_GRATE);
                    ...
                    param1.accept(Items.OXIDIZED_COPPER_DOOR);
                    param1.accept(Items.OXIDIZED_COPPER_TRAPDOOR);
                    param1.accept(Items.OXIDIZED_COPPER_BULB);
                    param1.accept(Items.WAXED_COPPER_BLOCK);
                    param1.accept(Items.WAXED_CHISELED_COPPER);
                    param1.accept(Items.WAXED_COPPER_GRATE);
                    param1.accept(Items.WAXED_CUT_COPPER);
                    param1.accept(Items.WAXED_CUT_COPPER_STAIRS);
                    param1.accept(Items.WAXED_CUT_COPPER_SLAB);
                    param1.accept(Items.WAXED_COPPER_DOOR);
                    param1.accept(Items.WAXED_COPPER_TRAPDOOR);
                    param1.accept(Items.WAXED_COPPER_BULB);
                    param1.accept(Items.WAXED_EXPOSED_COPPER);
                    param1.accept(Items.WAXED_EXPOSED_CHISELED_COPPER);
                    param1.accept(Items.WAXED_EXPOSED_COPPER_GRATE);
                    ...
                    param1.accept(Items.WAXED_EXPOSED_COPPER_DOOR);
                    param1.accept(Items.WAXED_EXPOSED_COPPER_TRAPDOOR);
                    param1.accept(Items.WAXED_EXPOSED_COPPER_BULB);
                    param1.accept(Items.WAXED_WEATHERED_COPPER);
                    param1.accept(Items.WAXED_WEATHERED_CHISELED_COPPER);
                    param1.accept(Items.WAXED_WEATHERED_COPPER_GRATE);
                    ...
                    param1.accept(Items.WAXED_WEATHERED_COPPER_DOOR);
                    param1.accept(Items.WAXED_WEATHERED_COPPER_TRAPDOOR);
                    param1.accept(Items.WAXED_WEATHERED_COPPER_BULB);
                    param1.accept(Items.WAXED_OXIDIZED_COPPER);
                    param1.accept(Items.WAXED_OXIDIZED_CHISELED_COPPER);
                    param1.accept(Items.WAXED_OXIDIZED_COPPER_GRATE);
                    ...
                    param1.accept(Items.WAXED_OXIDIZED_COPPER_DOOR);
                    param1.accept(Items.WAXED_OXIDIZED_COPPER_TRAPDOOR);
                    param1.accept(Items.WAXED_OXIDIZED_COPPER_BULB);
                })
                .build()
        );
        Registry.register(
        ...
        Registry.register(
            ...
            CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2)
                ...
                .displayItems((param0x, param1) -> {
                    ...
                    param1.accept(Items.SHORT_GRASS);
        ...
        Registry.register(
            ...
            CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4)
                ...
                .displayItems((param0x, param1) -> {
                    ...
                    param1.accept(Items.TRIAL_SPAWNER);
    ...
    private static void generateSuspiciousStews(CreativeModeTab.Output param0, CreativeModeTab.TabVisibility param1) {
        ...
        for(SuspiciousEffectHolder var2 : var0) {
            ...
            SuspiciousStewItem.saveMobEffects(var3, var2.getSuspiciousEffects());
            var1.add(var3);
        }
