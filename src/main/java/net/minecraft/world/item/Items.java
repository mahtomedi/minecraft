...
public class Items {
    ...
    public static Item registerBlock(Block param0) {
        return registerBlock(new BlockItem(param0, new Item.Properties()));
    }

    public static Item registerBlock(Block param0, Block... param1) {
        BlockItem var0 = new BlockItem(param0, new Item.Properties());

        for(Block var1 : param1) {
    ...
    public static Item registerBlock(BlockItem param0) {
        return registerBlock(param0.getBlock(), param0);
    }

    public static Item registerBlock(Block param0, Item param1) {
        return registerItem(BuiltInRegistries.BLOCK.getKey(param0), param1);
    }

    public static Item registerItem(String param0, Item param1) {
        return registerItem(new ResourceLocation(param0), param1);
    }

    public static Item registerItem(ResourceLocation param0, Item param1) {
        return registerItem(ResourceKey.create(BuiltInRegistries.ITEM.key(), param0), param1);
    }

    public static Item registerItem(ResourceKey<Item> param0, Item param1) {
