...
public enum ArmorMaterials implements ArmorMaterial {
    ...
    private ArmorMaterials(String param0, int param1, int[] param2, int param3, SoundEvent param4, float param5, Supplier<Ingredient> param6) {
        this.name = param0;
        ...
        this.repairIngredient = new LazyLoadedValue<>(param6);
    }
