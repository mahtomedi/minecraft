...
public class TransientCraftingContainer implements CraftingContainer {
    ...
    public TransientCraftingContainer(AbstractContainerMenu param0, int param1, int param2) {
        this(param0, param1, param2, NonNullList.withSize(param1 * param2, ItemStack.EMPTY));
    }

    public TransientCraftingContainer(AbstractContainerMenu param0, int param1, int param2, NonNullList<ItemStack> param3) {
        this.items = param3;
        this.menu = param0;
        this.width = param1;
        this.height = param2;
