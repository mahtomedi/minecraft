...
public class CartographyMenu extends AbstractContainerMenu {
    ...
    public CartographyMenu(int param0, Inventory param1) {
        this(param0, param1, ContainerLevelAccess.NULL);
    }

    public CartographyMenu(int param0, Inventory param1, final ContainerLevelAccess param2) {
        super(MenuType.CARTOGRAPHY, param0);
        this.access = param2;
        ...
        this.addSlot(
            new Slot(this.resultContainer, 2, 145, 39) {
                ...
                public ItemStack remove(int param0) {
                    ...
                    ItemStack var1 = param2.<ItemStack>evaluate((param1, param2xx) -> {
                        if (!CartographyMenu.this.quickMoved && CartographyMenu.this.container.getItem(1).getItem() == Items.GLASS_PANE) {
                            ItemStack var0x = MapItem.lockMap(param1, CartographyMenu.this.container.getItem(0));
                            if (var0x != null) {
                                var0x.setCount(1);
                                return var0x;
                            }
                ...
                public ItemStack onTake(Player param0, ItemStack param1) {
                    ...
                    param2.execute(
                        (param0x, param1x) -> param0x.playSound(null, param1x, SoundEvents.UI_CARTOGRAPHY_TABLE_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F)
                    );
