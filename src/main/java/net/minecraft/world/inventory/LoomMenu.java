    ...
    public LoomMenu(int param0, Inventory param1, final ContainerLevelAccess param2) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.outputContainer, 0, 143, 58) {
            ...
            public ItemStack onTake(Player param0, ItemStack param1) {
                ...
                param2.execute((param0x, param1x) -> param0x.playSound(null, param1x, SoundEvents.UI_LOOM_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F));
    ...
    public void slotsChanged(Container param0) {
        ...
        if (var3.isEmpty()
            || !var0.isEmpty()
                ...
                && (this.selectedBannerPatternIndex.get() < BannerPattern.COUNT - 5 || !var2.isEmpty())) {
