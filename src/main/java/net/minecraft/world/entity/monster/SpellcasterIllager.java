...
public abstract class SpellcasterIllager extends AbstractIllager {
    ...
    public void tick() {
        ...
        if (this.level.isClientSide && this.isCastingSpell()) {
            ...
            this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.x + (double)var5 * 0.6, this.y + 1.8, this.z + (double)var6 * 0.6, var1, var2, var3);
            this.level.addParticle(ParticleTypes.ENTITY_EFFECT, this.x - (double)var5 * 0.6, this.y + 1.8, this.z - (double)var6 * 0.6, var1, var2, var3);
        }
    ...
    public static enum IllagerSpell {
        ...
        public static SpellcasterIllager.IllagerSpell byId(int param0) {
            for(SpellcasterIllager.IllagerSpell var0 : values()) {
                if (param0 == var0.id) {
                    return var0;
                }
            }
