...
public class Ravager extends Raider {
    ...
    public void aiStep() {
        ...
        if (this.isAlive()) {
            if (this.isImmobile()) {
                ...
                double var1 = this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getBaseValue();
                this.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(Mth.lerp(0.1, var1, var0));
            }
    ...
    public boolean canSee(Entity param0) {
        return this.stunnedTick <= 0 && this.roarTick <= 0 ? super.canSee(param0) : false;
    }
