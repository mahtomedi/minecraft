...
public class Drowned extends Zombie implements RangedAttackMob {
    ...
    public static boolean checkDrownedSpawnRules(EntityType<Drowned> param0, LevelAccessor param1, MobSpawnType param2, BlockPos param3, Random param4) {
        ...
        if (var0 != Biomes.RIVER && var0 != Biomes.FROZEN_RIVER) {
    ...
    protected boolean canReplaceCurrentItem(ItemStack param0, ItemStack param1, EquipmentSlot param2) {
        if (param1.getItem() == Items.NAUTILUS_SHELL) {
            ...
            return param0.getItem() == Items.TRIDENT ? true : super.canReplaceCurrentItem(param0, param1, param2);
        }
    }
    ...
    static class DrownedGoToBeachGoal extends MoveToBlockGoal {
        ...
        public boolean canUse() {
            return super.canUse()
                ...
                && this.drowned.y >= (double)(this.drowned.level.getSeaLevel() - 3);
        }
    ...
    static class DrownedGoToWaterGoal extends Goal {
        ...
        private Vec3 getWaterPos() {
            ...
            for(int var2 = 0; var2 < 10; ++var2) {
                ...
                if (this.level.getBlockState(var3).getBlock() == Blocks.WATER) {
    ...
    static class DrownedMoveControl extends MoveControl {
        ...
        public void tick() {
            ...
            if (this.drowned.wantsToSwim() && this.drowned.isInWater()) {
                if (var0 != null && var0.y > this.drowned.y || this.drowned.searchingForLand) {
                ...
                double var1 = this.wantedX - this.drowned.x;
                double var2 = this.wantedY - this.drowned.y;
                double var3 = this.wantedZ - this.drowned.z;
    ...
    static class DrownedSwimUpGoal extends Goal {
        ...
        public void tick() {
            if (this.drowned.y < (double)(this.seaLevel - 1) && (this.drowned.getNavigation().isDone() || this.drowned.closeToNextPos())) {
                Vec3 var0 = RandomPos.getPosTowards(this.drowned, 4, 8, new Vec3(this.drowned.x, (double)(this.seaLevel - 1), this.drowned.z));
                if (var0 == null) {
                    this.stuck = true;
                    return;
                }
