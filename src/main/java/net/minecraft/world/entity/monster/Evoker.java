...
public class Evoker extends SpellcasterIllager {
    ...
    class EvokerAttackSpellGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        private void createSpellEntity(double param0, double param1, double param2, double param3, float param4, int param5) {
            BlockPos var0 = BlockPos.containing(param0, param3, param1);
            boolean var1 = false;
            double var2 = 0.0;
            ...
            if (var1) {
                Evoker.this.level()
                    .addFreshEntity(new EvokerFangs(Evoker.this.level(), param0, (double)var0.getY() + var2, param1, param4, param5, Evoker.this));
                Evoker.this.level().gameEvent(GameEvent.ENTITY_PLACE, new Vec3(param0, (double)var0.getY() + var2, param1), GameEvent.Context.of(Evoker.this));
            }
