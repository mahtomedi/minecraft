...
public class Vex extends Monster implements TraceableEntity {
    ...
    public void restoreFrom(Entity param0) {
        ...
        if (param0 instanceof Vex var0) {
            this.owner = var0.getOwner();
        }
    ...
    class VexChargeAttackGoal extends Goal {
        ...
        public boolean canUse() {
            ...
            if (var0 != null && var0.isAlive() && !Vex.this.getMoveControl().hasWanted() && Vex.this.random.nextInt(reducedTickDelay(7)) == 0) {
                return Vex.this.distanceToSqr(var0) > 4.0;
            } else {
                return false;
            }
        }
