...
public class Silverfish extends Monster {
    ...
    public static boolean checkSliverfishSpawnRules(EntityType<Silverfish> param0, LevelAccessor param1, MobSpawnType param2, BlockPos param3, Random param4) {
        ...
        public boolean canUse() {
            if (this.mob.getTarget() != null) {
                ...
                if (this.mob.level.getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && var0.nextInt(10) == 0) {
                    ...
                    BlockPos var1 = new BlockPos(this.mob.x, this.mob.y + 0.5, this.mob.z).relative(this.selectedDirection);
    ...
    static class SilverfishWakeUpFriendsGoal extends Goal {
        ...
        public void tick() {
            ...
            if (this.lookForFriends <= 0) {
                ...
                BlockPos var2 = new BlockPos(this.silverfish);
