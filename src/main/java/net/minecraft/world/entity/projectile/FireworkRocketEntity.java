...
public class FireworkRocketEntity extends Projectile implements ItemSupplier {
    ...
    private void dealExplosionDamage() {
        ...
        if (var0 > 0.0F) {
            if (this.attachedToEntity != null) {
                this.attachedToEntity.hurt(this.damageSources().fireworks(this, this.getOwner()), 5.0F + (float)(var3.size() * 2));
            }
            ...
            for(LivingEntity var7 : this.level.getEntitiesOfClass(LivingEntity.class, this.getBoundingBox().inflate(5.0))) {
                if (var7 != this.attachedToEntity && !(this.distanceToSqr(var7) > 25.0)) {
                    ...
                    if (var8) {
                        ...
                        var7.hurt(this.damageSources().fireworks(this, this.getOwner()), var12);
                    }
                }
            }
        }
