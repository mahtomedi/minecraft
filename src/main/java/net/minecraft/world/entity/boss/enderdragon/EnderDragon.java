...
public class EnderDragon extends Mob implements Enemy {
    ...
    public void aiStep() {
        if (this.level.isClientSide) {
            ...
            if (!this.isSilent()) {
                ...
                if (var1 <= -0.3F && var0 >= -0.3F) {
                    this.level
                        .playLocalSound(
                            this.x, this.y, this.z, SoundEvents.ENDER_DRAGON_FLAP, this.getSoundSource(), 5.0F, 0.8F + this.random.nextFloat() * 0.3F, false
                        );
                }
                ...
                if (!this.phaseManager.getCurrentPhase().isSitting() && --this.growlTime < 0) {
                    this.level
                        .playLocalSound(
                            this.x, this.y, this.z, SoundEvents.ENDER_DRAGON_GROWL, this.getSoundSource(), 2.5F, 0.8F + this.random.nextFloat() * 0.3F, false
                        );
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.level.addParticle(ParticleTypes.EXPLOSION, this.x + (double)var2, this.y + 2.0 + (double)var3, this.z + (double)var4, 0.0, 0.0, 0.0);
        } else {
            this.checkCrystals();
            ...
            if (this.isNoAi()) {
                ...
                if (this.level.isClientSide) {
                    if (this.lerpSteps > 0) {
                        double var8 = this.x + (this.lerpX - this.x) / (double)this.lerpSteps;
                        double var9 = this.y + (this.lerpY - this.y) / (double)this.lerpSteps;
                        double var10 = this.z + (this.lerpZ - this.z) / (double)this.lerpSteps;
                    ...
                    if (var13 != null) {
                        double var14 = var13.x - this.x;
                        double var15 = var13.y - this.y;
                        double var16 = var13.z - this.z;
                        ...
                        Vec3 var21 = var13.subtract(this.x, this.y, this.z).normalize();
                        Vec3 var22 = new Vec3(
                ...
                for(int var29 = 0; var29 < this.subEntities.length; ++var29) {
                    var28[var29] = new Vec3(this.subEntities[var29].x, this.subEntities[var29].y, this.subEntities[var29].z);
                }
                ...
                this.body.tick();
                this.body.moveTo(this.x + (double)(var34 * 0.5F), this.y, this.z - (double)(var35 * 0.5F), 0.0F, 0.0F);
                this.wing1.tick();
                this.wing1.moveTo(this.x + (double)(var35 * 4.5F), this.y + 2.0, this.z + (double)(var34 * 4.5F), 0.0F, 0.0F);
                this.wing2.tick();
                this.wing2.moveTo(this.x - (double)(var35 * 4.5F), this.y + 2.0, this.z - (double)(var34 * 4.5F), 0.0F, 0.0F);
                ...
                double[] var36 = this.getLatencyPos(5, 1.0F);
                float var37 = Mth.sin(this.yRot * (float) (Math.PI / 180.0) - this.yRotA * 0.01F);
                float var38 = Mth.cos(this.yRot * (float) (Math.PI / 180.0) - this.yRotA * 0.01F);
                this.head.tick();
                this.neck.tick();
                float var39 = this.getHeadYOffset(1.0F);
                this.head
                    .moveTo(
                        this.x + (double)(var37 * 6.5F * var31),
                        this.y + (double)var39 + (double)(var32 * 6.5F),
                        this.z - (double)(var38 * 6.5F * var31),
                        0.0F,
                        0.0F
                    );
                this.neck
                    .moveTo(
                        this.x + (double)(var37 * 5.5F * var31),
                        this.y + (double)var39 + (double)(var32 * 5.5F),
                        this.z - (double)(var38 * 5.5F * var31),
                        0.0F,
                        0.0F
                    );
                ...
                for(int var40 = 0; var40 < 3; ++var40) {
                    ...
                    float var43 = this.yRot * (float) (Math.PI / 180.0) + this.rotWrap(var42[0] - var36[0]) * (float) (Math.PI / 180.0);
                    ...
                    var41.tick();
                    var41.moveTo(
                        this.x - (double)((var34 * 1.5F + var44 * var47) * var31),
                        this.y + (var42[1] - var36[1]) - (double)((var47 + 1.5F) * var32) + 1.5,
                        this.z + (double)((var35 * 1.5F + var45 * var47) * var31),
                        0.0F,
                        0.0F
                    );
                }
    ...
    private float getHeadYOffset(float param0) {
        double var0;
        if (this.phaseManager.getCurrentPhase().isSitting()) {
            var0 = -1.0;
        } else {
    ...
    private void knockBack(List<Entity> param0) {
        ...
        for(Entity var2 : param0) {
            if (var2 instanceof LivingEntity) {
                double var3 = var2.x - var0;
                double var4 = var2.z - var1;
    ...
    private void hurt(List<Entity> param0) {
        for(int var0 = 0; var0 < param0.size(); ++var0) {
            Entity var1 = param0.get(var0);
            if (var1 instanceof LivingEntity) {
                var1.hurt(DamageSource.mobAttack(this), 10.0F);
    ...
    protected void tickDeath() {
        ...
        if (this.dragonDeathTime >= 180 && this.dragonDeathTime <= 200) {
            ...
            float var2 = (this.random.nextFloat() - 0.5F) * 8.0F;
            this.level.addParticle(ParticleTypes.EXPLOSION_EMITTER, this.x + (double)var0, this.y + 2.0 + (double)var1, this.z + (double)var2, 0.0, 0.0, 0.0);
        }
    ...
    private void dropExperience(int param0) {
        while(param0 > 0) {
            ...
            param0 -= var0;
            this.level.addFreshEntity(new ExperienceOrb(this.level, this.x, this.y, this.z, var0));
        }
