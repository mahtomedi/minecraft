...
public class NearestItemSensor extends Sensor<Mob> {
    ...
    protected void doTick(ServerLevel param0, Mob param1) {
        ...
        List<ItemEntity> var1 = param0.getEntitiesOfClass(ItemEntity.class, param1.getBoundingBox().inflate(32.0, 16.0, 32.0), param0x -> true);
        ...
        Optional<ItemEntity> var2 = var1.stream()
            ...
            .filter(param1x -> param1x.closerThan(param1, 32.0))
