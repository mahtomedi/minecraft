...
public class MemoryModuleType<U> {
    ...
    private MemoryModuleType(Optional<Function<Dynamic<?>, U>> param0) {
    ...
    private static <U extends Serializable> MemoryModuleType<U> register(String param0, Optional<Function<Dynamic<?>, U>> param1) {
        return Registry.register(Registry.MEMORY_MODULE_TYPE, new ResourceLocation(param0), new MemoryModuleType<>(param1));
    }
