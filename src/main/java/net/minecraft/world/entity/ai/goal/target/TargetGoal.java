...
public abstract class TargetGoal extends Goal {
    ...
    protected double getFollowDistance() {
        AttributeInstance var0 = this.mob.getAttribute(SharedMonsterAttributes.FOLLOW_RANGE);
        return var0 == null ? 16.0 : var0.getValue();
    }
    ...
    protected boolean canAttack(@Nullable LivingEntity param0, TargetingConditions param1) {
        if (param0 == null) {
            ...
            return false;
        } else if (!this.mob.isWithinRestriction(new BlockPos(param0))) {
            return false;
        } else {
            if (this.mustReach) {
