...
public class CopyMemoryWithExpiry<E extends Mob, T> extends Behavior<E> {
    ...
    public CopyMemoryWithExpiry(Predicate<E> param0, MemoryModuleType<? extends T> param1, MemoryModuleType<T> param2, UniformInt param3) {
    ...
    protected void start(ServerLevel param0, E param1, long param2) {
        ...
        var0.setMemoryWithExpiry(this.targetMemory, var0.getMemory(this.sourceMemory).get(), (long)this.durationOfCopy.sample(param0.random));
    }
}
