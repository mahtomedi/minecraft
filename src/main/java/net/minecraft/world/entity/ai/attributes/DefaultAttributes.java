...
public class DefaultAttributes {
    ...
    public static AttributeSupplier getSupplier(EntityType<? extends LivingEntity> param0) {
        return SUPPLIERS.get(param0);
    }

    public static boolean hasSupplier(EntityType<?> param0) {
        return SUPPLIERS.containsKey(param0);
    }
