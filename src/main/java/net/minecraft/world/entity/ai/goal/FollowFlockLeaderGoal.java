...
public class FollowFlockLeaderGoal extends Goal {
    ...
    public boolean canUse() {
        if (this.mob.hasFollowers()) {
            ...
            List<AbstractSchoolingFish> var1 = this.mob.level.getEntitiesOfClass(this.mob.getClass(), this.mob.getBoundingBox().inflate(8.0, 8.0, 8.0), var0);
            AbstractSchoolingFish var2 = var1.stream().filter(AbstractSchoolingFish::canBeFollowed).findAny().orElse(this.mob);
