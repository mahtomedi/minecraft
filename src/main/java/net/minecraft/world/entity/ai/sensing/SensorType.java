...
public class SensorType<U extends Sensor<?>> {
    ...
    private SensorType(Supplier<U> param0) {
        this.factory = param0;
    }
    ...
    private static <U extends Sensor<?>> SensorType<U> register(String param0, Supplier<U> param1) {
        return Registry.register(BuiltInRegistries.SENSOR_TYPE, new ResourceLocation(param0), new SensorType<>(param1));
    }
}
