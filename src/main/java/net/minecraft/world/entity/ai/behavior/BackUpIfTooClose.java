...
public class BackUpIfTooClose<E extends Mob> extends Behavior<E> {
    ...
    protected void start(ServerLevel param0, E param1, long param2) {
        ...
        param1.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, new EntityPosWrapper(this.getTarget(param1)));
    }

    private boolean isTargetVisible(E param0) {
        return param0.getBrain().getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).get().contains(this.getTarget(param0));
    }
