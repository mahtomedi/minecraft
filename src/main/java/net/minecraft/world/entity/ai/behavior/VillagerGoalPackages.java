...
public class VillagerGoalPackages {
    public static ImmutableList<Pair<Integer, ? extends Behavior<? super Villager>>> getCorePackage(VillagerProfession param0, float param1) {
        return ImmutableList.of(
            ...
            Pair.of(6, new AcquirePoi(param0.getJobPoiType(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true)),
            Pair.of(6, new GoToPotentialJobSite(param1)),
            Pair.of(7, new YieldJobSite(param1)),
