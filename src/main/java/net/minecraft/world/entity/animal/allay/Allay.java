...
public class Allay extends PathfinderMob implements InventoryCarrier {
    ...
    private boolean allayConsidersItemEqual(ItemStack param0, ItemStack param1) {
        return param0.sameItemStackIgnoreDurability(param1) && !this.hasNonMatchingPotion(param0, param1);
    }
    ...
    public Iterable<BlockPos> iteratePathfindingStartNodeCandidatePositions() {
        ...
        int var1 = Mth.floor(var0.minX - 0.5);
        int var2 = Mth.floor(var0.maxX + 0.5);
        int var3 = Mth.floor(var0.minZ - 0.5);
        int var4 = Mth.floor(var0.maxZ + 0.5);
        int var5 = Mth.floor(var0.minY - 0.5);
