...
public class Panda extends Animal {
    ...
    public void addAdditionalSaveData(CompoundTag param0) {
        ...
        param0.putString("MainGene", this.getMainGene().getSerializedName());
        param0.putString("HiddenGene", this.getHiddenGene().getSerializedName());
    }
    ...
    protected Vector3f getPassengerAttachmentPoint(Entity param0, EntityDimensions param1, float param2) {
        return new Vector3f(0.0F, param1.height - (this.isBaby() ? 0.4375F : 0.0F) * param2, 0.0F);
    }
    ...
    public static enum Gene implements StringRepresentable {
        ...
        public static Panda.Gene byName(String param0) {
            return CODEC.byName(param0, NORMAL);
        }
    ...
    static class PandaHurtByTargetGoal extends HurtByTargetGoal {
        ...
        protected void alertOther(Mob param0, LivingEntity param1) {
            if (param0 instanceof Panda && param0.isAggressive()) {
