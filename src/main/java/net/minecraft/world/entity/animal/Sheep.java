...
public class Sheep extends Animal implements Shearable {
    ...
    public Sheep getBreedOffspring(ServerLevel param0, AgeableMob param1) {
        Sheep var0 = EntityType.SHEEP.create(param0);
        if (var0 != null) {
            var0.setColor(this.getOffspringColor(this, (Sheep)param1));
        }
    ...
    private DyeColor getOffspringColor(Animal param0, Animal param1) {
        ...
        return this.level()
            ...
            .map(param1x -> param1x.value().assemble(var2, this.level().registryAccess()))
    ...
    private static CraftingContainer makeContainer(DyeColor param0, DyeColor param1) {
        CraftingContainer var0 = new TransientCraftingContainer(new AbstractContainerMenu(null, -1) {
            @Override
