...
public class Ocelot extends Animal {
    ...
    public boolean checkSpawnObstruction(LevelReader param0) {
        if (param0.isUnobstructed(this) && !param0.containsAnyLiquid(this.getBoundingBox())) {
            ...
            if (var2 == Blocks.GRASS_BLOCK || var1.is(BlockTags.LEAVES)) {
                return true;
            }
        }
    ...
    protected void addKittensDuringSpawn() {
        for(int var0 = 0; var0 < 2; ++var0) {
            Ocelot var1 = EntityType.OCELOT.create(this.level);
            var1.moveTo(this.x, this.y, this.z, this.yRot, 0.0F);
            var1.setAge(-24000);
    ...
    public SpawnGroupData finalizeSpawn(
        ...
        if (param0.getRandom().nextInt(7) == 0) {
