...
public class Dolphin extends WaterAnimal {
                ...
                for(int var4 = 0; var4 < 2; ++var4) {
                    this.level
                        .addParticle(
                            ...
                            this.x - var0.x * (double)var3 + (double)var1,
                            this.y - var0.y,
                            this.z - var0.z * (double)var3 + (double)var2,
                            0.0,
                            0.0,
                            0.0
                        );
    ...
    protected boolean mobInteract(Player param0, InteractionHand param1) {
        ...
        if (!var0.isEmpty() && var0.getItem().is(ItemTags.FISHES)) {
    ...
    public static boolean checkDolphinSpawnRules(EntityType<Dolphin> param0, LevelAccessor param1, MobSpawnType param2, BlockPos param3, Random param4) {
        return param3.getY() > 45
            && param3.getY() < param1.getSeaLevel()
            && (param1.getBiome(param3) != Biomes.OCEAN || param1.getBiome(param3) != Biomes.DEEP_OCEAN)
    ...
    static class DolphinMoveControl extends MoveControl {
        ...
        public DolphinMoveControl(Dolphin param0) {
            super(param0);
            this.dolphin = param0;
        }
        ...
        public void tick() {
            ...
            if (this.operation == MoveControl.Operation.MOVE_TO && !this.dolphin.getNavigation().isDone()) {
                double var0 = this.wantedX - this.dolphin.x;
                double var1 = this.wantedY - this.dolphin.y;
                double var2 = this.wantedZ - this.dolphin.z;
                ...
                if (var3 < 2.5000003E-7F) {
                    ...
                    this.dolphin.yRot = this.rotlerp(this.dolphin.yRot, var4, 10.0F);
                    this.dolphin.yBodyRot = this.dolphin.yRot;
                    this.dolphin.yHeadRot = this.dolphin.yRot;
                    float var5 = (float)(this.speedModifier * this.dolphin.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getValue());
                    if (this.dolphin.isInWater()) {
                        this.dolphin.setSpeed(var5 * 0.02F);
                        float var6 = -((float)(Mth.atan2(var1, (double)Mth.sqrt(var0 * var0 + var2 * var2)) * 180.0F / (float)Math.PI));
                        var6 = Mth.clamp(Mth.wrapDegrees(var6), -85.0F, 85.0F);
                        this.dolphin.xRot = this.rotlerp(this.dolphin.xRot, var6, 5.0F);
                        float var7 = Mth.cos(this.dolphin.xRot * (float) (Math.PI / 180.0));
                        float var8 = Mth.sin(this.dolphin.xRot * (float) (Math.PI / 180.0));
                        this.dolphin.zza = var7 * var5;
                        this.dolphin.yya = -var8 * var5;
                    } else {
                        this.dolphin.setSpeed(var5 * 0.1F);
                    }
    ...
    static class DolphinSwimToTreasureGoal extends Goal {
        ...
        public boolean canContinueToUse() {
            ...
            return !new BlockPos((double)var0.getX(), this.dolphin.y, (double)var0.getZ()).closerThan(this.dolphin.position(), 4.0)
                && !this.stuck
        ...
        public void stop() {
            BlockPos var0 = this.dolphin.getTreasurePos();
            if (new BlockPos((double)var0.getX(), this.dolphin.y, (double)var0.getZ()).closerThan(this.dolphin.position(), 4.0) || this.stuck) {
        ...
        public void tick() {
            ...
            if (this.dolphin.closeToNextPos() || this.dolphin.getNavigation().isDone()) {
                Vec3 var2 = RandomPos.getPosTowards(
                    this.dolphin, 16, 1, new Vec3((double)var0.getX(), (double)var0.getY(), (double)var0.getZ()), (float) (Math.PI / 8)
                );
                if (var2 == null) {
                    var2 = RandomPos.getPosTowards(this.dolphin, 8, 4, new Vec3((double)var0.getX(), (double)var0.getY(), (double)var0.getZ()));
                }

                if (var2 != null) {
                    BlockPos var3 = new BlockPos(var2);
                    if (!var1.getFluidState(var3).is(FluidTags.WATER) || !var1.getBlockState(var3).isPathfindable(var1, var3, PathComputationType.WATER)) {
                        var2 = RandomPos.getPosTowards(this.dolphin, 8, 5, new Vec3((double)var0.getX(), (double)var0.getY(), (double)var0.getZ()));
                    }
                }
    ...
    class PlayWithItemsGoal extends Goal {
        ...
        private void drop(ItemStack param0) {
            if (!param0.isEmpty()) {
                double var0 = Dolphin.this.y - 0.3F + (double)Dolphin.this.getEyeHeight();
                ItemEntity var1 = new ItemEntity(Dolphin.this.level, Dolphin.this.x, var0, Dolphin.this.z, param0);
