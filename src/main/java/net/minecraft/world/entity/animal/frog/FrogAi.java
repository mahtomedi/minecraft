...
public class FrogAi {
    ...
    protected static void initMemories(Frog param0) {
    ...
    private static void initIdleActivity(Brain<Frog> param0) {
        param0.addActivityWithConditions(
            ...
            ImmutableList.of(
                ...
                Pair.of(2, new StartAttacking<>(FrogAi::canAttack, param0x -> param0x.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))),
    ...
    private static void initLaySpawnActivity(Brain<Frog> param0) {
        param0.addActivityWithConditions(
            ...
            ImmutableList.of(
                Pair.of(0, new RunSometimes<>(new SetEntityLookTarget(EntityType.PLAYER, 6.0F), UniformInt.of(30, 60))),
                Pair.of(1, new StartAttacking<>(FrogAi::canAttack, param0x -> param0x.getBrain().getMemory(MemoryModuleType.NEAREST_ATTACKABLE))),
            ...
            ImmutableList.of(
                ...
                Pair.of(
                    ...
                    new LongJumpToPreferredBlock<>(
                        ...
                        0.5F,
                        param0x -> param0x.is(Blocks.LILY_PAD)
                    )
                )
            ),
            ImmutableSet.of(
