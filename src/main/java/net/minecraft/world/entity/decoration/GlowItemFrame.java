...
public class GlowItemFrame extends ItemFrame {
    public GlowItemFrame(EntityType<? extends ItemFrame> param0, Level param1) {
        super(param0, param1);
    }

    public GlowItemFrame(Level param0, BlockPos param1, Direction param2) {
        super(EntityType.GLOW_ITEM_FRAME, param0, param1, param2);
    }
