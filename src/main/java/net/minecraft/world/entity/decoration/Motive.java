...
public class Motive {
    ...
    private static Motive register(String param0, int param1, int param2) {
        return Registry.register(Registry.MOTIVE, param0, new Motive(param1, param2));
    }

    public Motive(int param0, int param1) {
        this.width = param0;
        this.height = param1;
    }
