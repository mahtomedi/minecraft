...
public class ArmorStand extends LivingEntity {
    ...
    protected void pushEntities() {
        for(Entity var1 : this.level().getEntities(this, this.getBoundingBox(), RIDABLE_MINECARTS)) {
            if (this.distanceToSqr(var1) <= 0.2) {
                var1.push(this);
            }
        }
    ...
    public boolean hurt(DamageSource param0, float param1) {
        if (this.level().isClientSide || this.isRemoved()) {
            ...
            if (!var0 && !var1) {
                ...
                if (var6 instanceof Player var2 && !var2.getAbilities().mayBuild) {
                    return false;
                }
    ...
    private void brokenByPlayer(DamageSource param0) {
        ItemStack var0 = new ItemStack(Items.ARMOR_STAND);
