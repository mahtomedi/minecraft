...
public abstract class HangingEntity extends Entity {
    ...
    public boolean skipAttackInteraction(Entity param0) {
        if (param0 instanceof Player) {
            ...
            return !this.level.mayInteract(var0, this.pos) ? true : this.hurt(DamageSource.playerAttack(var0), 0.0F);
        } else {
            return false;
        }
    }
    ...
    public void readAdditionalSaveData(CompoundTag param0) {
        this.pos = new BlockPos(param0.getInt("TileX"), param0.getInt("TileY"), param0.getInt("TileZ"));
    }
    ...
    public void setPos(double param0, double param1, double param2) {
        this.pos = new BlockPos(param0, param1, param2);
        this.recalculateBoundingBox();
