...
public class VillagerProfession {
    ...
    private VillagerProfession(String param0, PoiType param1, ImmutableSet<Item> param2, ImmutableSet<Block> param3, @Nullable SoundEvent param4) {
        this.name = param0;
        this.jobPoiType = param1;
        this.requestedItems = param2;
        this.secondaryPoi = param3;
        this.workSound = param4;
    }
    ...
    static VillagerProfession register(String param0, PoiType param1, @Nullable SoundEvent param2) {
        return register(param0, param1, ImmutableSet.of(), ImmutableSet.of(), param2);
    }

    static VillagerProfession register(String param0, PoiType param1, ImmutableSet<Item> param2, ImmutableSet<Block> param3, @Nullable SoundEvent param4) {
        return Registry.register(Registry.VILLAGER_PROFESSION, new ResourceLocation(param0), new VillagerProfession(param0, param1, param2, param3, param4));
    }
}
