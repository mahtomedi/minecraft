...
public class VillagerTrades {
                    ...
                    ImmutableMap.of(
                        ...
                        new VillagerTrades.ItemListing[]{
                            ...
                            new VillagerTrades.TreasureMapForEmeralds(
                                13, ConfiguredStructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapDecoration.Type.MONUMENT, 12, 5
                            )
                        },
                        3,
                        new VillagerTrades.ItemListing[]{
    ...
    static class DyedArmorForEmeralds implements VillagerTrades.ItemListing {
        ...
        private static DyeItem getRandomDye(Random param0) {
    ...
    static class EmeraldForItems implements VillagerTrades.ItemListing {
        ...
        @Override
        public MerchantOffer getOffer(Entity param0, Random param1) {
            ItemStack var0 = new ItemStack(this.item, this.cost);
            return new MerchantOffer(var0, new ItemStack(Items.EMERALD), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }
    ...
    static class EmeraldsForVillagerTypeItem implements VillagerTrades.ItemListing {
        ...
        @Override
        public MerchantOffer getOffer(Entity param0, Random param1) {
            if (param0 instanceof VillagerDataHolder) {
                ItemStack var0 = new ItemStack(this.trades.get(((VillagerDataHolder)param0).getVillagerData().getType()), this.cost);
                return new MerchantOffer(var0, new ItemStack(Items.EMERALD), this.maxUses, this.villagerXp, 0.05F);
            } else {
                return null;
            }
        }
    ...
    static class TreasureMapForEmeralds implements VillagerTrades.ItemListing {
        ...
        public TreasureMapForEmeralds(
            int param0, TagKey<ConfiguredStructureFeature<?, ?>> param1, String param2, MapDecoration.Type param3, int param4, int param5
        ) {
        ...
        public MerchantOffer getOffer(Entity param0, Random param1) {
            if (!(param0.level instanceof ServerLevel)) {
                ...
                BlockPos var1 = var0.findNearestMapFeature(this.destination, param0.blockPosition(), 100, true);
                if (var1 != null) {
                    ...
                    var2.setHoverName(new TranslatableComponent(this.displayName));
                    return new MerchantOffer(
