...
public class VillagerTrades {
                ...
                toIntMap(
                    ImmutableMap.of(
                        ...
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.EmeraldForItems(Blocks.HAY_BLOCK, Integer.MAX_VALUE, 8),
                            new VillagerTrades.ItemsForEmeralds(Blocks.HAY_BLOCK, 1, 4)
                        },
                        2,
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.EmeraldForItems(Blocks.PUMPKIN, Integer.MAX_VALUE, 40),
                            new VillagerTrades.ItemsForEmeralds(Blocks.PUMPKIN, 1, 20)
                        },
                        3,
                        new VillagerTrades.ItemListing[]{
                        ...
                        4,
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.ItemsForEmeralds(Blocks.CAKE, 1, 60),
                            new VillagerTrades.EmeraldForItems(CarryableTrade.entity(EntityType.WITHER_SKELETON), 1, 120)
                        },
                        5,
            ...
            param0.put(
                ...
                toIntMap(
                    ImmutableMap.of(
                        ...
                        4,
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.ItemsForEmeralds(Blocks.DARK_PRISMARINE, 1, 60),
                            new VillagerTrades.ItemsForEmeralds(CarryableTrade.entity(EntityType.SQUID), 1, 8)
                        },
                        5,
                        new VillagerTrades.ItemListing[]{
                ...
                toIntMap(
                    ImmutableMap.<Integer, VillagerTrades.ItemListing[]>builder()
                        ...
                        .put(
                            2,
                            new VillagerTrades.ItemListing[]{
                                new VillagerTrades.EmeraldForItems(Blocks.BOOKSHELF, Integer.MAX_VALUE, 40),
                                new VillagerTrades.ItemsForEmeralds(Blocks.LANTERN, 1, 20)
                            }
                        )
            ...
            param0.put(
                ...
                toIntMap(
                    ImmutableMap.of(
                        1,
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.ItemsForEmeralds(Blocks.CAMPFIRE, 1, 4),
                            new VillagerTrades.EmeraldForItems(CarryableTrade.entity(EntityType.CHICKEN), 3, 8)
                        },
                        2,
                        new VillagerTrades.ItemListing[]{
            ...
            param0.put(
                ...
                toIntMap(
                    ImmutableMap.of(
                        1,
                        new VillagerTrades.ItemListing[]{
                            new VillagerTrades.EmeraldForItems(Blocks.CLAY, Integer.MAX_VALUE, 8),
                            new VillagerTrades.ItemsForEmeralds(Blocks.BRICKS, Integer.MAX_VALUE, 4)
                        },
                        2,
    ...
    static class EmeraldForItems implements VillagerTrades.ItemListing {
        ...
        public EmeraldForItems(Block param0, int param1, int param2) {
            this(CarryableTrade.block(param0), param1, param2);
        }

        public EmeraldForItems(CarryableTrade param0, int param1, int param2) {
            this.cost = param0;
            this.maxUses = param1;
    ...
    static class ItemsForEmeralds implements VillagerTrades.ItemListing {
        ...
        public ItemsForEmeralds(Block param0, int param1, int param2) {
            this(CarryableTrade.block(param0), param1, param2);
        }

        public ItemsForEmeralds(Item param0, int param1, int param2) {
            this(
                CarryableTrade.block(
                    CarriedBlocks.getBlockFromItemStack(param0.getDefaultInstance())
        ...
        public ItemsForEmeralds(CarryableTrade param0, int param1, int param2) {
            this(param0, param1, param2, 0.05F);
        }

        public ItemsForEmeralds(CarryableTrade param0, int param1, int param2, float param3) {
            this.result = param0;
            this.maxUses = param1;
            this.villagerXp = param2;
            this.priceMultiplier = param3;
        }
