...
public interface BishopTransformer extends AreaTransformer1, DimensionOffset1Transformer {
    ...
    default int applyPixel(BigContext<?> param0, Area param1, int param2, int param3) {
        return this.apply(
            param0,
            param1.get(this.getParentX(param2 + 0), this.getParentY(param3 + 2)),
            param1.get(this.getParentX(param2 + 2), this.getParentY(param3 + 2)),
            param1.get(this.getParentX(param2 + 2), this.getParentY(param3 + 0)),
            param1.get(this.getParentX(param2 + 0), this.getParentY(param3 + 0)),
