...
public interface StructurePieceType {
    ...
    private static StructurePieceType setFullContextPieceId(StructurePieceType param0, String param1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_PIECE, param1.toLowerCase(Locale.ROOT), param0);
    }

    private static StructurePieceType setPieceId(StructurePieceType.ContextlessType param0, String param1) {
        return setFullContextPieceId(param0, param1);
    }

    private static StructurePieceType setTemplatePieceId(StructurePieceType.StructureTemplateType param0, String param1) {
        return setFullContextPieceId(param0, param1);
    }
    ...
    public interface ContextlessType extends StructurePieceType {
        ...
        @Override
        default StructurePiece load(StructurePieceSerializationContext param0, CompoundTag param1) {
            return this.load(param1);
        }
    }
    ...
    public interface StructureTemplateType extends StructurePieceType {
        ...
        @Override
        default StructurePiece load(StructurePieceSerializationContext param0, CompoundTag param1) {
            return this.load(param0.structureTemplateManager(), param1);
        }
    }
}
