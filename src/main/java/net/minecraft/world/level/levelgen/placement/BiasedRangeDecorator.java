...
public class BiasedRangeDecorator extends SimpleFeatureDecorator<RangeDecoratorConfiguration> {
    public BiasedRangeDecorator(Codec<RangeDecoratorConfiguration> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> place(Random param0, RangeDecoratorConfiguration param1, BlockPos param2) {
        ...
        int var2 = param0.nextInt(param0.nextInt(param1.maximum - param1.topOffset) + param1.bottomOffset);
