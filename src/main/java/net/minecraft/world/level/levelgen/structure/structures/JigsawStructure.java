...
public final class JigsawStructure extends Structure {
    ...
    public static P9<Mu<JigsawStructure>, HolderSet<Biome>, Map<MobCategory, StructureSpawnOverride>, GenerationStep.Decoration, Boolean, Holder<StructureTemplatePool>, Integer, HeightProvider, Boolean, Optional<Heightmap.Types>> jigsawCodec(
        ...
        P5<Mu<JigsawStructure>, Holder<StructureTemplatePool>, Integer, HeightProvider, Boolean, Optional<Heightmap.Types>> var1 = param0.group(
        ...
        return new P9<>(var0.t1(), var0.t2(), var0.t3(), var0.t4(), var1.t1(), var1.t2(), var1.t3(), var1.t4(), var1.t5());
    }
    ...
    public JigsawStructure(
        ...
        this(param0, param1, param2, param3, param4, param5, param6, param7, Optional.of(param8));
    }
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext param0) {
        ...
        return JigsawPlacement.addPieces(
            param0, this.startPool, this.maxDepth, PoolElementStructurePiece::new, var2, this.useExpansionHack, this.projectStartToHeightmap
        );
    }
