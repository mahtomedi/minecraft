...
public class GrowingPlantConfiguration implements FeatureConfiguration {
    public static final Codec<GrowingPlantConfiguration> CODEC = RecordCodecBuilder.create(
        param0 -> param0.group(
                    SimpleWeightedRandomList.wrappedCodec(IntProvider.CODEC).fieldOf("height_distribution").forGetter(param0x -> param0x.heightDistribution),
    ...
    public GrowingPlantConfiguration(
        SimpleWeightedRandomList<IntProvider> param0, Direction param1, BlockStateProvider param2, BlockStateProvider param3, boolean param4
    ) {
