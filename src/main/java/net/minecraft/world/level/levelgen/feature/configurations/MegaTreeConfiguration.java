...
public class MegaTreeConfiguration extends TreeConfiguration {
    ...
    protected MegaTreeConfiguration(BlockStateProvider param0, BlockStateProvider param1, List<TreeDecorator> param2, int param3, int param4) {
    ...
    public <T> Dynamic<T> serialize(DynamicOps<T> param0) {
        Dynamic<T> var0 = new Dynamic<>(
            param0, param0.createMap(ImmutableMap.of(param0.createString("height_interval"), param0.createInt(this.heightInterval)))
        );
    ...
    public static <T> MegaTreeConfiguration deserialize(Dynamic<T> param0) {
        ...
        return new MegaTreeConfiguration(var0.trunkProvider, var0.leavesProvider, var0.decorators, var0.baseHeight, param0.get("height_interval").asInt(0));
    }
