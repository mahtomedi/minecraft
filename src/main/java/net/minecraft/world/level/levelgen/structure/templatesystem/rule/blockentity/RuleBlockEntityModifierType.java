...
public interface RuleBlockEntityModifierType<P extends RuleBlockEntityModifier> {
    ...
    private static <P extends RuleBlockEntityModifier> RuleBlockEntityModifierType<P> register(String param0, Codec<P> param1) {
        return Registry.register(BuiltInRegistries.RULE_BLOCK_ENTITY_MODIFIER, param0, () -> param1);
    }
}
