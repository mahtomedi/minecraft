...
public interface StructurePoolElementType<P extends StructurePoolElement> {
    ...
    static <P extends StructurePoolElement> StructurePoolElementType<P> register(String param0, Codec<P> param1) {
        return Registry.register(BuiltInRegistries.STRUCTURE_POOL_ELEMENT, param0, () -> param1);
    }
}
