...
public class IcebergPlacementDecorator extends FeatureDecorator<DecoratorChance> {
    public IcebergPlacementDecorator(Function<Dynamic<?>, ? extends DecoratorChance> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> getPositions(
        ...
        if (param2.nextFloat() < 1.0F / (float)param3.chance) {
            int var0 = param2.nextInt(8) + 4;
            int var1 = param2.nextInt(8) + 4;
            return Stream.of(param0.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING, param4.offset(var0, 0, var1)));
        } else {
            return Stream.empty();
        }
    }
