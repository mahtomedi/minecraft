...
public abstract class FeatureDecorator<DC extends DecoratorConfiguration> {
    ...
    public static final FeatureDecorator<NoiseDependantDecoratorConfiguration> NOISE_HEIGHTMAP_DOUBLE = register(
        ...
        new NoiseHeightmapDoubleDecorator(NoiseDependantDecoratorConfiguration::deserialize, NoiseDependantDecoratorConfiguration::random)
    );
    ...
    public FeatureDecorator(Function<Dynamic<?>, ? extends DC> param0, Function<Random, ? extends DC> param1) {
        this.configurationFactory = param0;
        this.randomConfigurationFactory = param1;
    }
    ...
    public ConfiguredDecorator<DC> random(Random param0) {
        return new ConfiguredDecorator<>(this, this.randomConfigurationFactory.apply(param0));
    }
    ...
    protected <FC extends FeatureConfiguration, F extends Feature<FC>> boolean placeFeature(
        ...
        this.getPositions(param0, param1, param2, param4, param3).forEach(param5x -> {
            boolean var0x = param5.place(param0, param1, param2, param5x);
