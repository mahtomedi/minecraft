        ...
        if (param0.enabledFeatures().contains(FeatureFlags.UPDATE_1_20)) {
            ...
            for(BlockPos var5 : var3) {
                if (var4 > 0) {
                    ...
                    param0.getBlockEntity(var5, BlockEntityType.SUSPICIOUS_SAND)
                        .ifPresent(param1x -> param1x.setLootTable(UpdateOneTwentyBuiltInLootTables.DESERT_PYRAMID_ARCHAEOLOGY, var5.asLong()));
                } else {
