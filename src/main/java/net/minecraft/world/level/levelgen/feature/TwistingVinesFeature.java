...
public class TwistingVinesFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public boolean place(
        ...
        if (this.isInvalidPlacementLocation(param0, param3)) {
            return false;
        } else {
            this.placeTwistingVines(param0, param2, param3);
            return true;
        }
    }

    private void placeTwistingVines(LevelAccessor param0, Random param1, BlockPos param2) {
        BlockPos.MutableBlockPos var0 = new BlockPos.MutableBlockPos();

        for(int var1 = 0; var1 < 100; ++var1) {
            var0.set(param2).move(Mth.nextInt(param1, -8, 8), Mth.nextInt(param1, -2, 7), Mth.nextInt(param1, -8, 8));

            while(param0.getBlockState(var0.below()).isAir()) {
                var0.move(0, -1, 0);
            }

            if (!this.isInvalidPlacementLocation(param0, var0)) {
                int var2 = Mth.nextInt(param1, 1, 8);
    ...
    private boolean isInvalidPlacementLocation(LevelAccessor param0, BlockPos param1) {
