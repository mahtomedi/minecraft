...
public class LakeChanceDecoratorConfig implements DecoratorConfiguration {
    ...
    public LakeChanceDecoratorConfig(int param0) {
        this.chance = param0;
    }
    ...
    public static LakeChanceDecoratorConfig deserialize(Dynamic<?> param0) {
        int var0 = param0.get("chance").asInt(0);
        return new LakeChanceDecoratorConfig(var0);
    }
}
