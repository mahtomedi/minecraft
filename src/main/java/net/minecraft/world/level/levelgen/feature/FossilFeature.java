...
public class FossilFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public FossilFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> param0, Function<Random, ? extends NoneFeatureConfiguration> param1) {
        super(param0, param1);
    }
    ...
    public boolean place(
        ...
        ChunkPos var7 = new ChunkPos(param3);
        ...
        for(int var14 = 0; var14 < var10.getX(); ++var14) {
            for(int var15 = 0; var15 < var10.getZ(); ++var15) {
                var13 = Math.min(var13, param0.getHeight(Heightmap.Types.OCEAN_FLOOR_WG, param3.getX() + var14 + var11, param3.getZ() + var15 + var12));
            }
        }
