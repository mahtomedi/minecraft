...
public class NoiseSettings {
    ...
    public static NoiseSettings create(
        ...
        NoiseSettings var0 = new NoiseSettings(
            param0, param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13
        );
