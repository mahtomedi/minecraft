...
public record NoiseSettings(
    ...
    public static NoiseSettings create(int param0, int param1, NoiseSamplingSettings param2, NoiseSlider param3, NoiseSlider param4, int param5, int param6) {
        NoiseSettings var0 = new NoiseSettings(param0, param1, param2, param3, param4, param5, param6);
    ...
    protected static NoiseSettings overworldNoiseSettings(boolean param0) {
        return create(
            -64,
            384,
