...
public class CountBiasedRangeDecorator extends SimpleFeatureDecorator<DecoratorCountRange> {
    public CountBiasedRangeDecorator(Function<Dynamic<?>, ? extends DecoratorCountRange> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> place(Random param0, DecoratorCountRange param1, BlockPos param2) {
        return IntStream.range(0, param1.count).mapToObj(param3 -> {
            ...
            int var1x = param0.nextInt(param0.nextInt(param1.maximum - param1.topOffset) + param1.bottomOffset);
