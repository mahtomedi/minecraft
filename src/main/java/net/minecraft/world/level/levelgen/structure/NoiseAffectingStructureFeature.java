...
public abstract class NoiseAffectingStructureFeature<C extends FeatureConfiguration> extends StructureFeature<C> {
    public NoiseAffectingStructureFeature(Codec<C> param0, PieceGeneratorSupplier<C> param1) {
        super(param0, param1);
    }

    public NoiseAffectingStructureFeature(Codec<C> param0, PieceGeneratorSupplier<C> param1, PostPlacementProcessor param2) {
