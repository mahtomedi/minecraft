...
public interface BuiltinStructures {
    ...
    private static ResourceKey<ConfiguredStructureFeature<?, ?>> createKey(String param0) {
        return ResourceKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation(param0));
    }
}
