...
public interface PlacementModifierType<P extends PlacementModifier> {
    ...
    private static <P extends PlacementModifier> PlacementModifierType<P> register(String param0, Codec<P> param1) {
        return Registry.register(BuiltInRegistries.PLACEMENT_MODIFIER_TYPE, param0, () -> param1);
    }
}
