...
public class EndCityPieces {
    ...
    private static final EndCityPieces.SectionGenerator HOUSE_TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
        ...
        public boolean generate(
            StructureManager param0, int param1, EndCityPieces.EndCityPiece param2, BlockPos param3, List<StructurePiece> param4, Random param5
        ) {
            if (param1 > 8) {
                return false;
            } else {
    ...
    public static void startHouseTower(StructureManager param0, BlockPos param1, Rotation param2, List<StructurePiece> param3, Random param4) {
