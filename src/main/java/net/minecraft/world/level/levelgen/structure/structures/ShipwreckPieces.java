...
public class ShipwreckPieces {
    ...
    public static void addPieces(
        StructureTemplateManager param0, BlockPos param1, Rotation param2, StructurePieceAccessor param3, RandomSource param4, boolean param5
    ) {
        ResourceLocation var0 = Util.getRandom(param5 ? STRUCTURE_LOCATION_BEACHED : STRUCTURE_LOCATION_OCEAN, param4);
        param3.addPiece(new ShipwreckPieces.ShipwreckPiece(param0, var0, param1, param2, param5));
    }

    public static class ShipwreckPiece extends TemplateStructurePiece {
        private final boolean isBeached;

        public ShipwreckPiece(StructureTemplateManager param0, ResourceLocation param1, BlockPos param2, Rotation param3, boolean param4) {
            super(StructurePieceType.SHIPWRECK_PIECE, 0, param0, param1, param1.toString(), makeSettings(param3), param2);
            this.isBeached = param4;
        }

        public ShipwreckPiece(StructureTemplateManager param0, CompoundTag param1) {
