...
public abstract class Feature<FC extends FeatureConfiguration> {
    ...
    public static final BiMap<String, StructureFeature<?>> STRUCTURES_REGISTRY = Util.make(HashBiMap.create(), param0 -> {
        ...
        param0.put("Ship".toLowerCase(Locale.ROOT), SHIP);
    });
    ...
    public Feature(Function<Dynamic<?>, ? extends FC> param0, Function<Random, ? extends FC> param1) {
    ...
    public ConfiguredFeature<FC, ?> random(Random param0) {
