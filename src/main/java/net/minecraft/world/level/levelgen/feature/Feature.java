...
public abstract class Feature<FC extends FeatureConfiguration> {
    ...
    public static final Feature<NoneFeatureConfiguration> JUNGLE_TREE = register(
        ...
        new JungleTreeFeature(
            NoneFeatureConfiguration::deserialize, false, 4, Blocks.JUNGLE_LOG.defaultBlockState(), Blocks.JUNGLE_LEAVES.defaultBlockState(), true
        )
    );
    ...
    public static final Feature<HellSpringConfiguration> NETHER_SPRING = register(
        "nether_spring", new NetherSpringFeature(HellSpringConfiguration::deserialize)
    );
    ...
    public Feature(Function<Dynamic<?>, ? extends FC> param0, boolean param1) {
        this.configurationFactory = param0;
        this.doUpdate = param1;
    }
