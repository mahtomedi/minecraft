...
public class CountHeightmap32Decorator extends FeatureDecorator<DecoratorFrequency> {
    public CountHeightmap32Decorator(Function<Dynamic<?>, ? extends DecoratorFrequency> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> getPositions(
        ...
        return IntStream.range(0, param3.count).mapToObj(param3x -> {
            ...
            int var2x = param0.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING, param4.offset(var0, 0, var1x)).getY() + 32;
            if (var2x <= 0) {
                return null;
            } else {
