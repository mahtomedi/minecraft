...
public class CountHeightmap32Decorator extends FeatureDecorator<FrequencyDecoratorConfiguration> {
    public CountHeightmap32Decorator(Function<Dynamic<?>, ? extends FrequencyDecoratorConfiguration> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> getPositions(LevelAccessor param0, ChunkGenerator param1, Random param2, FrequencyDecoratorConfiguration param3, BlockPos param4) {
        return IntStream.range(0, param3.count).mapToObj(param3x -> {
            ...
            int var2x = param0.getHeight(Heightmap.Types.MOTION_BLOCKING, var0, var1x) + 32;
