...
public class DripstoneClusterFeature extends Feature<DripstoneClusterConfiguration> {
    ...
    private void placeColumn(
        ...
        Optional<Column> var0 = Column.scan(param0, param2, param9.floorToCeilingSearchRange, DripstoneUtils::isEmptyOrWater, DripstoneUtils::isDripstoneBase);
        if (var0.isPresent()) {
            ...
            if (var1.isPresent() || var2.isPresent()) {
                ...
                boolean var28 = param1.nextBoolean();
                if (var1.isPresent()) {
