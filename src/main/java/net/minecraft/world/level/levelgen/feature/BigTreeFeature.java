...
public class BigTreeFeature extends AbstractTreeFeature<NoneFeatureConfiguration> {
    ...
    public BigTreeFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> param0, boolean param1) {
        super(param0, param1);
    }

    private void crossSection(LevelSimulatedRW param0, BlockPos param1, float param2, BoundingBox param3, Set<BlockPos> param4) {
        int var0 = (int)((double)param2 + 0.618);

        for(int var1 = -var0; var1 <= var0; ++var1) {
            for(int var2 = -var0; var2 <= var0; ++var2) {
                if (Math.pow((double)Math.abs(var1) + 0.5, 2.0) + Math.pow((double)Math.abs(var2) + 0.5, 2.0) <= (double)(param2 * param2)) {
                    BlockPos var3 = param1.offset(var1, 0, var2);
                    if (isAirOrLeaves(param0, var3)) {
                        this.setBlock(param4, param0, var3, LEAVES, param3);
                    }
                }
            }
        }
    ...
    private void foliageCluster(LevelSimulatedRW param0, BlockPos param1, BoundingBox param2, Set<BlockPos> param3) {
        for(int var0 = 0; var0 < 5; ++var0) {
            this.crossSection(param0, param1.above(var0), this.foliageShape(var0), param2, param3);
        }

    }

    private int makeLimb(Set<BlockPos> param0, LevelSimulatedRW param1, BlockPos param2, BlockPos param3, boolean param4, BoundingBox param5) {
        if (!param4 && Objects.equals(param2, param3)) {
            ...
            for(int var5 = 0; var5 <= var1; ++var5) {
                ...
                if (param4) {
                    this.setBlock(param0, param1, var6, LOG.setValue(LogBlock.AXIS, this.getLogAxis(param2, var6)), param5);
                } else if (!isFree(param1, var6)) {
                    return var5;
                }
            }
    ...
    private void makeFoliage(
        LevelSimulatedRW param0, int param1, BlockPos param2, List<BigTreeFeature.FoliageCoords> param3, BoundingBox param4, Set<BlockPos> param5
    ) {
        for(BigTreeFeature.FoliageCoords var0 : param3) {
            if (this.trimBranches(param1, var0.getBranchBase() - param2.getY())) {
                this.foliageCluster(param0, var0, param4, param5);
            }
        }
    ...
    private void makeTrunk(Set<BlockPos> param0, LevelSimulatedRW param1, BlockPos param2, int param3, BoundingBox param4) {
        this.makeLimb(param0, param1, param2, param2.above(param3), true, param4);
    }

    private void makeBranches(
        Set<BlockPos> param0, LevelSimulatedRW param1, int param2, BlockPos param3, List<BigTreeFeature.FoliageCoords> param4, BoundingBox param5
    ) {
        for(BigTreeFeature.FoliageCoords var0 : param4) {
            ...
            if (!var2.equals(var0) && this.trimBranches(param2, var1 - param3.getY())) {
                this.makeLimb(param0, param1, var2, var0, true, param5);
            }
        }
    ...
    public boolean doPlace(Set<BlockPos> param0, LevelSimulatedRW param1, Random param2, BlockPos param3, BoundingBox param4) {
        Random var0 = new Random(param2.nextLong());
        int var1 = this.checkLocation(param0, param1, param3, 5 + var0.nextInt(12), param4);
        if (var1 == -1) {
            return false;
        } else {
            ...
            int var6 = var1 - 5;
            List<BigTreeFeature.FoliageCoords> var7 = Lists.newArrayList();
            var7.add(new BigTreeFeature.FoliageCoords(param3.above(var6), var5));
            ...
            for(; var6 >= 0; --var6) {
                ...
                if (!(var8 < 0.0F)) {
                    for(int var9 = 0; var9 < var4; ++var9) {
                        ...
                        if (this.makeLimb(param0, param1, var15, var16, false, param4) == -1) {
                            ...
                            if (this.makeLimb(param0, param1, var21, var15, false, param4) == -1) {
                                var7.add(new BigTreeFeature.FoliageCoords(var15, var21.getY()));
                            }
                        }
                    }
                }
            ...
            this.makeFoliage(param1, var1, param3, var7, param4, param0);
            this.makeTrunk(param0, param1, param3, var2, param4);
            this.makeBranches(param0, param1, var1, param3, var7, param4);
            return true;
        }
    }

    private int checkLocation(Set<BlockPos> param0, LevelSimulatedRW param1, BlockPos param2, int param3, BoundingBox param4) {
        if (!isGrassOrDirtOrFarmland(param1, param2.below())) {
            return -1;
        } else {
            int var0 = this.makeLimb(param0, param1, param2, param2.above(param3 - 1), false, param4);
            if (var0 == -1) {
                return param3;
            } else {
