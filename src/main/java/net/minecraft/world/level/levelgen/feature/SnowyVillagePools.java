        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/snowy/streets/corner_01", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/corner_02", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/corner_03", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/square_01", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_01", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_02", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_03", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_04", var1), 7),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_06", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/straight_08", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_02", var1), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_03", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_04", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_05", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/crossroad_06", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/streets/turn_01", var1), 3)
                    ),
        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    new ResourceLocation("village/snowy/terminators"),
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/corner_01", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/corner_02", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/corner_03", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/square_01", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_01", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_02", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_03", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_04", var1), 7),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_06", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/straight_08", var1), 4),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/crossroad_02", var1), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/crossroad_03", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/crossroad_04", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/crossroad_05", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/crossroad_06", var1), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/streets/turn_01", var1), 3)
                    ),
                    StructureTemplatePool.Projection.TERRAIN_MATCHING
                )
            );
            ...
            .register(
                new StructureTemplatePool(
                    ...
                    ImmutableList.of(
                        ...
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_1", var2), 3),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_2", var2), 3),
        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    new ResourceLocation("village/snowy/terminators"),
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_3", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_4", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_5", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_6", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_7", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_small_house_8", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_medium_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_medium_house_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/zombie/houses/snowy_medium_house_3", var0), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_butchers_shop_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_butchers_shop_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_tool_smith_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_fletcher_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_shepherds_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_armorer_house_1", var0), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_armorer_house_2", var0), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_fisher_cottage", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_tannery_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_cartographer_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_library_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_masons_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_masons_house_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_weapon_smith_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_temple_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_1", var0), 3),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_farm_2", var0), 3),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_animal_pen_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/snowy/houses/snowy_animal_pen_2", var0), 2),
                        Pair.of(EmptyPoolElement.INSTANCE, 6)
                    ),
                    StructureTemplatePool.Projection.RIGID
                )
        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    new ResourceLocation("empty"),
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/snowy/snowy_lamp_post_01", var0), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/snowy_lamp_post_02", var0), 1),
                        new Pair<>(new SinglePoolElement("village/snowy/snowy_lamp_post_03", var0), 1),
                        new Pair<>(new FeaturePoolElement(Feature.NORMAL_TREE.configured(BiomeDefaultFeatures.SPRUCE_TREE_CONFIG)), 4),
                        new Pair<>(new FeaturePoolElement(Feature.BLOCK_PILE.configured(BiomeDefaultFeatures.SNOW_PILE_CONFIG)), 4),
