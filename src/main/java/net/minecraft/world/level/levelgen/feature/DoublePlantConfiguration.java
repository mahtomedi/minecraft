...
public class DoublePlantConfiguration implements FeatureConfiguration {
    ...
    public DoublePlantConfiguration(BlockState param0) {
        this.state = param0;
    }
    ...
    public static <T> DoublePlantConfiguration deserialize(Dynamic<T> param0) {
        BlockState var0 = param0.get("state").map(BlockState::deserialize).orElse(Blocks.AIR.defaultBlockState());
        return new DoublePlantConfiguration(var0);
    }
}
