...
public abstract class SurfaceBuilder<C extends SurfaceBuilderConfiguration> {
    ...
    public static final SurfaceBuilder<SurfaceBuilderBaseConfiguration> GROVE = register(
        "grove", new GroveSurfaceBuilder(SurfaceBuilderBaseConfiguration.CODEC)
    );
    ...
    public SurfaceBuilder(Codec<C> param0) {
        this.configuredCodec = param0.fieldOf("config").xmap(this::configured, ConfiguredSurfaceBuilder::config).codec();
    }
    ...
    public ConfiguredSurfaceBuilder<C> configured(C param0x) {
        return new ConfiguredSurfaceBuilder<>(this, param0x);
    }
