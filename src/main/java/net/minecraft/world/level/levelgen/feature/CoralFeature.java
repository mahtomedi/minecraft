...
public abstract class CoralFeature extends Feature<NoneFeatureConfiguration> {
    public CoralFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> param0, Function<Random, ? extends NoneFeatureConfiguration> param1) {
        super(param0, param1);
    }
    ...
    protected boolean placeCoralBlock(LevelAccessor param0, Random param1, BlockPos param2, BlockState param3) {
        ...
        if ((var1.getBlock() == Blocks.WATER || var1.is(BlockTags.CORALS)) && param0.getBlockState(var0).getBlock() == Blocks.WATER) {
            ...
            for(Direction var2 : Direction.Plane.HORIZONTAL) {
                if (param1.nextFloat() < 0.2F) {
                    ...
                    if (param0.getBlockState(var3).getBlock() == Blocks.WATER) {
