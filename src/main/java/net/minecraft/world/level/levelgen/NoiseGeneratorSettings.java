...
public record NoiseGeneratorSettings(
    ...
    private static NoiseGeneratorSettings end(BootstapContext<?> param0) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.end(param0.lookup(Registries.DENSITY_FUNCTION)),
            SurfaceRuleData.end(),
            List.of(),
            0,
            true,
    ...
    private static NoiseGeneratorSettings nether(BootstapContext<?> param0) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.nether(param0.lookup(Registries.DENSITY_FUNCTION), param0.lookup(Registries.NOISE)),
    ...
    private static NoiseGeneratorSettings overworld(BootstapContext<?> param0, boolean param1, boolean param2) {
        return new NoiseGeneratorSettings(
            ...
            NoiseRouterData.overworld(param0.lookup(Registries.DENSITY_FUNCTION), param0.lookup(Registries.NOISE), param2, param1),
    ...
    private static NoiseGeneratorSettings caves(BootstapContext<?> param0) {
        return new NoiseGeneratorSettings(
            ...
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.caves(param0.lookup(Registries.DENSITY_FUNCTION), param0.lookup(Registries.NOISE)),
    ...
    private static NoiseGeneratorSettings floatingIslands(BootstapContext<?> param0) {
        return new NoiseGeneratorSettings(
            ...
            Blocks.STONE.defaultBlockState(),
            Blocks.WATER.defaultBlockState(),
            NoiseRouterData.floatingIslands(param0.lookup(Registries.DENSITY_FUNCTION), param0.lookup(Registries.NOISE)),
