...
public class DecoratorFrequencyWithExtraChance implements DecoratorConfiguration {
    ...
    public DecoratorFrequencyWithExtraChance(int param0, float param1, int param2) {
        this.count = param0;
    ...
    public static DecoratorFrequencyWithExtraChance deserialize(Dynamic<?> param0) {
        int var0 = param0.get("count").asInt(0);
        float var1 = param0.get("extra_chance").asFloat(0.0F);
        int var2 = param0.get("extra_count").asInt(0);
        return new DecoratorFrequencyWithExtraChance(var0, var1, var2);
    }
}
