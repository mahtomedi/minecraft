...
public class RandomSpreadStructurePlacement extends StructurePlacement {
    ...
    private static DataResult<RandomSpreadStructurePlacement> validate(RandomSpreadStructurePlacement param0) {
        return param0.spacing <= param0.separation ? DataResult.error(() -> "Spacing has to be larger than separation") : DataResult.success(param0);
    }
