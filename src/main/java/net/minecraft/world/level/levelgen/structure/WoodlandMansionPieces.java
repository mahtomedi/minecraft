...
public class WoodlandMansionPieces {
    public static void generateMansion(
        StructureManager param0, BlockPos param1, Rotation param2, List<WoodlandMansionPieces.WoodlandMansionPiece> param3, Random param4
    ) {
    ...
    static class FirstFloorRoomCollection extends WoodlandMansionPieces.FloorRoomCollection {
        ...
        @Override
        public String get1x1Secret(Random param0) {
            return "1x1_as" + (param0.nextInt(4) + 1);
        }

        @Override
        public String get1x2SideEntrance(Random param0, boolean param1) {
            return "1x2_a" + (param0.nextInt(9) + 1);
        }

        @Override
        public String get1x2FrontEntrance(Random param0, boolean param1) {
            return "1x2_b" + (param0.nextInt(5) + 1);
        }

        @Override
        public String get1x2Secret(Random param0) {
            return "1x2_s" + (param0.nextInt(2) + 1);
        }

        @Override
        public String get2x2(Random param0) {
            return "2x2_a" + (param0.nextInt(4) + 1);
        }

        @Override
        public String get2x2Secret(Random param0) {
            return "2x2_s1";
        }
    }
    ...
    static class MansionGrid {
        ...
        private void identifyRooms(WoodlandMansionPieces.SimpleGrid param0, WoodlandMansionPieces.SimpleGrid param1) {
            ...
            Collections.shuffle(var0, this.random);
            int var3 = 10;
    ...
    static class MansionPiecePlacer {
        ...
        public MansionPiecePlacer(StructureManager param0, Random param1) {
                ...
                for(int var17 = 0; var17 < var14.height; ++var17) {
                    for(int var18 = 0; var18 < var14.width; ++var18) {
                        if (var14.get(var18, var17) == 1) {
                            ...
                            param2.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "corridor_floor", var19, param1));
                            if (var14.get(var18, var17 - 1) == 1 || (var13.get(var18, var17 - 1) & 8388608) == 8388608) {
                                param2.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "carpet_north", var19.relative(param1.rotate(Direction.EAST), 1).above(), param1
                                    )
                                );
                            }
                    ...
                    for(int var24 = 0; var24 < var14.width; ++var24) {
                        ...
                        if (var14.get(var24, var23) == 2 || var25) {
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(var14, var24 - 1, var23) && !param3.isRoomId(var14, var24 - 1, var23, var11, var28)) {
                                param2.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, var30 == Direction.WEST ? var21 : var20, var31, param1
                                    )
                                );
                            }
                            ...
                            if (var14.get(var24 + 1, var23) == 1 && !var25) {
                                ...
                                param2.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, var30 == Direction.EAST ? var21 : var20, var32, param1
                                    )
                                );
                            }
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(var14, var24, var23 + 1) && !param3.isRoomId(var14, var24, var23 + 1, var11, var28)) {
                                ...
                                param2.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, var30 == Direction.SOUTH ? var21 : var20, var33, param1.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            }
                            ...
                            if (var14.get(var24, var23 - 1) == 1 && !var25) {
                                ...
                                param2.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, var30 == Direction.NORTH ? var21 : var20, var34, param1.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            }
            ...
            for(int var0 = 0; var0 < param3.height; ++var0) {
                for(int var1 = 0; var1 < param3.width; ++var1) {
                    ...
                    if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var1, var0) && !var3) {
                        param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof", var22.above(3), param2));
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var1 + 1, var0)) {
                            ...
                            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_front", var4, param2));
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var1 - 1, var0)) {
                            ...
                            param0.add(
                                new WoodlandMansionPieces.WoodlandMansionPiece(
                                    this.structureManager, "roof_front", var5, param2.getRotated(Rotation.CLOCKWISE_180)
                                )
                            );
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var1, var0 - 1)) {
                            ...
                            param0.add(
                                new WoodlandMansionPieces.WoodlandMansionPiece(
                                    this.structureManager, "roof_front", var6, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                                )
                            );
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var1, var0 + 1)) {
                            ...
                            param0.add(
                                new WoodlandMansionPieces.WoodlandMansionPiece(
                                    this.structureManager, "roof_front", var7, param2.getRotated(Rotation.CLOCKWISE_90)
                                )
                            );
                        }
                    }
                    ...
                    for(int var9 = 0; var9 < param3.width; ++var9) {
                        ...
                        if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8) && var11) {
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9 + 1, var8)) {
                                ...
                                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall", var12, param2));
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9 - 1, var8)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "small_wall", var13, param2.getRotated(Rotation.CLOCKWISE_180)
                                    )
                                );
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 - 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "small_wall", var14, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 + 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "small_wall", var15, param2.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9 + 1, var8)) {
                                if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 - 1)) {
                                    ...
                                    param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "small_wall_corner", var16, param2));
                                }
                                ...
                                if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 + 1)) {
                                    ...
                                    param0.add(
                                        new WoodlandMansionPieces.WoodlandMansionPiece(
                                            this.structureManager, "small_wall_corner", var17x, param2.getRotated(Rotation.CLOCKWISE_90)
                                        )
                                    );
                                }
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9 - 1, var8)) {
                                if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 - 1)) {
                                    ...
                                    param0.add(
                                        new WoodlandMansionPieces.WoodlandMansionPiece(
                                            this.structureManager, "small_wall_corner", var18, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                                        )
                                    );
                                }
                                ...
                                if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var9, var8 + 1)) {
                                    ...
                                    param0.add(
                                        new WoodlandMansionPieces.WoodlandMansionPiece(
                                            this.structureManager, "small_wall_corner", var19, param2.getRotated(Rotation.CLOCKWISE_180)
                                        )
                                    );
                                }
                            }
                    ...
                    if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var21, var20) && !var23) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21 + 1, var20)) {
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21, var20 + 1)) {
                                ...
                                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_corner", var25, param2));
                                ...
                                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "roof_inner_corner", var26, param2));
                            }

                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21, var20 - 1)) {
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_corner", var24, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            } else if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var21 + 1, var20 - 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_inner_corner", var27, param2.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            }
                        }
                        ...
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21 - 1, var20)) {
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21, var20 + 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_corner", var29, param2.getRotated(Rotation.CLOCKWISE_90)
                                    )
                                );
                            } else if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var21 - 1, var20 + 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_inner_corner", var30, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                                    )
                                );
                            }
                            ...
                            if (!WoodlandMansionPieces.MansionGrid.isHouse(param3, var21, var20 - 1)) {
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_corner", var28, param2.getRotated(Rotation.CLOCKWISE_180)
                                    )
                                );
                            } else if (WoodlandMansionPieces.MansionGrid.isHouse(param3, var21 - 1, var20 - 1)) {
                                ...
                                param0.add(
                                    new WoodlandMansionPieces.WoodlandMansionPiece(
                                        this.structureManager, "roof_inner_corner", var31, param2.getRotated(Rotation.CLOCKWISE_180)
                                    )
                                );
                            }
                        }
        ...
        private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> param0, WoodlandMansionPieces.PlacementData param1) {
            ...
            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "entrance", param1.position.relative(var0, 9), param1.rotation));
        ...
        private void traverseWallPiece(List<WoodlandMansionPieces.WoodlandMansionPiece> param0, WoodlandMansionPieces.PlacementData param1) {
            param0.add(
                new WoodlandMansionPieces.WoodlandMansionPiece(
                    this.structureManager, param1.wallType, param1.position.relative(param1.rotation.rotate(Direction.EAST), 7), param1.rotation
                )
            );
        ...
        private void traverseTurn(List<WoodlandMansionPieces.WoodlandMansionPiece> param0, WoodlandMansionPieces.PlacementData param1) {
            ...
            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, "wall_corner", param1.position, param1.rotation));
        ...
        private void addRoom1x1(
            ...
            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, var1, var3, var0));
        }
        ...
        private void addRoom1x2(
            ...
            if (param4 == Direction.EAST && param3 == Direction.SOUTH) {
                ...
                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, param5.get1x2SideEntrance(this.random, param6), var0, param2));
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2SideEntrance(this.random, param6), var1, param2, Mirror.LEFT_RIGHT
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2SideEntrance(this.random, param6), var2, param2.getRotated(Rotation.CLOCKWISE_180)
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2SideEntrance(this.random, param6), var3, param2, Mirror.FRONT_BACK
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2SideEntrance(this.random, param6), var5, param2.getRotated(Rotation.CLOCKWISE_90)
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2SideEntrance(this.random, param6), var7, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                    )
                );
                ...
                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, param5.get1x2FrontEntrance(this.random, param6), var8, param2));
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2FrontEntrance(this.random, param6), var9, param2.getRotated(Rotation.CLOCKWISE_180)
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2FrontEntrance(this.random, param6), var10, param2.getRotated(Rotation.CLOCKWISE_90)
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2FrontEntrance(this.random, param6), var11, param2.getRotated(Rotation.COUNTERCLOCKWISE_90)
                    )
                );
                ...
                param0.add(
                    new WoodlandMansionPieces.WoodlandMansionPiece(
                        this.structureManager, param5.get1x2Secret(this.random), var12, param2.getRotated(Rotation.CLOCKWISE_90)
                    )
                );
                ...
                param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, param5.get1x2Secret(this.random), var13, param2));
            }
        ...
        private void addRoom2x2(
            ...
            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, param5.get2x2(this.random), var4, var2, var3));
        }
        ...
        private void addRoom2x2Secret(
            ...
            BlockPos var0 = param1.relative(param2.rotate(Direction.EAST), 1);
            param0.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureManager, param3.get2x2Secret(this.random), var0, param2, Mirror.NONE));
        }
    }
    ...
    public static class WoodlandMansionPiece extends TemplateStructurePiece {
        ...
        protected void handleDataMarker(String param0, BlockPos param1, LevelAccessor param2, Random param3, BoundingBox param4) {
            if (param0.startsWith("Chest")) {
                ...
                var2.finalizeSpawn(param2, param2.getCurrentDifficultyAt(new BlockPos(var2)), MobSpawnType.STRUCTURE, null, null);
