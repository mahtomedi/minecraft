...
public class SinglePoolElement extends StructurePoolElement {
    ...
    public SinglePoolElement(Dynamic<?> param0) {
        super(param0);
        this.location = new ResourceLocation(param0.get("location").asString(""));
    ...
    protected StructurePlaceSettings getSettings(Rotation param0, BoundingBox param1) {
        ...
        return new Dynamic<>(
            ...
            param0.createMap(
                ImmutableMap.of(
                    ...
                    param0.createString(this.location.toString()),
