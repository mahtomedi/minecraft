...
public class UnderwaterCaveWorldCarver extends CaveWorldCarver {
    public UnderwaterCaveWorldCarver(Function<Dynamic<?>, ? extends ProbabilityFeatureConfiguration> param0) {
        super(param0, 256);
    ...
    protected boolean carveBlock(
        ...
        return carveBlock(this, param0, param1, param2, param3, param6, param7, param8, param9, param10, param11, param12, param13);
    }
