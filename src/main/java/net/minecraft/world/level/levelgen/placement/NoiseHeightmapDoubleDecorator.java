...
public class NoiseHeightmapDoubleDecorator extends FeatureDecorator<DecoratorNoiseDependant> {
    public NoiseHeightmapDoubleDecorator(Function<Dynamic<?>, ? extends DecoratorNoiseDependant> param0) {
        super(param0);
    }
    ...
    public Stream<BlockPos> getPositions(
        ...
        return IntStream.range(0, var1).mapToObj(param3x -> {
            ...
            int var2x = param0.getHeightmapPos(Heightmap.Types.MOTION_BLOCKING, param4.offset(var0x, 0, var1x)).getY() * 2;
            if (var2x <= 0) {
                return null;
            } else {
