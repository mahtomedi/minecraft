            ...
            .register(
                new StructureTemplatePool(
                    ...
                    ImmutableList.of(
                        ...
                        new Pair<>(new SinglePoolElement("village/desert/zombie/town_centers/desert_meeting_point_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/town_centers/desert_meeting_point_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/town_centers/desert_meeting_point_3", var0), 1)
                    ),
            ...
            .register(
                new StructureTemplatePool(
                    ...
                    ImmutableList.of(
                        ...
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_large_farm_1", var1), 11),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_farm_1", var1), 4),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_farm_2", var1), 4),
        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    new ResourceLocation("village/desert/zombie/terminators"),
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_3", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_4", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_5", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_6", var0), 1),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_7", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_small_house_8", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_medium_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/zombie/houses/desert_medium_house_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_butcher_shop_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_tool_smith_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_fletcher_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_shepherd_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_armorer_1", var0), 1),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_fisher_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_tannery_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_cartographer_house_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_library_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_mason_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_weaponsmith_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_temple_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_temple_2", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_large_farm_1", var0), 7),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_farm_1", var0), 4),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_farm_2", var0), 4),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_animal_pen_1", var0), 2),
                        new Pair<>(new SinglePoolElement("village/desert/houses/desert_animal_pen_2", var0), 2),
                        Pair.of(EmptyPoolElement.INSTANCE, 5)
                    ),
                    StructureTemplatePool.Projection.RIGID
                )
        ...
        JigsawPlacement.POOLS
            .register(
                new StructureTemplatePool(
                    ...
                    new ResourceLocation("empty"),
                    ImmutableList.of(
                        new Pair<>(new SinglePoolElement("village/desert/desert_lamp_1", var0), 10),
                        new Pair<>(new FeaturePoolElement(new ConfiguredFeature<>(Feature.CACTUS, FeatureConfiguration.NONE)), 4),
                        new Pair<>(new FeaturePoolElement(new ConfiguredFeature<>(Feature.HAY_PILE, FeatureConfiguration.NONE)), 4),
                        Pair.of(EmptyPoolElement.INSTANCE, 10)
                    ),
