...
public class JungleGrassFeature extends Feature<NoneFeatureConfiguration> {
    public JungleGrassFeature(Function<Dynamic<?>, ? extends NoneFeatureConfiguration> param0) {
        super(param0);
    }

    public BlockState getState(Random param0) {
        return param0.nextInt(4) == 0 ? Blocks.FERN.defaultBlockState() : Blocks.GRASS.defaultBlockState();
    }
    ...
    public boolean place(
        ...
        for(int var3 = 0; var3 < 128; ++var3) {
            ...
            if (param0.isEmptyBlock(var4) && param0.getBlockState(var4.below()).getBlock() != Blocks.PODZOL && var0.canSurvive(param0, var4)) {
