...
public class MapColor {
    ...
    private MapColor(int param0, int param1) {
    ...
    public int calculateRGBColor(MapColor.Brightness param0) {
        if (this == NONE) {
            return 0;
        } else {
    ...
    public static MapColor byId(int param0) {
        Preconditions.checkPositionIndex(param0, MATERIAL_COLORS.length, "material id");
        return byIdUnsafe(param0);
    }

    private static MapColor byIdUnsafe(int param0) {
        MapColor var0 = MATERIAL_COLORS[param0];
        return var0 != null ? var0 : NONE;
    }

    public static int getColorFromPackedId(int param0) {
        int var0 = param0 & 0xFF;
        return byIdUnsafe(var0 >> 2).calculateRGBColor(MapColor.Brightness.byIdUnsafe(var0 & 3));
    }

    public byte getPackedId(MapColor.Brightness param0) {
    ...
    public static enum Brightness {
        ...
        public static MapColor.Brightness byId(int param0) {
            Preconditions.checkPositionIndex(param0, VALUES.length, "brightness id");
            return byIdUnsafe(param0);
        }

        static MapColor.Brightness byIdUnsafe(int param0) {
