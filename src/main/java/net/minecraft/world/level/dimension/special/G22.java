...
public class G22 extends SpecialDimensionBase {
    public G22(Level param0, DimensionType param1) {
    ...
    public static class Generator extends ChunkGenerator<NoneGeneratorSettings> {
        ...
        public void createStructures(BiomeManager param0, ChunkAccess param1, ChunkGenerator<?> param2, StructureManager param3) {
            if (this.template == null) {
                this.template = param3.getOrCreate(new ResourceLocation("house_of_bob"));
            }
            ...
            for(int var1 = 0; var1 < 16; ++var1) {
                for(int var2 = 0; var2 < 16; ++var2) {
                    for(int var3 = 0; var3 < 64; ++var3) {
                        param1.setBlockState(var0.set(var1, var3, var2), Blocks.DIRT.defaultBlockState(), false);
                    }
                }
            }
        ...
        public void applyBiomeDecoration(WorldGenRegion param0) {
            ...
            if (var0 == 0 && var1 == 0) {
                BlockPos var2 = new BlockPos(0, 60, 0);
