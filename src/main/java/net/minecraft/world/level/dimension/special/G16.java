...
public class G16 extends SpecialDimensionBase {
    public G16(Level param0, DimensionType param1) {
    ...
    public static class Generator extends ChunkGenerator<NoneGeneratorSettings> {
        ...
        public void createStructures(BiomeManager param0, ChunkAccess param1, ChunkGenerator<?> param2, StructureManager param3) {
            if (this.library == null) {
                this.library = param3.getOrCreate(new ResourceLocation("library"));
            }
        ...
        public void applyBiomeDecoration(WorldGenRegion param0) {
            ...
            for(int var2 = 0; var2 < 16; ++var2) {
                BlockPos var3 = new BlockPos(16 * var0, var2 * 16, 16 * var1);
                this.library.placeInWorld(param0, var3, var3, new StructurePlaceSettings(), 4);
            }
