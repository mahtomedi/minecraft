...
public class G33 extends NormalDimension {
    public G33(Level param0, DimensionType param1) {
        super(param0, param1);
    }

    @Override
    public ChunkGenerator<? extends ChunkGeneratorSettings> createRandomLevelGenerator() {
        FixedBiomeSourceSettings var0 = BiomeSourceType.FIXED.createSettings(0L).setBiome(Biomes.BUSY);
        return ChunkGeneratorType.SURFACE.create(this.level, new FixedBiomeSource(var0), ChunkGeneratorType.SURFACE.createSettings());
    }
    ...
    public static class BusyBiome extends Biome {
        public BusyBiome() {
            ...
            ConfiguredDecorator<CountRangeDecoratorConfiguration> var0 = FeatureDecorator.COUNT_RANGE
            ...
            this.addFeature(
                GenerationStep.Decoration.UNDERGROUND_ORES,
                Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Blocks.PISTON.defaultBlockState(), 17)).decorated(var0)
            );
            this.addFeature(
                GenerationStep.Decoration.UNDERGROUND_ORES,
                Feature.ORE
            ...
            this.addFeature(
                GenerationStep.Decoration.UNDERGROUND_ORES,
                Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Blocks.DROPPER.defaultBlockState(), 8)).decorated(var0)
            );
            this.addFeature(
                GenerationStep.Decoration.UNDERGROUND_ORES,
                Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Blocks.OBSERVER.defaultBlockState(), 8)).decorated(var0)
            );
            this.addFeature(
                GenerationStep.Decoration.UNDERGROUND_ORES,
                Feature.ORE.configured(new OreConfiguration(OreConfiguration.Predicates.NATURAL_STONE, Blocks.HOPPER.defaultBlockState(), 7)).decorated(var0)
            );
        }
    }
}
