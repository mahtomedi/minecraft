...
public abstract class Biome {
    ...
    public static <F extends FeatureConfiguration, D extends DecoratorConfiguration> ConfiguredFeature<?> makeComposite(
        ...
        Feature<DecoratedFeatureConfiguration> var0 = param0 instanceof FlowerFeature ? Feature.DECORATED_FLOWER : Feature.DECORATED;
        return new ConfiguredFeature<>(var0, new DecoratedFeatureConfiguration(param0, param1, param2, param3));
    }
    ...
    protected Biome(Biome.BiomeBuilder param0) {
        if (param0.surfaceBuilder != null
            ...
            && param0.waterColor != null
            && param0.waterFogColor != null) {
            ...
            this.waterColor = param0.waterColor;
            this.waterFogColor = param0.waterFogColor;
    ...
    public int getSkyColor(float param0) {
        param0 /= 3.0F;
        param0 = Mth.clamp(param0, -1.0F, 1.0F);
        return Mth.hsvToRgb(0.62222224F - param0 * 0.05F, 0.5F + param0 * 0.1F, 1.0F);
    }
    ...
    protected float getTemperatureNoCache(BlockPos param0) {
        if (param0.getY() > 64) {
            float var0 = (float)(TEMPERATURE_NOISE.getValue((double)((float)param0.getX() / 8.0F), (double)((float)param0.getZ() / 8.0F)) * 4.0);
    ...
    public <C extends FeatureConfiguration> void addStructureStart(StructureFeature<C> param0, C param1) {
        this.validFeatureStarts.put(param0, param1);
    }
    ...
    public int getGrassColor(BlockPos param0) {
        double var0 = (double)Mth.clamp(this.getTemperature(param0), 0.0F, 1.0F);
    ...
    public static class BiomeBuilder {
        ...
        public Biome.BiomeBuilder waterColor(int param0) {
            this.waterColor = param0;
            return this;
        }

        public Biome.BiomeBuilder waterFogColor(int param0) {
            this.waterFogColor = param0;
            return this;
        }
