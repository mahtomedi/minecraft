    ...
    public IceSpikesBiome() {
            ...
            new Biome.BiomeBuilder()
                .surfaceBuilder(
                    ...
                    new SurfaceBuilderBaseConfiguration(
                        Blocks.SNOW_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.GRAVEL.defaultBlockState()
                    )
                )
        ...
        this.addFeature(
            ...
            Feature.ICE_SPIKE
                ...
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP.configured(new FrequencyDecoratorConfiguration(3)))
        );
        this.addFeature(
            GenerationStep.Decoration.SURFACE_STRUCTURES,
            Feature.ICE_PATCH
