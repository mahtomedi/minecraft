...
public class BiomeDefaultFeatures {
    ...
    public static void addStructureFeaturePlacement(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.MINESHAFT, new MineshaftConfiguration(0.004F, MineshaftFeature.Type.NORMAL), FeatureDecorator.NOPE, DecoratorConfiguration.NONE
            )
        );
        param0.addFeature(
    ...
    public static void addDefaultSoftDisks(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                ...
                new DiskConfiguration(
                    Blocks.SAND.defaultBlockState(), 7, 2, Lists.newArrayList(Blocks.DIRT.defaultBlockState(), Blocks.GRASS_BLOCK.defaultBlockState())
                ),
        ...
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.DISK,
                new DiskConfiguration(
                    Blocks.CLAY.defaultBlockState(), 4, 1, Lists.newArrayList(Blocks.DIRT.defaultBlockState(), Blocks.CLAY.defaultBlockState())
                ),
                FeatureDecorator.COUNT_TOP_SOLID,
        ...
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.DISK,
                new DiskConfiguration(
                    Blocks.GRAVEL.defaultBlockState(), 6, 2, Lists.newArrayList(Blocks.DIRT.defaultBlockState(), Blocks.GRASS_BLOCK.defaultBlockState())
                ),
                FeatureDecorator.COUNT_TOP_SOLID,
                new DecoratorFrequency(1)
            )
    ...
    public static void addMossyStoneBlock(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.FOREST_ROCK,
                new BlockBlobConfiguration(Blocks.MOSSY_COBBLESTONE.defaultBlockState(), 0),
                FeatureDecorator.FOREST_ROCK,
                new DecoratorFrequency(3)
            )
        );
    }
    ...
    public static void addFerns(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                ...
                new DoublePlantConfiguration(Blocks.LARGE_FERN.defaultBlockState()),
                FeatureDecorator.COUNT_HEIGHTMAP_32,
                new DecoratorFrequency(7)
            )
        );
    }
    ...
    public static void addPlainVegetation(Biome param0) {
        ...
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.GRASS,
                new GrassConfiguration(Blocks.GRASS.defaultBlockState()),
                FeatureDecorator.NOISE_HEIGHTMAP_DOUBLE,
                new DecoratorNoiseDependant(-0.8, 5, 10)
            )
        );
    }
    ...
    public static void addDefaultMushrooms(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.BUSH,
                new BushConfiguration(Blocks.BROWN_MUSHROOM.defaultBlockState()),
                FeatureDecorator.CHANCE_HEIGHTMAP_DOUBLE,
                new DecoratorChance(4)
            )
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
    ...
    public static void addDefaultSprings(Biome param0) {
        param0.addFeature(
            ...
            Biome.makeComposite(
                Feature.SPRING,
                new SpringConfiguration(Fluids.WATER.defaultFluidState()),
                FeatureDecorator.COUNT_BIASED_RANGE,
                new DecoratorCountRange(50, 8, 8, 256)
            )
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
    ...
    public static void addIcebergs(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.LOCAL_MODIFICATIONS,
            Biome.makeComposite(
                Feature.ICEBERG, new IcebergConfiguration(Blocks.PACKED_ICE.defaultBlockState()), FeatureDecorator.ICEBERG, new DecoratorChance(16)
            )
        );
        param0.addFeature(
            GenerationStep.Decoration.LOCAL_MODIFICATIONS,
            Biome.makeComposite(
                Feature.ICEBERG, new IcebergConfiguration(Blocks.BLUE_ICE.defaultBlockState()), FeatureDecorator.ICEBERG, new DecoratorChance(200)
            )
        );
    }
