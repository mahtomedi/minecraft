    ...
    public static void addTaigaTrees(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(Feature.NORMAL_TREE.configured(PINE_TREE_CONFIG).weighted(0.33333334F)),
        ...
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(
                            Feature.NORMAL_TREE.configured(BIRCH_TREE_CONFIG).weighted(0.2F), Feature.FANCY_TREE.configured(FANCY_TREE_CONFIG).weighted(0.1F)
                        ),
    ...
    public static void addTallBirchTrees(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(Feature.NORMAL_TREE.configured(SUPER_BIRCH_TREE_CONFIG).weighted(0.5F)),
                        Feature.NORMAL_TREE.configured(BIRCH_TREE_CONFIG)
                    )
                )
                .decorated(FeatureDecorator.COUNT_EXTRA_HEIGHTMAP.configured(new FrequencyWithExtraChanceDecoratorConfiguration(10, 0.1F, 1)))
        );
        ...
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(
                            Feature.NORMAL_TREE.configured(SPRUCE_TREE_CONFIG).weighted(0.666F),
