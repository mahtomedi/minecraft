...
public class BiomeDefaultFeatures {
    ...
    public static void addDefaultOverworldLandMesaStructures(Biome param0) {
        param0.addStructureStart(MINESHAFT_MESA);
        param0.addStructureStart(STRONGHOLD);
    }

    public static void addDefaultOverworldLandStructures(Biome param0) {
        param0.addStructureStart(MINESHAFT);
        param0.addStructureStart(STRONGHOLD);
    }

    public static void addDefaultOverworldOceanStructures(Biome param0) {
        param0.addStructureStart(MINESHAFT);
        param0.addStructureStart(SHIPWRECK);
    }
    ...
    public static void addNetherDefaultOres(Biome param0) {
        ...
        addNetherOres(param0, 10, 16);
        addAncientDebris(param0);
    }

    public static void addNetherOres(Biome param0, int param1, int param2) {
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_DECORATION,
            Feature.ORE
                .configured(new OreConfiguration(OreConfiguration.Predicates.NETHERRACK, NETHER_GOLD_ORE, 10))
                .decorated(FeatureDecorator.COUNT_RANGE.configured(new CountRangeDecoratorConfiguration(param1, 10, 20, 128)))
        );
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_DECORATION,
            Feature.ORE
                .configured(new OreConfiguration(OreConfiguration.Predicates.NETHERRACK, NETHER_QUARTZ_ORE, 14))
                .decorated(FeatureDecorator.COUNT_RANGE.configured(new CountRangeDecoratorConfiguration(param2, 10, 20, 128)))
        );
    }
