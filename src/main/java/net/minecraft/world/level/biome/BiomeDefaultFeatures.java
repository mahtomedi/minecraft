...
public class BiomeDefaultFeatures {
    ...
    public static void addDefaultCarvers(Biome param0) {
        param0.addCarver(GenerationStep.Carving.AIR, Biome.makeCarver(WorldCarver.CAVE, new ProbabilityFeatureConfiguration(0.14285715F)));
        param0.addCarver(GenerationStep.Carving.AIR, Biome.makeCarver(WorldCarver.CANYON, new ProbabilityFeatureConfiguration(0.02F)));
    }

    public static void addOceanCarvers(Biome param0) {
        param0.addCarver(GenerationStep.Carving.AIR, Biome.makeCarver(WorldCarver.CAVE, new ProbabilityFeatureConfiguration(0.06666667F)));
        param0.addCarver(GenerationStep.Carving.AIR, Biome.makeCarver(WorldCarver.CANYON, new ProbabilityFeatureConfiguration(0.02F)));
        param0.addCarver(GenerationStep.Carving.LIQUID, Biome.makeCarver(WorldCarver.UNDERWATER_CANYON, new ProbabilityFeatureConfiguration(0.02F)));
        param0.addCarver(GenerationStep.Carving.LIQUID, Biome.makeCarver(WorldCarver.UNDERWATER_CAVE, new ProbabilityFeatureConfiguration(0.06666667F)));
    }

    public static void addStructureFeaturePlacement(Biome param0) {
        param0.addFeature(
        ...
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.PILLAGER_OUTPOST.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, Feature.STRONGHOLD.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.SWAMP_HUT.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.DESERT_PYRAMID.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.JUNGLE_TEMPLE.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.IGLOO.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.RUINED_PORTAL.configured(new RuinedPortalConfiguration()));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.SHIPWRECK.configured(new ShipwreckConfiguration(false)));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.OCEAN_MONUMENT.configured(FeatureConfiguration.NONE));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.WOODLAND_MANSION.configured(FeatureConfiguration.NONE));
        param0.addFeature(
        ...
        param0.addFeature(GenerationStep.Decoration.UNDERGROUND_STRUCTURES, Feature.BURIED_TREASURE.configured(new BuriedTreasureConfiguration(0.01F)));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.VILLAGE.configured(new JigsawConfiguration("village/plains/town_centers", 6)));
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.BASTION_REMNANT.configured(new MultiJigsawConfiguration(BastionPieces.POOLS)));
    }
    ...
    public static void addDefaultSoftDisks(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_ORES,
            Feature.DISK
                .configured(new DiskConfiguration(SAND, 7, 2, Lists.newArrayList(DIRT, GRASS_BLOCK)))
                .decorated(FeatureDecorator.COUNT_TOP_SOLID.configured(new FrequencyDecoratorConfiguration(3)))
        );
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_ORES,
            Feature.DISK
                .configured(new DiskConfiguration(CLAY, 4, 1, Lists.newArrayList(DIRT, CLAY)))
                .decorated(FeatureDecorator.COUNT_TOP_SOLID.configured(new FrequencyDecoratorConfiguration(1)))
        );
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_ORES,
            Feature.DISK
                .configured(new DiskConfiguration(GRAVEL, 6, 2, Lists.newArrayList(DIRT, GRASS_BLOCK)))
                .decorated(FeatureDecorator.COUNT_TOP_SOLID.configured(new FrequencyDecoratorConfiguration(1)))
        );
    }
    ...
    public static void addFerns(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                .configured(LARGE_FERN_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_32.configured(new FrequencyDecoratorConfiguration(7)))
        );
    }
    ...
    public static void addWaterTrees(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(Feature.TREE.configured(FANCY_TREE_CONFIG).weighted(0.1F)), Feature.TREE.configured(NORMAL_TREE_CONFIG)
                    )
                )
        ...
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(
                            Feature.TREE.configured(BIRCH_TREE_WITH_BEES_0002_CONFIG).weighted(0.2F),
                            Feature.TREE.configured(FANCY_TREE_WITH_BEES_0002_CONFIG).weighted(0.1F)
                        ),
    ...
    public static void addSavannaTrees(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(Feature.TREE.configured(ACACIA_TREE_CONFIG).weighted(0.8F)), Feature.TREE.configured(NORMAL_TREE_CONFIG)
                    )
                )
        ...
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(
                            Feature.TREE.configured(SPRUCE_TREE_CONFIG).weighted(0.666F), Feature.TREE.configured(FANCY_TREE_CONFIG).weighted(0.1F)
                        ),
        ...
        param0.addFeature(
            ...
            Feature.RANDOM_SELECTOR
                .configured(
                    new RandomFeatureConfiguration(
                        ImmutableList.of(
                            Feature.TREE.configured(MEGA_SPRUCE_TREE_CONFIG).weighted(0.33333334F),
    ...
    public static void addJungleGrass(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
                .configured(JUNGLE_GRASS_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(25)))
        );
    }
    ...
    public static void addShatteredSavannaGrass(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                ...
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(5)))
        );
    }
    ...
    public static void addForestGrass(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                .configured(DEFAULT_GRASS_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(2)))
        );
    }
    ...
    public static void addSwampVegetation(Biome param0) {
        ...
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
                .configured(WATERLILLY_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(4)))
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
    ...
    public static void addGiantTaigaVegetation(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
                .configured(TAIGA_GRASS_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(7)))
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
    ...
    public static void addDefaultMushrooms(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                .configured(BROWN_MUSHROOM_CONFIG)
                .decorated(FeatureDecorator.CHANCE_HEIGHTMAP_DOUBLE.configured(new ChanceDecoratorConfiguration(4)))
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
                .configured(RED_MUSHROOM_CONFIG)
                .decorated(FeatureDecorator.CHANCE_HEIGHTMAP_DOUBLE.configured(new ChanceDecoratorConfiguration(8)))
        );
    }
    ...
    public static void addBadlandExtraVegetation(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                .configured(SUGAR_CANE_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(13)))
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
    ...
    public static void addDesertExtraVegetation(Biome param0) {
        param0.addFeature(
            ...
            Feature.RANDOM_PATCH
                .configured(SUGAR_CANE_CONFIG)
                .decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(60)))
        );
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.RANDOM_PATCH
    ...
    public static void addDesertExtraDecoration(Biome param0) {
        param0.addFeature(
            ...
            Feature.DESERT_WELL
                ...
                .decorated(FeatureDecorator.CHANCE_HEIGHTMAP.configured(new ChanceDecoratorConfiguration(1000)))
        );
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_DECORATION,
            Feature.FOSSIL
                .configured(FeatureConfiguration.NONE)
                .decorated(FeatureDecorator.CHANCE_PASSTHROUGH.configured(new ChanceDecoratorConfiguration(64)))
        );
    }

    public static void addSwampExtraDecoration(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.UNDERGROUND_DECORATION,
            Feature.FOSSIL
                .configured(FeatureConfiguration.NONE)
    ...
    public static void addColdOceanExtraVegetation(Biome param0) {
        param0.addFeature(
            ...
            Feature.KELP
                ...
                .decorated(
                    FeatureDecorator.TOP_SOLID_HEIGHTMAP_NOISE_BIASED
                        .configured(new NoiseCountFactorDecoratorConfiguration(120, 80.0, 0.0, Heightmap.Types.OCEAN_FLOOR_WG))
                )
        );
    }
    ...
    public static void addWarmSeagrass(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.SEAGRASS
    ...
    public static void addDeepWarmSeagrass(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.SEAGRASS
    ...
    public static void addLukeWarmKelp(Biome param0) {
        param0.addFeature(
            ...
            Feature.KELP
                ...
                .decorated(
                    FeatureDecorator.TOP_SOLID_HEIGHTMAP_NOISE_BIASED
                        .configured(new NoiseCountFactorDecoratorConfiguration(80, 80.0, 0.0, Heightmap.Types.OCEAN_FLOOR_WG))
                )
        );
    }
    ...
    public static void addIcebergs(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.LOCAL_MODIFICATIONS,
            Feature.ICEBERG
                .configured(new BlockStateConfiguration(PACKED_ICE))
                .decorated(FeatureDecorator.ICEBERG.configured(new ChanceDecoratorConfiguration(16)))
        );
        param0.addFeature(
            GenerationStep.Decoration.LOCAL_MODIFICATIONS,
            Feature.ICEBERG
                .configured(new BlockStateConfiguration(BLUE_ICE))
                .decorated(FeatureDecorator.ICEBERG.configured(new ChanceDecoratorConfiguration(200)))
        );
    }
    ...
    public static void addSurfaceFreezing(Biome param0) {
        param0.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, Feature.FREEZE_TOP_LAYER.configured(FeatureConfiguration.NONE));
    }

    public static void addEndCity(Biome param0) {
        param0.addFeature(GenerationStep.Decoration.SURFACE_STRUCTURES, Feature.END_CITY.configured(FeatureConfiguration.NONE));
    }
    ...
    public static void addCrimsonForestVegetation(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.HUGE_FUNGUS
    ...
    public static void addWarpedForestVegetation(Biome param0) {
        param0.addFeature(
            GenerationStep.Decoration.VEGETAL_DECORATION,
            Feature.HUGE_FUNGUS
