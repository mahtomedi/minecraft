...
public abstract class Biomes {
    ...
    public static final Biome GIANT_SPRUCE_TAIGA = register(
        160, "giant_spruce_taiga", VanillaBiomes.giantTreeTaiga(0.2F, 0.2F, 0.25F, true, "giant_tree_taiga")
    );
    ...
    private static Biome register(int param0, String param1, Biome param2) {
        BuiltinRegistries.registerMapping(BuiltinRegistries.BIOME, param0, param1, param2);
        if (param2.isMutated()) {
            MUTATED_BIOMES.addMapping(param2, BuiltinRegistries.BIOME.getId(BuiltinRegistries.BIOME.get(new ResourceLocation(param2.parent))));
        }
    ...
    public static Biome getMutatedVariant(Biome param0) {
        return MUTATED_BIOMES.byId(BuiltinRegistries.BIOME.getId(param0));
    }
