...
public class GameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> RULE_LIMITED_CRAFTING = register(
        "doLimitedCrafting", GameRules.Category.PLAYER, GameRules.BooleanValue.create(false, (param0, param1) -> {
            for(ServerPlayer var0 : param0.getPlayerList().getPlayers()) {
                var0.connection.send(new ClientboundGameEventPacket(ClientboundGameEventPacket.LIMITED_CRAFTING, param1.get() ? 1.0F : 0.0F));
            }
