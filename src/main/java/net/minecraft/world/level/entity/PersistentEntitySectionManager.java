...
public class PersistentEntitySectionManager<T extends EntityAccess> implements AutoCloseable {
    ...
    private static <T extends EntityAccess> Visibility getEffectiveStatus(T param0, Visibility param1) {
