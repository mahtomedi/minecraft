...
public class SoundType {
    ...
    public SoundType(float param0, float param1, SoundEvent param2, SoundEvent param3, SoundEvent param4, SoundEvent param5, SoundEvent param6) {
        this.volume = param0;
        this.pitch = param1;
        this.breakSound = param2;
        this.stepSound = param3;
        this.placeSound = param4;
        this.hitSound = param5;
        this.fallSound = param6;
    }
