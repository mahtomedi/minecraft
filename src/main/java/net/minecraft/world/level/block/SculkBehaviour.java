...
public interface SculkBehaviour {
    SculkBehaviour DEFAULT = new SculkBehaviour() {
        ...
        public int attemptUseCharge(
            SculkSpreader.ChargeCursor param0, LevelAccessor param1, BlockPos param2, Random param3, SculkSpreader param4, boolean param5
        ) {
    ...
    default void onDischarged(LevelAccessor param0, BlockState param1, BlockPos param2, Random param3) {
    }

    default boolean depositCharge(LevelAccessor param0, BlockPos param1, Random param2) {
        return false;
    }
    ...
    int attemptUseCharge(SculkSpreader.ChargeCursor var1, LevelAccessor var2, BlockPos var3, Random var4, SculkSpreader var5, boolean var6);
}
