...
public class SculkSpreader {
    ...
    public void updateCursors(LevelAccessor param0, BlockPos param1, Random param2, boolean param3) {
    ...
    public static class ChargeCursor {
        ...
        public void update(LevelAccessor param0, BlockPos param1, Random param2, SculkSpreader param3, boolean param4) {
        ...
        @Nullable
        private static BlockPos getValidMovementPos(LevelAccessor param0, BlockPos param1, Random param2) {
