...
public class FrogspawnBlock extends Block {
    ...
    private static int getFrogspawnHatchDelay(Random param0) {
    ...
    private void hatchFrogspawn(ServerLevel param0, BlockPos param1, Random param2) {
    ...
    private void spawnTadpoles(ServerLevel param0, BlockPos param1, Random param2) {
