...
public class BlockEntityType<T extends BlockEntity> {
    ...
    private static <T extends BlockEntity> BlockEntityType<T> register(String param0, BlockEntityType.Builder<T> param1) {
        ...
        try {
            ...
            LOGGER.warn("No data fixer registered for block entity {}", param0);
        }
    ...
    public static final class Builder<T extends BlockEntity> {
        ...
        public BlockEntityType<T> build(Type<?> param0) {
            return new BlockEntityType<>(this.factory, this.validBlocks, param0);
        }
    }
}
