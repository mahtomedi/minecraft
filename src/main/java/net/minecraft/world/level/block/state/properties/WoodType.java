...
public record WoodType(
    ...
    public WoodType(String param0, BlockSetType param1) {
        this(param0, param1, SoundType.WOOD, SoundType.HANGING_SIGN, SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN);
    }

    private static WoodType register(WoodType param0) {
        TYPES.put(param0.name(), param0);
        return param0;
    }
