...
public class CoralFanBlock extends BaseCoralFanBlock {
    public static final MapCodec<CoralFanBlock> CODEC = RecordCodecBuilder.mapCodec(
        param0 -> param0.group(CoralBlock.DEAD_CORAL_FIELD.forGetter(param0x -> param0x.deadBlock), propertiesCodec()).apply(param0, CoralFanBlock::new)
    );
    ...
    protected CoralFanBlock(Block param0, BlockBehaviour.Properties param1) {
        super(param1);
