...
public class Blocks {
    ...
    public static final Block ACACIA_SIGN = register(
        "acacia_sign",
        new StandingSignBlock(Block.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).noCollission().strength(1.0F).sound(SoundType.WOOD))
    );
    ...
    public static final Block DARK_OAK_SIGN = register(
        "dark_oak_sign",
        new StandingSignBlock(Block.Properties.of(Material.WOOD, DARK_OAK_LOG.materialColor).noCollission().strength(1.0F).sound(SoundType.WOOD))
    );
