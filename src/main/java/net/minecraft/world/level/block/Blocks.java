...
public class Blocks {
    ...
    public static final Block ORANGE_STAINED_GLASS = register(
        ...
        new StainedGlassBlock(DyeColor.ORANGE, Block.Properties.of(Material.GLASS, DyeColor.ORANGE).strength(0.3F).sound(SoundType.GLASS))
    );
    ...
    public static final Block YELLOW_STAINED_GLASS = register(
        ...
        new StainedGlassBlock(DyeColor.YELLOW, Block.Properties.of(Material.GLASS, DyeColor.YELLOW).strength(0.3F).sound(SoundType.GLASS))
    );
    ...
    public static final Block PURPLE_STAINED_GLASS = register(
        ...
        new StainedGlassBlock(DyeColor.PURPLE, Block.Properties.of(Material.GLASS, DyeColor.PURPLE).strength(0.3F).sound(SoundType.GLASS))
    );
    ...
    public static final Block LIGHT_BLUE_STAINED_GLASS_PANE = register(
        ...
        new StainedGlassPaneBlock(DyeColor.LIGHT_BLUE, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS))
    );
    ...
    public static final Block LIGHT_GRAY_STAINED_GLASS_PANE = register(
        ...
        new StainedGlassPaneBlock(DyeColor.LIGHT_GRAY, Block.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS))
    );
    ...
    public static final Block PINK_SHULKER_BOX = register(
        "pink_shulker_box",
        new ShulkerBoxBlock(DyeColor.PINK, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_PINK).strength(2.0F).dynamicShape())
    );
    public static final Block GRAY_SHULKER_BOX = register(
        "gray_shulker_box",
        new ShulkerBoxBlock(DyeColor.GRAY, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_GRAY).strength(2.0F).dynamicShape())
    );
    ...
    public static final Block CYAN_SHULKER_BOX = register(
        "cyan_shulker_box",
        new ShulkerBoxBlock(DyeColor.CYAN, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_CYAN).strength(2.0F).dynamicShape())
    );
    ...
    public static final Block BLUE_SHULKER_BOX = register(
        "blue_shulker_box",
        new ShulkerBoxBlock(DyeColor.BLUE, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_BLUE).strength(2.0F).dynamicShape())
    );
    ...
    public static final Block RED_SHULKER_BOX = register(
        "red_shulker_box",
        new ShulkerBoxBlock(DyeColor.RED, Block.Properties.of(Material.SHULKER_SHELL, MaterialColor.COLOR_RED).strength(2.0F).dynamicShape())
    );
    ...
    public static final Block CAMPFIRE = register(
        "campfire",
        new CampfireBlock(Block.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(2.0F).sound(SoundType.WOOD).lightLevel(15).randomTicks())
    );
