...
public abstract class GenericThread implements Runnable {
    ...
    protected GenericThread(String param0) {
        this.name = param0;
    }
        ...
        if (null != this.thread) {
            ...
            while(this.thread.isAlive()) {
                try {
                    ...
                    if (++var0 >= 5) {
                        LOGGER.warn("Waited {} seconds attempting force stop!", var0);
                    } else if (this.thread.isAlive()) {
                        LOGGER.warn("Thread {} ({}) failed to exit after {} second(s)", this, this.thread.getState(), var0, new Exception("Stack:"));
