...
public class GiveCommand {
    ...
    private static int giveItem(CommandSourceStack param0, ItemInput param1, Collection<ServerPlayer> param2, int param3) throws CommandSyntaxException {
        ...
        int var1 = var0 * 100;
        ItemStack var2 = param1.createItemStack(param3, false);
        if (param3 > var1) {
            param0.sendFailure(Component.translatable("commands.give.failed.toomanyitems", var1, var2.getDisplayName()));
            return 0;
        } else {
            ...
            if (param2.size() == 1) {
                param0.sendSuccess(
                    () -> Component.translatable("commands.give.success.single", param3, var2.getDisplayName(), param2.iterator().next().getDisplayName()),
                    true
                );
            } else {
                param0.sendSuccess(() -> Component.translatable("commands.give.success.single", param3, var2.getDisplayName(), param2.size()), true);
            }
