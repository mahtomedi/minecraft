...
public class ScoreboardCommand {
        ...
        if (param1.size() == 1) {
            ...
            param0.sendSuccess(
                () -> Component.translatable(
                        "commands.scoreboard.players.operation.success.single", param2.getFormattedDisplayName(), param1.iterator().next(), var6
                    ),
                true
            );
        } else {
    ...
    private static int resetScore(CommandSourceStack param0, Collection<String> param1, Objective param2) {
        ...
        if (param1.size() == 1) {
            param0.sendSuccess(
                () -> Component.translatable("commands.scoreboard.players.reset.specific.single", param2.getFormattedDisplayName(), param1.iterator().next()),
                true
            );
        } else {
            param0.sendSuccess(
    ...
    private static int setScore(CommandSourceStack param0, Collection<String> param1, Objective param2, int param3) {
        ...
        if (param1.size() == 1) {
            param0.sendSuccess(
                () -> Component.translatable(
                        "commands.scoreboard.players.set.success.single", param2.getFormattedDisplayName(), param1.iterator().next(), param3
                    ),
                true
            );
        } else {
    ...
    private static int addScore(CommandSourceStack param0, Collection<String> param1, Objective param2, int param3) {
        ...
        if (param1.size() == 1) {
            ...
            param0.sendSuccess(
                () -> Component.translatable(
                        "commands.scoreboard.players.add.success.single", param3, param2.getFormattedDisplayName(), param1.iterator().next(), var4
                    ),
                true
            );
        } else {
    ...
    private static int removeScore(CommandSourceStack param0, Collection<String> param1, Objective param2, int param3) {
        ...
        if (param1.size() == 1) {
            ...
            param0.sendSuccess(
                () -> Component.translatable(
                        "commands.scoreboard.players.remove.success.single", param3, param2.getFormattedDisplayName(), param1.iterator().next(), var4
                    ),
                true
            );
        } else {
