...
public class TeamCommand {
    ...
    private static int leaveTeam(CommandSourceStack param0, Collection<String> param1) {
        ...
        if (param1.size() == 1) {
            param0.sendSuccess(new TranslatableComponent("commands.team.leave.success.single", param1.iterator().next()), true);
        } else {
            param0.sendSuccess(new TranslatableComponent("commands.team.leave.success.multiple", param1.size()), true);
        }
    ...
    private static int joinTeam(CommandSourceStack param0, PlayerTeam param1, Collection<String> param2) {
        ...
        if (param2.size() == 1) {
            param0.sendSuccess(new TranslatableComponent("commands.team.join.success.single", param2.iterator().next(), param1.getFormattedDisplayName()), true);
        } else {
            param0.sendSuccess(new TranslatableComponent("commands.team.join.success.multiple", param2.size(), param1.getFormattedDisplayName()), true);
        }
    ...
    private static int setNametagVisibility(CommandSourceStack param0, PlayerTeam param1, Team.Visibility param2) throws CommandSyntaxException {
        if (param1.getNameTagVisibility() == param2) {
            ...
            param0.sendSuccess(
                new TranslatableComponent("commands.team.option.nametagVisibility.success", param1.getFormattedDisplayName(), param2.getDisplayName()), true
            );
            return 0;
        }
    }
    ...
    private static int setDeathMessageVisibility(CommandSourceStack param0, PlayerTeam param1, Team.Visibility param2) throws CommandSyntaxException {
        if (param1.getDeathMessageVisibility() == param2) {
            ...
            param0.sendSuccess(
                new TranslatableComponent("commands.team.option.deathMessageVisibility.success", param1.getFormattedDisplayName(), param2.getDisplayName()),
                true
            );
            return 0;
        }
    ...
    private static int setCollision(CommandSourceStack param0, PlayerTeam param1, Team.CollisionRule param2) throws CommandSyntaxException {
        if (param1.getCollisionRule() == param2) {
            ...
            param0.sendSuccess(
                new TranslatableComponent("commands.team.option.collisionRule.success", param1.getFormattedDisplayName(), param2.getDisplayName()), true
            );
            return 0;
        }
    }
    ...
    private static int setFriendlySight(CommandSourceStack param0, PlayerTeam param1, boolean param2) throws CommandSyntaxException {
        if (param1.canSeeFriendlyInvisibles() == param2) {
            ...
            param0.sendSuccess(
                new TranslatableComponent("commands.team.option.seeFriendlyInvisibles." + (param2 ? "enabled" : "disabled"), param1.getFormattedDisplayName()),
                true
            );
            return 0;
        }
    ...
    private static int setFriendlyFire(CommandSourceStack param0, PlayerTeam param1, boolean param2) throws CommandSyntaxException {
        if (param1.isAllowFriendlyFire() == param2) {
            ...
            param0.sendSuccess(
                new TranslatableComponent("commands.team.option.friendlyfire." + (param2 ? "enabled" : "disabled"), param1.getFormattedDisplayName()), true
            );
            return 0;
        }
    }
    ...
    private static int setDisplayName(CommandSourceStack param0, PlayerTeam param1, Component param2) throws CommandSyntaxException {
        if (param1.getDisplayName().equals(param2)) {
            ...
            param0.sendSuccess(new TranslatableComponent("commands.team.option.name.success", param1.getFormattedDisplayName()), true);
            return 0;
        }
    }
    ...
    private static int setColor(CommandSourceStack param0, PlayerTeam param1, ChatFormatting param2) throws CommandSyntaxException {
        if (param1.getColor() == param2) {
            ...
            param0.sendSuccess(new TranslatableComponent("commands.team.option.color.success", param1.getFormattedDisplayName(), param2.getName()), true);
            return 0;
        }
    }
    ...
    private static int emptyTeam(CommandSourceStack param0, PlayerTeam param1) throws CommandSyntaxException {
        ...
        if (var1.isEmpty()) {
            ...
            param0.sendSuccess(new TranslatableComponent("commands.team.empty.success", var1.size(), param1.getFormattedDisplayName()), true);
            return var1.size();
        }
    }
    ...
    private static int deleteTeam(CommandSourceStack param0, PlayerTeam param1) {
        ...
        param0.sendSuccess(new TranslatableComponent("commands.team.remove.success", param1.getFormattedDisplayName()), true);
    ...
    private static int createTeam(CommandSourceStack param0, String param1) throws CommandSyntaxException {
        return createTeam(param0, param1, new TextComponent(param1));
    }
    ...
    private static int createTeam(CommandSourceStack param0, String param1, Component param2) throws CommandSyntaxException {
        ...
        if (var0.getPlayerTeam(param1) != null) {
            ...
            param0.sendSuccess(new TranslatableComponent("commands.team.add.success", var1.getFormattedDisplayName()), true);
            return var0.getPlayerTeams().size();
        }
    }
    ...
    private static int listMembers(CommandSourceStack param0, PlayerTeam param1) {
        ...
        if (var0.isEmpty()) {
            param0.sendSuccess(new TranslatableComponent("commands.team.list.members.empty", param1.getFormattedDisplayName()), false);
        } else {
            param0.sendSuccess(
                new TranslatableComponent("commands.team.list.members.success", param1.getFormattedDisplayName(), var0.size(), ComponentUtils.formatList(var0)),
                false
            );
        }
    ...
    private static int listTeams(CommandSourceStack param0) {
        ...
        if (var0.isEmpty()) {
            param0.sendSuccess(new TranslatableComponent("commands.team.list.teams.empty"), false);
        } else {
            param0.sendSuccess(
                new TranslatableComponent("commands.team.list.teams.success", var0.size(), ComponentUtils.formatList(var0, PlayerTeam::getFormattedDisplayName)),
                false
            );
        }
    ...
    private static int setPrefix(CommandSourceStack param0, PlayerTeam param1, Component param2) {
        ...
        param0.sendSuccess(new TranslatableComponent("commands.team.option.prefix.success", param2), false);
        return 1;
    }

    private static int setSuffix(CommandSourceStack param0, PlayerTeam param1, Component param2) {
        param1.setPlayerSuffix(param2);
        param0.sendSuccess(new TranslatableComponent("commands.team.option.suffix.success", param2), false);
        return 1;
    }
}
