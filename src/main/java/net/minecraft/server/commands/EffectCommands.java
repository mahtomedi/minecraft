...
public class EffectCommands {
            ...
            if (param1.size() == 1) {
                param0.sendSuccess(
                    () -> Component.translatable(
                            "commands.effect.give.success.single", var0.getDisplayName(), param1.iterator().next().getDisplayName(), var2 / 20
                        ),
                    true
                );
            } else {
    ...
    private static int clearEffects(CommandSourceStack param0, Collection<? extends Entity> param1) throws CommandSyntaxException {
        ...
        if (var0 == 0) {
            ...
            if (param1.size() == 1) {
                param0.sendSuccess(
                    () -> Component.translatable("commands.effect.clear.everything.success.single", param1.iterator().next().getDisplayName()), true
                );
            } else {
    ...
    private static int clearEffect(CommandSourceStack param0, Collection<? extends Entity> param1, Holder<MobEffect> param2) throws CommandSyntaxException {
        ...
        if (var1 == 0) {
            ...
            if (param1.size() == 1) {
                param0.sendSuccess(
                    () -> Component.translatable(
                            "commands.effect.clear.specific.success.single", var0.getDisplayName(), param1.iterator().next().getDisplayName()
                        ),
                    true
                );
            } else {
