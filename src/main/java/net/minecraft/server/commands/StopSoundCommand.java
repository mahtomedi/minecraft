...
public class StopSoundCommand {
    ...
    private static int stopSound(CommandSourceStack param0, Collection<ServerPlayer> param1, @Nullable SoundSource param2, @Nullable ResourceLocation param3) {
        ...
        if (param2 != null) {
            if (param3 != null) {
                param0.sendSuccess(
                    () -> Component.translatable("commands.stopsound.success.source.sound", Component.translationArg(param3), param2.getName()), true
                );
            } else {
                param0.sendSuccess(() -> Component.translatable("commands.stopsound.success.source.any", param2.getName()), true);
            }
        } else if (param3 != null) {
            param0.sendSuccess(() -> Component.translatable("commands.stopsound.success.sourceless.sound", Component.translationArg(param3)), true);
        } else {
