...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
    ...
    public ChunkMap(
        ...
        super(new File(param0.getDimension().getType().getStorageFolder(param1), "region"), param2);
        ...
        this.lightEngine = new ThreadedLevelLightEngine(
            param6, this, this.level.getDimension().isHasSkyLight(), var2, this.queueSorter.getProcessor(var2, false)
        );
        this.distanceManager = new ChunkMap.DistanceManager(param4, param5);
        this.overworldDataStorage = param9;
        this.poiManager = new PoiManager(new File(this.storageFolder, "poi"), param2);
    ...
    private boolean save(ChunkAccess param0x) {
        ...
        if (!param0x.isUnsaved()) {
            ...
            ChunkPos var1x = param0x.getPos();

            try {
                ChunkStatus var2 = param0x.getStatus();
                if (var2.getChunkType() != ChunkStatus.ChunkType.LEVELCHUNK) {
                    CompoundTag var3 = this.readChunk(var1x);
                    if (var3 != null && ChunkSerializer.getChunkTypeFromTag(var3) == ChunkStatus.ChunkType.LEVELCHUNK) {
                        return false;
                    }

                    if (var2 == ChunkStatus.EMPTY && param0x.getAllStarts().values().stream().noneMatch(StructureStart::isValid)) {
                        return false;
                    }
                }
                ...
                LOGGER.error("Failed to save chunk {},{}", var1x.x, var1x.z, var51);
                return false;
            }
        }
    }
    ...
    private CompoundTag readChunk(ChunkPos param0) throws IOException {
        ...
        return var0 == null ? null : this.upgradeChunkTag(this.level.getDimension().getType(), this.overworldDataStorage, var0);
    }
    ...
    class TrackedEntity {
        ...
        public void updatePlayer(ServerPlayer param0) {
            if (param0 != this.entity) {
                ...
                int var1 = Math.min(this.range, (ChunkMap.this.viewDistance - 1) * 16);
