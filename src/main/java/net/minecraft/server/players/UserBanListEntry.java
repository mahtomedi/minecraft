...
public class UserBanListEntry extends BanListEntry<GameProfile> {
    public UserBanListEntry(@Nullable GameProfile param0) {
        this(param0, null, null, null, null);
    }

    public UserBanListEntry(@Nullable GameProfile param0, @Nullable Date param1, @Nullable String param2, @Nullable Date param3, @Nullable String param4) {
    ...
    protected void serialize(JsonObject param0) {
        if (this.getUser() != null) {
            param0.addProperty("uuid", this.getUser().getId().toString());
    ...
    public Component getDisplayName() {
        ...
        return var0 != null ? Component.literal(var0.getName()) : Component.translatable("commands.banlist.entry.unknown");
    }
