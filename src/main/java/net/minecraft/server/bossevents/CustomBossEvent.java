...
public class CustomBossEvent extends ServerBossEvent {
    ...
    public void setValue(int param0) {
        this.value = param0;
        this.setProgress(Mth.clamp((float)param0 / (float)this.max, 0.0F, 1.0F));
    }

    public void setMax(int param0) {
        this.max = param0;
        this.setProgress(Mth.clamp((float)this.value / (float)param0, 0.0F, 1.0F));
    }
    ...
    public static CustomBossEvent load(CompoundTag param0, ResourceLocation param1) {
        ...
        for(Tag var2 : param0.getList("Players", 11)) {
            var0.addOfflinePlayer(NbtUtils.loadUUID(var2));
        }
