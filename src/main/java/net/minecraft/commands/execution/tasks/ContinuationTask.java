...
public class ContinuationTask<T, P> implements EntryAction<T> {
    ...
    private ContinuationTask(ContinuationTask.TaskProvider<T, P> param0, List<P> param1, Frame param2) {
    ...
    public static <T, P> void schedule(ExecutionContext<T> param0, Frame param1, List<P> param2, ContinuationTask.TaskProvider<T, P> param3) {
