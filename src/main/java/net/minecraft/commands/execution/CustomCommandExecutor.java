...
public interface CustomCommandExecutor<T> {
    ...
    public abstract static class WithErrorHandling<T extends ExecutionCommandSource<T>> implements CustomCommandExecutor<T> {
        public final void run(T param0, ContextChain<T> param1, ChainModifiers param2, ExecutionControl<T> param3) {
            try {
        ...
        protected void onError(CommandSyntaxException param0, T param1, ChainModifiers param2, @Nullable TraceCallbacks param3) {
            param1.handleError(param0, param2.isForked(), param3);
        }
