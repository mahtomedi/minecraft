...
public interface CustomCommandExecutor<T> {
    void run(T var1, ContextChain<T> var2, boolean var3, ExecutionControl<T> var4) throws CommandSyntaxException;
    ...
    public abstract static class WithErrorHandling<T extends ExecutionCommandSource<T>> implements CustomCommandExecutor<T> {
        public final void run(T param0, ContextChain<T> param1, boolean param2, ExecutionControl<T> param3) throws CommandSyntaxException {
            try {
                this.runGuarded(param0, param1, param2, param3);
            } catch (CommandSyntaxException var6) {
                this.onError(var6, param0, param2);
                param0.storeResults(false, 0);
                throw var6;
            }
        }

        protected void onError(CommandSyntaxException param0, T param1, boolean param2) {
        }
