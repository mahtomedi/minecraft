...
public class SharedConstants {
    ...
    public static String filterText(String param0) {
        return filterText(param0, false);
    }

    public static String filterText(String param0, boolean param1) {
    ...
    public static void setVersion(WorldVersion param0) {
        if (CURRENT_VERSION == null) {
            CURRENT_VERSION = param0;
        } else if (param0 != CURRENT_VERSION) {
