...
public class RegistrySynchronization {
    private static final Map<ResourceKey<? extends Registry<?>>, RegistrySynchronization.NetworkedRegistryData<?>> NETWORKABLE_REGISTRIES = Util.make(() -> {
        ...
        put(var0, Registry.BIOME_REGISTRY, Biome.NETWORK_CODEC);
        put(var0, Registry.CHAT_TYPE_REGISTRY, ChatType.CODEC);
        put(var0, Registry.DIMENSION_TYPE_REGISTRY, DimensionType.DIRECT_CODEC);
        return var0.build();
    });
    ...
    public static Stream<RegistryAccess.RegistryEntry<?>> networkSafeRegistries(LayeredRegistryAccess<RegistryLayer> param0) {
        ...
        Stream<RegistryAccess.RegistryEntry<?>> var1 = ownedNetworkableRegistries(param0.getAccessFrom(RegistryLayer.WORLDGEN));
