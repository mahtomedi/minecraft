...
public class SoundEvents {
    ...
    private static SoundEvent register(String param0, float param1) {
        return Registry.register(Registry.SOUND_EVENT, param0, new SoundEvent(new ResourceLocation(param0), param1));
    }

    private static SoundEvent register(String param0) {
        return Registry.register(Registry.SOUND_EVENT, param0, new SoundEvent(new ResourceLocation(param0)));
    }
