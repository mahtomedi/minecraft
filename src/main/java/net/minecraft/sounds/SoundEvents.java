...
public class SoundEvents {
    ...
    private static Holder<SoundEvent> register(ResourceLocation param0, ResourceLocation param1, float param2) {
        return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, param0, SoundEvent.createFixedRangeEvent(param1, param2));
    }

    private static SoundEvent register(String param0) {
        return register(new ResourceLocation(param0));
    }

    private static SoundEvent register(ResourceLocation param0) {
        return register(param0, param0);
    }

    private static Holder.Reference<SoundEvent> registerForHolder(String param0) {
        return registerForHolder(new ResourceLocation(param0));
    }

    private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation param0) {
        return registerForHolder(param0, param0);
    }

    private static SoundEvent register(ResourceLocation param0, ResourceLocation param1) {
        return Registry.register(BuiltInRegistries.SOUND_EVENT, param0, SoundEvent.createVariableRangeEvent(param1));
    }

    private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation param0, ResourceLocation param1) {
        return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, param0, SoundEvent.createVariableRangeEvent(param1));
    }

    private static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
        return IntStream.range(0, 8).mapToObj(param0 -> registerForHolder("item.goat_horn.sound." + param0)).collect(ImmutableList.toImmutableList());
    }
}
