...
public class BlockTintCache {
    ...
    public int getColor(BlockPos param0) {
        ...
        if (var2.x != var0 || var2.z != var1 || var2.cache == null || var2.cache.isInvalidated()) {
            var2.x = var0;
            var2.z = var1;
        ...
        try {
            ...
            for(int var0 = -1; var0 <= 1; ++var0) {
                for(int var1 = -1; var1 <= 1; ++var1) {
                    ...
                    BlockTintCache.CacheData var3 = this.cache.remove(var2);
                    if (var3 != null) {
                        var3.invalidate();
                    }
                }
        ...
        try {
            ...
            if (var2 == null) {
                ...
                if (this.cache.size() >= 256) {
                    BlockTintCache.CacheData var4 = this.cache.removeFirst();
                    if (var4 != null) {
                        var4.invalidate();
                    }
                }
