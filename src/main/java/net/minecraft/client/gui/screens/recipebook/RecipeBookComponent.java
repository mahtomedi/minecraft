...
public class RecipeBookComponent extends GuiComponent implements Widget, GuiEventListener, NarratableEntry, RecipeShownListener, PlaceRecipe<Ingredient> {
    ...
    public void initVisuals() {
        ...
        this.searchBox = new EditBox(this.minecraft.font, var0 + 25, var1 + 14, 80, 9 + 5, Component.translatable("itemGroup.search"));
    ...
    public void render(PoseStack param0, int param1, int param2, float param3) {
        if (this.isVisible()) {
            ...
            if (!this.searchBox.isFocused() && this.searchBox.getValue().isEmpty()) {
                drawString(param0, this.minecraft.font, SEARCH_HINT, var0 + 25, var1 + 14, -1);
            } else {
    ...
    private void renderGhostRecipeTooltip(PoseStack param0, int param1, int param2, int param3, int param4) {
        ...
        if (var0 != null && this.minecraft.screen != null) {
            this.minecraft.screen.renderComponentTooltip(param0, this.minecraft.screen.getTooltipFromItem(var0), param3, param4);
        }
    ...
    private void pirateSpeechForThePeople(String param0) {
        if ("excitedze".equals(param0)) {
            ...
            LanguageInfo var1 = var0.getLanguage("en_pt");
