...
public class WinScreen extends Screen {
    ...
    private void renderBg(int param0, int param1, float param2) {
        ...
        var8.vertex(0.0, (double)this.height, (double)this.blitOffset).uv(0.0, (double)(var1 * 0.015625F)).color(var4, var4, var4, 1.0F).endVertex();
        var8.vertex((double)var0, (double)this.height, (double)this.blitOffset)
            .uv((double)((float)var0 * 0.015625F), (double)(var1 * 0.015625F))
            .color(var4, var4, var4, 1.0F)
            .endVertex();
        var8.vertex((double)var0, 0.0, (double)this.blitOffset)
            .uv((double)((float)var0 * 0.015625F), (double)(var2 * 0.015625F))
            .color(var4, var4, var4, 1.0F)
            .endVertex();
        var8.vertex(0.0, 0.0, (double)this.blitOffset).uv(0.0, (double)(var2 * 0.015625F)).color(var4, var4, var4, 1.0F).endVertex();
        var7.end();
    }
    ...
    public void render(int param0, int param1, float param2) {
        ...
        var11.vertex(0.0, (double)var9, (double)this.blitOffset).uv(0.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        var11.vertex((double)var8, (double)var9, (double)this.blitOffset).uv(1.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        var11.vertex((double)var8, 0.0, (double)this.blitOffset).uv(1.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        var11.vertex(0.0, 0.0, (double)this.blitOffset).uv(0.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        var10.end();
