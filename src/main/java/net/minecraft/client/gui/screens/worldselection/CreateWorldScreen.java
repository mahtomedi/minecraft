...
public class CreateWorldScreen extends Screen {
    ...
    protected void init() {
        ...
        this.commandsButton = this.addButton(
            new Button(this.width / 2 - 155, 151, 150, 20, I18n.get("selectWorld.allowCommands"), param0 -> {
        ...
        this.bonusItemsButton = this.addButton(
            new Button(this.width / 2 + 5, 151, 150, 20, I18n.get("selectWorld.bonusItems"), param0 -> {
