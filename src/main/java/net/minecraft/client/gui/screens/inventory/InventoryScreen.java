...
public class InventoryScreen extends EffectRenderingInventoryScreen<InventoryMenu> implements RecipeUpdateListener {
    ...
    public static void renderEntityInInventory(int param0, int param1, int param2, float param3, float param4, LivingEntity param5) {
        ...
        Quaternion var1 = Vector3f.ZP.rotationDegrees(180.0F);
        Quaternion var2 = Vector3f.XP.rotationDegrees(-((float)Math.atan((double)(param4 / 40.0F))) * 20.0F);
        var1.mul(var2);
        var0.mulPose(var1);
        float var3 = param5.yBodyRot;
        float var4 = param5.yRot;
        float var5 = param5.xRot;
        float var6 = param5.yHeadRotO;
        float var7 = param5.yHeadRot;
        ...
        var2.conj();
        var2.mul(Vector3f.YP.rotationDegrees(180.0F));
        var8.overrideCameraOrientation(var2);
        var8.setRenderShadow(false);
        MultiBufferSource.BufferSource var9 = Minecraft.getInstance().renderBuffers().bufferSource();
        var8.render(param5, 0.0, 0.0, 0.0, 0.0F, 1.0F, var0, var9, 15728880);
        var9.endBatch(-param0, param1, 1000);
        var8.setRenderShadow(true);
        param5.yBodyRot = var3;
        param5.yRot = var4;
        param5.xRot = var5;
        param5.yHeadRotO = var6;
        param5.yHeadRot = var7;
