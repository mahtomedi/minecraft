...
public class ErrorScreen extends Screen {
    ...
    public void render(PoseStack param0, int param1, int param2, float param3) {
        ...
        this.drawCenteredString(param0, this.font, this.title, this.width / 2, 90, 16777215);
        this.drawCenteredString(param0, this.font, this.message, this.width / 2, 110, 16777215);
