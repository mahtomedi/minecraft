...
public class BrewingStandScreen extends AbstractContainerScreen<BrewingStandMenu> {
    ...
    protected void renderBg(GuiGraphics param0, float param1, int param2, int param3) {
        ...
        if (var3 > 0) {
            param0.blit(BREWING_STAND_LOCATION, var0 + 60, var1 + 44, 176, 29, var3, 4);
        }
        ...
        if (var4 > 0) {
            ...
            if (var5 > 0) {
                param0.blit(BREWING_STAND_LOCATION, var0 + 97, var1 + 16, 176, 0, 9, var5);
            }

            var5 = BUBBLELENGTHS[var4 / 2 % 7];
            if (var5 > 0) {
                param0.blit(BREWING_STAND_LOCATION, var0 + 63, var1 + 14 + 29 - var5, 185, 29 - var5, 12, var5);
            }
        }
