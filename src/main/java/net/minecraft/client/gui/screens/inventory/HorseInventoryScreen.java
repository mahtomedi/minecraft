...
public class HorseInventoryScreen extends AbstractContainerScreen<HorseInventoryMenu> {
    ...
    protected void renderBg(GuiGraphics param0, float param1, int param2, int param3) {
        ...
        if (this.horse instanceof AbstractChestedHorse var2 && var2.hasChest()) {
            param0.blit(HORSE_INVENTORY_LOCATION, var0 + 79, var1 + 17, 0, this.imageHeight, var2.getInventoryColumns() * 18, 54);
        }

        if (this.horse.isSaddleable()) {
            param0.blit(HORSE_INVENTORY_LOCATION, var0 + 7, var1 + 35 - 18, 18, this.imageHeight + 54, 18, 18);
        }

        if (this.horse.canWearArmor()) {
            if (this.horse instanceof Llama) {
                param0.blit(HORSE_INVENTORY_LOCATION, var0 + 7, var1 + 35, 36, this.imageHeight + 54, 18, 18);
            } else {
                param0.blit(HORSE_INVENTORY_LOCATION, var0 + 7, var1 + 35, 0, this.imageHeight + 54, 18, 18);
            }
        }

        InventoryScreen.renderEntityInInventoryFollowsMouse(
            param0, var0 + 51, var1 + 60, 17, (float)(var0 + 51) - this.xMouse, (float)(var1 + 75 - 50) - this.yMouse, this.horse
        );
    }
