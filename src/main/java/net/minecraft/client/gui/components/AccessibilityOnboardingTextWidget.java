...
public class AccessibilityOnboardingTextWidget extends MultiLineTextWidget {
    ...
    public void renderWidget(GuiGraphics param0, int param1, int param2, float param3) {
        ...
        param0.fill(var0 - 1, var1 - 1, var0, var3 + 1, var4);
        param0.fill(var2, var1 - 1, var2 + 1, var3 + 1, var4);
        param0.fill(var0, var1, var2, var1 - 1, var4);
        param0.fill(var0, var3, var2, var3 + 1, var4);
        param0.fill(var0, var1, var2, var3, 1426063360);
