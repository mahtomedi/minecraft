...
public class AdvancementToast implements Toast {
    ...
    public Toast.Visibility render(GuiGraphics param0, ToastComponent param1, long param2) {
        ...
        if (var0 != null) {
            ...
            int var2 = var0.getType() == AdvancementType.CHALLENGE ? 16746751 : 16776960;
            if (var1.size() == 1) {
                param0.drawString(param1.getMinecraft().font, var0.getType().getDisplayName(), 30, 7, var2 | 0xFF000000, false);
                ...
                if (param2 < 1500L) {
                    ...
                    param0.drawString(param1.getMinecraft().font, var0.getType().getDisplayName(), 30, 11, var2 | var5, false);
                } else {
            ...
            if (!this.playedSound && param2 > 0L) {
                ...
                if (var0.getType() == AdvancementType.CHALLENGE) {
