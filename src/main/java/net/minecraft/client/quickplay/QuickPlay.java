...
public class QuickPlay {
    ...
    private static void joinSingleplayerWorld(Minecraft param0, String param1) {
        if (!param0.getLevelSource().levelExists(param1)) {
            ...
            param0.createWorldOpenFlows().checkForBackupAndLoad(param1, () -> param0.setScreen(new TitleScreen()));
        }
    }
    ...
    private static void joinMultiplayerWorld(Minecraft param0, String param1) {
        ...
        if (var1 == null) {
            var1 = new ServerData(I18n.get("selectServer.defaultName"), param1, ServerData.Type.OTHER);
            var0.add(var1, true);
            var0.save();
        }
    ...
    private static void joinRealmsWorld(Minecraft param0, RealmsClient param1, String param2) {
        ...
        if (var8 == null) {
            ...
            GetServerDetailsTask var11 = new GetServerDetailsTask(var10, var8);
