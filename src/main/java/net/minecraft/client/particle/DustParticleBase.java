...
public class DustParticleBase<T extends DustParticleOptionsBase> extends TextureSheetParticle {
    ...
    protected DustParticleBase(
        ...
        this.rCol = this.randomizeColor((float)param7.getColor().x, var0);
        this.gCol = this.randomizeColor((float)param7.getColor().y, var0);
        this.bCol = this.randomizeColor((float)param7.getColor().z, var0);
