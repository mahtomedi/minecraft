...
public class AttackSweepParticle extends TextureSheetParticle {
    ...
    private AttackSweepParticle(Level param0, double param1, double param2, double param3, double param4, SpriteSet param5) {
        ...
        this.gCol = var0;
        this.bCol = var0;
        this.quadSize = 1.0F - (float)param4 * 0.5F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new AttackSweepParticle(param1, param2, param3, param4, param5, this.sprites);
        }
    }
}
