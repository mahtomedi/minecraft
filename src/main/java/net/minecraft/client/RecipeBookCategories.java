...
public enum RecipeBookCategories {
    ...
    private RecipeBookCategories(ItemStack... param0) {
        this.itemIcons = ImmutableList.copyOf(param0);
    }

    public static List<RecipeBookCategories> getCategories(RecipeBookType param0) {
        switch(param0) {
            case CRAFTING:
