...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
    ...
    public void onDisconnect(Component param0) {
        if (this.parent != null && this.parent instanceof RealmsScreenProxy) {
            this.minecraft.setScreen(new DisconnectedRealmsScreen(((RealmsScreenProxy)this.parent).getScreen(), "connect.failed", param0).getProxy());
        } else {
            this.minecraft.setScreen(new DisconnectedScreen(this.parent, "connect.failed", param0));
        }
