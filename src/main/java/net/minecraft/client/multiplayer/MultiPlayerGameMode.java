...
public class MultiPlayerGameMode {
    ...
    public static void creativeDestroyBlock(Minecraft param0, MultiPlayerGameMode param1, BlockPos param2, Direction param3) {
        if (!param0.level.extinguishFire(param0.player, param2, param3)) {
            param1.destroyBlock(param2);
        }
    ...
    public boolean startDestroyBlock(BlockPos param0, Direction param1) {
        if (this.minecraft.player.blockActionRestricted(this.minecraft.level, param0, this.localPlayerMode)) {
            ...
            if (this.localPlayerMode.isCreative()) {
                ...
                creativeDestroyBlock(this.minecraft, this, param0, param1);
                this.destroyDelay = 5;
            ...
            if (var1.isAir()) {
                ...
                if (this.destroyTicks % 4.0F == 0.0F) {
                    ...
                    this.minecraft
                        .getSoundManager()
                        .play(
                            new SimpleSoundInstance(var2.getHitSound(), SoundSource.NEUTRAL, (var2.getVolume() + 1.0F) / 8.0F, var2.getPitch() * 0.5F, param0)
                        );
                }
