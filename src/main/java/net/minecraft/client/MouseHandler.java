...
public class MouseHandler {
        ...
        if (param0 == this.minecraft.getWindow().getWindow()) {
            ...
            if (this.minecraft.getOverlay() == null) {
                if (this.minecraft.screen == null) {
                    ...
                    if (var0) {
                        var5.afterMouseAction();
                        Screen.wrapScreenError(
                            () -> var2[0] = var5.mouseClicked(var3, var4, var1), "mouseClicked event handler", var5.getClass().getCanonicalName()
                        );
                    } else {
                        Screen.wrapScreenError(
                            () -> var2[0] = var5.mouseReleased(var3, var4, var1), "mouseReleased event handler", var5.getClass().getCanonicalName()
                        );
                    }
                }
            }
    ...
    private void onScroll(long param0, double param1, double param2) {
        if (param0 == Minecraft.getInstance().getWindow().getWindow()) {
            double var0 = (this.minecraft.options.discreteMouseScroll ? Math.signum(param2) : param2) * this.minecraft.options.mouseWheelSensitivity().get();
            if (this.minecraft.getOverlay() == null) {
                if (this.minecraft.screen != null) {
