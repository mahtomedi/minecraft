...
public class AxolotlModel<T extends Axolotl> extends AgeableListModel<T> {
    ...
    private void setupInitialAnimationValues(float param0, float param1) {
        ...
        this.head.y = 0.0F;
        this.body.y = 20.0F;
        ModelUtils.setRotation(this.body, param1 * (float) (Math.PI / 180.0), param0 * (float) (Math.PI / 180.0), 0.0F);
    ...
    private void setupGroundCrawlingAnimation(float param0) {
        ...
        this.leftGills.yRot = -this.topGills.xRot;
        this.rightGills.yRot = -this.leftGills.yRot;
        ModelUtils.setRotation(this.leftHindLeg, 0.9424779F, 1.5F - var2, -0.1F);
        ModelUtils.setRotation(this.leftFrontLeg, this.leftFrontLeg.xRot = 1.0995574F, (float) (Math.PI / 2) - var3, 0.0F);
        ModelUtils.setRotation(this.rightHindLeg, this.leftHindLeg.xRot, -1.0F - var2, 0.0F);
        ModelUtils.setRotation(this.rightFrontLeg, this.leftFrontLeg.xRot, (float) (-Math.PI / 2) - var3, 0.0F);
    }
    ...
    private void setupWaterHoveringAnimation(float param0) {
        ...
        this.rightGills.yRot = -this.leftGills.yRot;
        ModelUtils.setRotation(this.leftHindLeg, (float) (Math.PI * 3.0 / 4.0) - var1 * 0.11F, 0.47123894F, 1.7278761F);
        ModelUtils.setRotation(this.leftFrontLeg, (float) (Math.PI / 4) - var1 * 0.2F, 2.042035F, 0.0F);
        this.applyMirrorLegRotations();
    ...
    private void setupSwimmingAnimation(float param0, float param1) {
        ...
        ModelUtils.setRotation(this.leftHindLeg, 1.8849558F, -0.4F * var1, (float) (Math.PI / 2));
        ModelUtils.setRotation(this.leftFrontLeg, 1.8849558F, -0.2F * var2 - 0.1F, (float) (Math.PI / 2));
        this.applyMirrorLegRotations();
    }
