...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T> {
    ...
    public HorseModel(Function<ResourceLocation, RenderType> param0, float param1) {
        super(param0, true, 16.2F, 1.36F, 2.7272F, 2.0F, 20.0F);
        this.texWidth = 64;
        this.texHeight = 64;
        ...
        var0.addBox(-3.0F, -11.0F, -2.0F, 6.0F, 5.0F, 7.0F, param1);
        ModelPart var1 = new ModelPart(this, 56, 36);
        var1.addBox(-1.0F, -11.0F, 5.01F, 2.0F, 16.0F, 2.0F, param1);
        ModelPart var2 = new ModelPart(this, 0, 25);
        var2.addBox(-2.0F, -11.0F, -7.0F, 4.0F, 5.0F, 5.0F, param1);
