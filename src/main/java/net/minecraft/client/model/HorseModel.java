...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T> {
    ...
    public void prepareMobModel(T param0, float param1, float param2, float param3) {
        ...
        float var0 = Mth.rotLerp(param3, param0.yBodyRotO, param0.yBodyRot);
        float var1 = Mth.rotLerp(param3, param0.yHeadRotO, param0.yHeadRot);
        ...
        if (param2 > 0.2F) {
            var4 += Mth.cos(param1 * 0.8F) * 0.15F * param2;
        }
