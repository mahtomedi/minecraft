...
public class WitchModel<T extends Entity> extends VillagerModel<T> {
    ...
    public WitchModel(float param0) {
        ...
        var0.texOffs(0, 76).addBox(0.0F, 0.0F, 0.0F, 7.0F, 4.0F, 7.0F);
