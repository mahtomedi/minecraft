...
public class BedModel extends Model {
    ...
    public void preparePiece(boolean param0) {
        this.headPiece.visible = param0;
        this.footPiece.visible = !param0;
        this.legs[0].visible = !param0;
        this.legs[1].visible = param0;
        this.legs[2].visible = !param0;
        this.legs[3].visible = param0;
    }
}
