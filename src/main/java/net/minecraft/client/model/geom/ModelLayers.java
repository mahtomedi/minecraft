...
public class ModelLayers {
    ...
    private static ModelLayerLocation register(String param0) {
        return register(param0, "main");
    }

    private static ModelLayerLocation register(String param0, String param1) {
        ModelLayerLocation var0 = createLocation(param0, param1);
        if (!ALL_MODELS.add(var0)) {
            throw new IllegalStateException("Duplicate registration for " + var0);
        } else {
            return var0;
        }
    }

    private static ModelLayerLocation createLocation(String param0, String param1) {
        return new ModelLayerLocation(new ResourceLocation("minecraft", param0), param1);
    }

    private static ModelLayerLocation registerInnerArmor(String param0) {
        return register(param0, "inner_armor");
    }

    private static ModelLayerLocation registerOuterArmor(String param0) {
        return register(param0, "outer_armor");
    }

    public static ModelLayerLocation createRaftModelName(Boat.Type param0) {
        return createLocation("raft/" + param0.getName(), "main");
    }

    public static ModelLayerLocation createChestRaftModelName(Boat.Type param0) {
        return createLocation("chest_raft/" + param0.getName(), "main");
    }
    ...
    public static ModelLayerLocation createSignModelName(WoodType param0) {
        return createLocation("sign/" + param0.name(), "main");
    }

    public static ModelLayerLocation createHangingSignModelName(WoodType param0) {
        return createLocation("hanging_sign/" + param0.name(), "main");
    }
