...
public class IronGolemModel<T extends IronGolem> extends EntityModel<T> {
    ...
    public IronGolemModel(float param0, float param1) {
        ...
        this.head.texOffs(0, 0).addBox(-4.0F, -12.0F, -5.5F, 8.0F, 10.0F, 8.0F, param0);
        this.head.texOffs(24, 0).addBox(-1.0F, -5.0F, -7.5F, 2.0F, 4.0F, 2.0F, param0);
        this.body = new ModelPart(this).setTexSize(128, 128);
        this.body.setPos(0.0F, 0.0F + param1, 0.0F);
        this.body.texOffs(0, 40).addBox(-9.0F, -2.0F, -6.0F, 18.0F, 12.0F, 11.0F, param0);
        this.body.texOffs(0, 70).addBox(-4.5F, 10.0F, -3.0F, 9.0F, 5.0F, 6.0F, param0 + 0.5F);
        this.arm0 = new ModelPart(this).setTexSize(128, 128);
        this.arm0.setPos(0.0F, -7.0F, 0.0F);
        this.arm0.texOffs(60, 21).addBox(-13.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F, param0);
        this.arm1 = new ModelPart(this).setTexSize(128, 128);
        this.arm1.setPos(0.0F, -7.0F, 0.0F);
        this.arm1.texOffs(60, 58).addBox(9.0F, -2.5F, -3.0F, 4.0F, 30.0F, 6.0F, param0);
        this.leg0 = new ModelPart(this, 0, 22).setTexSize(128, 128);
        this.leg0.setPos(-4.0F, 18.0F + param1, 0.0F);
        this.leg0.texOffs(37, 0).addBox(-3.5F, -3.0F, -3.0F, 6.0F, 16.0F, 5.0F, param0);
