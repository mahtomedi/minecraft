...
public class MovementTutorialStepInstance implements TutorialStepInstance {
    ...
    public MovementTutorialStepInstance(Tutorial param0) {
    ...
    public void onInput(Input param0) {
        if (param0.up || param0.down || param0.left || param0.right || param0.jumping) {
            this.moved = true;
        }
    ...
    public void onMouse(double param0, double param1) {
        if (Math.abs(param0) > 0.01 || Math.abs(param1) > 0.01) {
            this.turned = true;
        }
