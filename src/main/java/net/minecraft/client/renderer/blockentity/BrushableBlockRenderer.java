...
public class BrushableBlockRenderer implements BlockEntityRenderer<BrushableBlockEntity> {
    ...
    public BrushableBlockRenderer(BlockEntityRendererProvider.Context param0) {
        this.itemRenderer = param0.getItemRenderer();
    }

    public void render(BrushableBlockEntity param0, float param1, PoseStack param2, MultiBufferSource param3, int param4, int param5) {
