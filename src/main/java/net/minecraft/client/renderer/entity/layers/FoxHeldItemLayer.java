    ...
    public void render(Fox param0, float param1, float param2, float param3, float param4, float param5, float param6, float param7) {
        ...
        if (!var0.isEmpty()) {
            ...
            if (var2) {
                ...
                RenderSystem.translatef(0.0F, 8.0F * param7, 3.35F * param7);
            }
            ...
            RenderSystem.rotatef(var4, 0.0F, 0.0F, 1.0F);
            RenderSystem.rotatef(param5, 0.0F, 1.0F, 0.0F);
            RenderSystem.rotatef(param6, 1.0F, 0.0F, 0.0F);
            if (param0.isBaby()) {
                if (var1) {
