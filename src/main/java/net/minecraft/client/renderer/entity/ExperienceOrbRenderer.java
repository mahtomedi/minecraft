...
public class ExperienceOrbRenderer extends EntityRenderer<ExperienceOrb> {
    ...
    public void render(ExperienceOrb param0, float param1, float param2, PoseStack param3, MultiBufferSource param4, int param5) {
        ...
        param3.mulPose(Vector3f.XP.rotationDegrees(var13));
        float var14 = 0.3F;
        param3.scale(0.3F, 0.3F, 0.3F);
        VertexConsumer var15 = param4.getBuffer(RenderType.entityCutout(EXPERIENCE_ORB_LOCATION));
        PoseStack.Pose var16 = param3.last();
        Matrix4f var17 = var16.pose();
        Matrix3f var18 = var16.normal();
        vertex(var15, var17, var18, -0.5F, -0.25F, var10, 255, var12, var1, var4, param5);
        vertex(var15, var17, var18, 0.5F, -0.25F, var10, 255, var12, var2, var4, param5);
        vertex(var15, var17, var18, 0.5F, 0.75F, var10, 255, var12, var2, var3, param5);
        vertex(var15, var17, var18, -0.5F, 0.75F, var10, 255, var12, var1, var3, param5);
        param3.popPose();
