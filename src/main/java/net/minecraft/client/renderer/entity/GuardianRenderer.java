...
public class GuardianRenderer extends MobRenderer<Guardian, GuardianModel> {
    ...
    public void render(Guardian param0, double param1, double param2, double param3, float param4, float param5, PoseStack param6, MultiBufferSource param7) {
        ...
        if (var0 != null) {
            ...
            param6.mulPose(Vector3f.YP.rotation(((float) (Math.PI / 2) - var10) * (180.0F / (float)Math.PI), true));
            param6.mulPose(Vector3f.XP.rotation(var9 * (180.0F / (float)Math.PI), true));
            int var11 = 1;
            ...
            VertexConsumer var40 = param7.getBuffer(RenderType.NEW_ENTITY(GUARDIAN_BEAM_LOCATION));
            OverlayTexture.setDefault(var40);
            ...
            var40.unsetDefaultOverlayCoords();
            param6.popPose();
        }
    ...
    private static void vertex(
        ...
        param0.vertex(param1, param2, param3, param4).color(param5, param6, param7, 255).uv(param8, param9).uv2(15728880).normal(0.0F, 1.0F, 0.0F).endVertex();
    }
