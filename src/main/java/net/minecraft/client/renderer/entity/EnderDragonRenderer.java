...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
    ...
    public void render(EnderDragon param0, float param1, float param2, PoseStack param3, MultiBufferSource param4, int param5) {
        ...
        param3.mulPose(Axis.YP.rotationDegrees(-var0));
        param3.mulPose(Axis.XP.rotationDegrees(var1 * 10.0F));
        param3.translate(0.0F, 0.0F, 1.0F);
        param3.scale(-1.0F, -1.0F, 1.0F);
        param3.translate(0.0F, -1.501F, 0.0F);
        ...
        if (param0.dragonDeathTime > 0) {
            ...
            param3.pushPose();
            param3.translate(0.0F, -1.0F, -2.0F);

            for(int var12 = 0; (float)var12 < (var8 + var8 * var8) / 2.0F * 60.0F; ++var12) {
                param3.mulPose(Axis.XP.rotationDegrees(var10.nextFloat() * 360.0F));
                param3.mulPose(Axis.YP.rotationDegrees(var10.nextFloat() * 360.0F));
                param3.mulPose(Axis.ZP.rotationDegrees(var10.nextFloat() * 360.0F));
                param3.mulPose(Axis.XP.rotationDegrees(var10.nextFloat() * 360.0F));
                param3.mulPose(Axis.YP.rotationDegrees(var10.nextFloat() * 360.0F));
                param3.mulPose(Axis.ZP.rotationDegrees(var10.nextFloat() * 360.0F + var8 * 90.0F));
    ...
    public static void renderCrystalBeams(
        ...
        param5.pushPose();
        param5.translate(0.0F, 2.0F, 0.0F);
        param5.mulPose(Axis.YP.rotation((float)(-Math.atan2((double)param2, (double)param0)) - (float) (Math.PI / 2)));
        param5.mulPose(Axis.XP.rotation((float)(-Math.atan2((double)var0, (double)param1)) - (float) (Math.PI / 2)));
    ...
    public static class DragonModel extends EntityModel<EnderDragon> {
        ...
        public void renderToBuffer(PoseStack param0, VertexConsumer param1, int param2, int param3, float param4, float param5, float param6, float param7) {
            ...
            param0.translate(0.0F, var1 - 2.0F, -3.0F);
            param0.mulPose(Axis.XP.rotationDegrees(var1 * 2.0F));
            float var2 = 0.0F;
            float var3 = 20.0F;
            float var4 = -12.0F;
            float var5 = 1.5F;
            double[] var6 = this.entity.getLatencyPos(6, this.a);
            float var7 = Mth.wrapDegrees((float)(this.entity.getLatencyPos(5, this.a)[0] - this.entity.getLatencyPos(10, this.a)[0]));
            float var8 = Mth.wrapDegrees((float)(this.entity.getLatencyPos(5, this.a)[0] + (double)(var7 / 2.0F)));
            ...
            for(int var10 = 0; var10 < 5; ++var10) {
                ...
                this.neck.yRot = Mth.wrapDegrees((float)(var11[0] - var6[0])) * (float) (Math.PI / 180.0) * 1.5F;
                this.neck.xRot = var12 + this.entity.getHeadPartYOffset(var10, var6, var11) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
                this.neck.zRot = -Mth.wrapDegrees((float)(var11[0] - (double)var8)) * (float) (Math.PI / 180.0) * 1.5F;
                this.neck.y = var3;
                this.neck.z = var4;
                this.neck.x = var2;
            ...
            this.head.yRot = Mth.wrapDegrees((float)(var13[0] - var6[0])) * (float) (Math.PI / 180.0);
            this.head.xRot = Mth.wrapDegrees(this.entity.getHeadPartYOffset(6, var6, var13)) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
            this.head.zRot = -Mth.wrapDegrees((float)(var13[0] - (double)var8)) * (float) (Math.PI / 180.0);
            this.head.render(param0, param1, param2, param3, 1.0F, 1.0F, 1.0F, param7);
            param0.pushPose();
            param0.translate(0.0F, 1.0F, 0.0F);
            param0.mulPose(Axis.ZP.rotationDegrees(-var7 * 1.5F));
            param0.translate(0.0F, -1.0F, 0.0F);
            this.body.zRot = 0.0F;
            ...
            for(int var16 = 0; var16 < 12; ++var16) {
                ...
                this.neck.yRot = (Mth.wrapDegrees((float)(var13[0] - var6[0])) * 1.5F + 180.0F) * (float) (Math.PI / 180.0);
                this.neck.xRot = var15 + (float)(var13[1] - var6[1]) * (float) (Math.PI / 180.0) * 1.5F * 5.0F;
                this.neck.zRot = Mth.wrapDegrees((float)(var13[0] - (double)var8)) * (float) (Math.PI / 180.0) * 1.5F;
                this.neck.y = var3;
                this.neck.z = var4;
                this.neck.x = var2;
                var3 += Mth.sin(this.neck.xRot) * 10.0F;
