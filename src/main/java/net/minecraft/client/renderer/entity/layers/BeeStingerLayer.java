...
public class BeeStingerLayer<T extends LivingEntity, M extends PlayerModel<T>> extends StuckInBodyLayer<T, M> {
    ...
    protected void renderStuckItem(
        ...
        param0.translate(0.0F, 0.0F, 0.0F);
        param0.mulPose(Axis.YP.rotationDegrees(var1 - 90.0F));
        param0.mulPose(Axis.ZP.rotationDegrees(var2));
        float var3 = 0.0F;
        float var4 = 0.125F;
        float var5 = 0.0F;
        float var6 = 0.0625F;
        ...
        param0.translate(2.5F, 0.0F, 0.0F);
