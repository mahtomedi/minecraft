...
public class ZombieVillagerRenderer extends HumanoidMobRenderer<ZombieVillager, ZombieVillagerModel<ZombieVillager>> {
    ...
    protected ResourceLocation getTextureLocation(ZombieVillager param0) {
        return ZOMBIE_VILLAGER_LOCATION;
    }

    protected void setupRotations(ZombieVillager param0, float param1, float param2, float param3) {
