...
public class ZombieVillagerRenderer extends HumanoidMobRenderer<ZombieVillager, ZombieVillagerModel<ZombieVillager>> {
    ...
    public ZombieVillagerRenderer(EntityRenderDispatcher param0, ReloadableResourceManager param1) {
        super(param0, new ZombieVillagerModel<>(RenderType::entityCutoutNoCull, 0.0F, false), 0.5F);
        this.addLayer(
            new HumanoidArmorLayer<>(
                this, new ZombieVillagerModel(RenderType::entitySolid, 0.5F, true), new ZombieVillagerModel(RenderType::entitySolid, 1.0F, true)
            )
        );
