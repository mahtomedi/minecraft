...
public class ShulkerBulletRenderer extends EntityRenderer<ShulkerBullet> {
    ...
    public void render(
        ...
        param6.mulPose(Vector3f.YP.rotationDegrees(Mth.sin(var2 * 0.1F) * 180.0F));
        param6.mulPose(Vector3f.XP.rotationDegrees(Mth.cos(var2 * 0.1F) * 180.0F));
        param6.mulPose(Vector3f.ZP.rotationDegrees(Mth.sin(var2 * 0.15F) * 360.0F));
        float var3 = 0.03125F;
        param6.scale(-1.0F, -1.0F, 1.0F);
        int var4 = param0.getLightColor();
        this.model.setupAnim(param0, 0.0F, 0.0F, 0.0F, var0, var1, 0.03125F);
        VertexConsumer var5 = param7.getBuffer(this.model.renderType(TEXTURE_LOCATION));
        this.model.renderToBuffer(param6, var5, var4, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F);
        param6.scale(1.5F, 1.5F, 1.5F);
        VertexConsumer var6 = param7.getBuffer(RenderType.entityForceTranslucent(TEXTURE_LOCATION));
