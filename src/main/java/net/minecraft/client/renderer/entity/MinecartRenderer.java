...
public class MinecartRenderer<T extends AbstractMinecart> extends EntityRenderer<T> {
    ...
    public void render(T param0, double param1, double param2, double param3, float param4, float param5) {
        ...
        GlStateManager.translatef(var1, var2, var3);
        ...
        GlStateManager.translatef((float)param1, (float)param2 + 0.375F, (float)param3);
        GlStateManager.rotatef(180.0F - param4, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotatef(-var9, 0.0F, 0.0F, 1.0F);
        ...
        if (var13 > 0.0F) {
            GlStateManager.rotatef(Mth.sin(var13) * var13 * var14 / 10.0F * (float)param0.getHurtDir(), 1.0F, 0.0F, 0.0F);
        }
        ...
        if (var16.getRenderShape() != RenderShape.INVISIBLE) {
            ...
            GlStateManager.translatef(-0.5F, (float)(var15 - 8) / 16.0F, 0.5F);
