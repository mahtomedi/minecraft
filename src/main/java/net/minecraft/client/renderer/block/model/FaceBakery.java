...
public class FaceBakery {
    ...
    public static BlockFaceUV recomputeUVs(BlockFaceUV param0, Direction param1, Transformation param2, ResourceLocation param3) {
        ...
        Vector4f var3 = var0.transform(new Vector4f(var1 / 16.0F, var2 / 16.0F, 0.0F, 1.0F));
        ...
        Vector4f var8 = var0.transform(new Vector4f(var6 / 16.0F, var7 / 16.0F, 0.0F, 1.0F));
        ...
        Matrix3f var20 = new Matrix3f(var0);
    ...
    private void applyElementRotation(Vector3f param0, @Nullable BlockElementRotation param1) {
        if (param1 != null) {
            ...
            Quaternionf var8 = new Quaternionf().rotationAxis(param1.angle() * (float) (Math.PI / 180.0), var0);
            if (param1.rescale()) {
            ...
            this.rotateVertexBy(param0, new Vector3f((Vector3fc)param1.origin()), new Matrix4f().rotation(var8), var1);
        }
    }
    ...
    private void rotateVertexBy(Vector3f param0, Vector3f param1, Matrix4f param2, Vector3f param3) {
        Vector4f var0 = param2.transform(new Vector4f(param0.x() - param1.x(), param0.y() - param1.y(), param0.z() - param1.z(), 1.0F));
        var0.mul(new Vector4f(param3, 1.0F));
    ...
    public static Direction calculateFacing(int[] param0) {
        ...
        Vector3f var3 = new Vector3f((Vector3fc)var0).sub(var1);
        Vector3f var4 = new Vector3f((Vector3fc)var2).sub(var1);
        Vector3f var5 = new Vector3f((Vector3fc)var4).cross(var3).normalize();
        if (!var5.isFinite()) {
            return Direction.UP;
        } else {
            Direction var6 = null;
