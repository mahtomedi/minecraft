...
public class ShapelessRecipeBuilder {
    ...
    public ShapelessRecipeBuilder requires(Tag<Item> param0) {
    ...
    public ShapelessRecipeBuilder unlocks(String param0, CriterionTriggerInstance param1) {
        this.advancement.addCriterion(param0, param1);
        return this;
    }

    public ShapelessRecipeBuilder group(String param0) {
        this.group = param0;
        return this;
    }
    ...
    public void save(Consumer<FinishedRecipe> param0, String param1) {
        ...
        if (new ResourceLocation(param1).equals(var0)) {
            throw new IllegalStateException("Shapeless Recipe " + param1 + " should remove its 'save' argument");
        } else {
    ...
    public void save(Consumer<FinishedRecipe> param0, ResourceLocation param1) {
        ...
        this.advancement
            ...
            .addCriterion("has_the_recipe", new RecipeUnlockedTrigger.TriggerInstance(param1))
