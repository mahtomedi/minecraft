...
public class LegacyUpgradeRecipeBuilder {
    ...
    public LegacyUpgradeRecipeBuilder(RecipeSerializer<?> param0, Ingredient param1, Ingredient param2, RecipeCategory param3, Item param4) {
    ...
    public static LegacyUpgradeRecipeBuilder smithing(Ingredient param0, Ingredient param1, RecipeCategory param2, Item param3) {
        return new LegacyUpgradeRecipeBuilder(RecipeSerializer.SMITHING, param0, param1, param2, param3);
    }

    public LegacyUpgradeRecipeBuilder unlocks(String param0, CriterionTriggerInstance param1) {
