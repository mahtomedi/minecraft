...
public class EntityLoot implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> param0) {
                            ...
                            LootItemKilledByPlayerCondition.killedByPlayer()
                                .or(
                                    LootItemEntityPropertyCondition.hasProperties(
                                        ...
                                        EntityPredicate.Builder.entity().targetedEntity(EntityPredicate.Builder.entity().build())
                                    )
                                )
                        )
                        .when(LootItemRandomChanceWithLootingCondition.randomChanceAndLootingBoost(0.025F, 0.01F))
        ...
        for(EntityType<?> var1 : Registry.ENTITY_TYPE) {
            ResourceLocation var2 = var1.getDefaultLootTable();
    ...
    private void add(EntityType<?> param0, LootTable.Builder param1) {
        this.add(param0.getDefaultLootTable(), param1);
    }

    private void add(ResourceLocation param0, LootTable.Builder param1) {
