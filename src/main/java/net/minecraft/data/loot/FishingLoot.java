...
public class FishingLoot implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    public static final LootItemCondition.Builder IN_JUNGLE_EDGE = LocationCheck.checkLocation(
        LocationPredicate.Builder.location().setBiome(Biomes.JUNGLE_EDGE)
    );
                    ...
                    LootPool.lootPool()
                        .add(
                            LootItem.lootTableItem(Items.LEATHER_BOOTS)
                                .setWeight(10)
                                .apply(SetItemDamageFunction.setDamage(RandomValueBounds.between(0.0F, 0.9F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.POTION)
                                .setWeight(10)
                                .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), param0x -> param0x.putString("Potion", "minecraft:water"))))
                        )
