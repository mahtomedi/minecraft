...
public class UpdateOneTwentyBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        LootItemBlockStatePropertyCondition.Builder var0 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TORCHFLOWER_CROP)
        ...
        this.add(
            ...
            this.applyExplosionDecay(
                ...
                LootTable.lootTable()
                    .withPool(
                        LootPool.lootPool()
                            .add(LootItem.lootTableItem(Items.TORCHFLOWER).when(var0).otherwise(LootItem.lootTableItem(Items.TORCHFLOWER_SEEDS)))
                    )
            )
        );
