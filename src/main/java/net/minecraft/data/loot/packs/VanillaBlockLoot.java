...
public class VanillaBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.SCULK_VEIN, param0 -> this.createMultifaceBlockDrops(param0, HAS_SILK_TOUCH));
        ...
        this.add(Blocks.STONE, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.COBBLESTONE));
        this.add(Blocks.DEEPSLATE, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.COBBLED_DEEPSLATE));
        this.add(Blocks.GRASS_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DIRT));
        this.add(Blocks.PODZOL, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DIRT));
        this.add(Blocks.MYCELIUM, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DIRT));
        this.add(Blocks.TUBE_CORAL_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DEAD_TUBE_CORAL_BLOCK));
        this.add(Blocks.BRAIN_CORAL_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DEAD_BRAIN_CORAL_BLOCK));
        this.add(Blocks.BUBBLE_CORAL_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
        this.add(Blocks.FIRE_CORAL_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DEAD_FIRE_CORAL_BLOCK));
        this.add(Blocks.HORN_CORAL_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.DEAD_HORN_CORAL_BLOCK));
        this.add(Blocks.CRIMSON_NYLIUM, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.NETHERRACK));
        this.add(Blocks.WARPED_NYLIUM, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.NETHERRACK));
        this.add(Blocks.BOOKSHELF, param0 -> this.createSingleItemTableWithSilkTouch(param0, Items.BOOK, ConstantValue.exactly(3.0F)));
        this.add(Blocks.CLAY, param0 -> this.createSingleItemTableWithSilkTouch(param0, Items.CLAY_BALL, ConstantValue.exactly(4.0F)));
        this.add(Blocks.ENDER_CHEST, param0 -> this.createSingleItemTableWithSilkTouch(param0, Blocks.OBSIDIAN, ConstantValue.exactly(8.0F)));
        this.add(Blocks.SNOW_BLOCK, param0 -> this.createSingleItemTableWithSilkTouch(param0, Items.SNOWBALL, ConstantValue.exactly(4.0F)));
        ...
        this.add(Blocks.OAK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.PETRIFIED_OAK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SPRUCE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.BIRCH_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.JUNGLE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.ACACIA_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.DARK_OAK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.MANGROVE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.CHERRY_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.BAMBOO_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.BAMBOO_MOSAIC_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.COBBLESTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.DARK_PRISMARINE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.NETHER_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.PRISMARINE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.PRISMARINE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.PURPUR_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.QUARTZ_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.RED_SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.CUT_RED_SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.CUT_SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.STONE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.STONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SMOOTH_STONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_GRANITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SMOOTH_RED_SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.MOSSY_STONE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_DIORITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.MOSSY_COBBLESTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.END_STONE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SMOOTH_SANDSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.SMOOTH_QUARTZ_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.GRANITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.ANDESITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.RED_NETHER_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_ANDESITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.DIORITE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.CRIMSON_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WARPED_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.BLACKSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_BLACKSTONE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.OXIDIZED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WEATHERED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.EXPOSED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.WAXED_CUT_COPPER_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.COBBLED_DEEPSLATE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_DEEPSLATE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.DEEPSLATE_TILE_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.DEEPSLATE_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.MUD_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.OAK_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.SPRUCE_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.BIRCH_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.JUNGLE_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.ACACIA_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.DARK_OAK_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.MANGROVE_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.CHERRY_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.BAMBOO_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WARPED_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.CRIMSON_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.IRON_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.BLACK_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BLUE_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BROWN_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.CYAN_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GRAY_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GREEN_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_BLUE_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_GRAY_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIME_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.MAGENTA_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PURPLE_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.ORANGE_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PINK_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.RED_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.WHITE_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.YELLOW_BED, param0 -> this.createSinglePropConditionTable(param0, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LILAC, param0 -> this.createSinglePropConditionTable(param0, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.SUNFLOWER, param0 -> this.createSinglePropConditionTable(param0, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.PEONY, param0 -> this.createSinglePropConditionTable(param0, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.ROSE_BUSH, param0 -> this.createSinglePropConditionTable(param0, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(
            Blocks.TNT,
            LootTable.lootTable()
                .withPool(
                                                        ...
                                                        LootItemBlockStatePropertyCondition.hasBlockStateProperties(param0)
                                                            .setProperties(
                                                                StatePropertiesPredicate.Builder.properties()
                                                                    .hasProperty(SeaPickleBlock.PICKLES, param1.intValue())
                                                            )
                                                    )
                                        )
                                )
        ...
        this.add(
            Blocks.COMPOSTER,
            param0 -> LootTable.lootTable()
                    .withPool(LootPool.lootPool().add(this.applyExplosionDecay(param0, LootItem.lootTableItem(Items.COMPOSTER))))
                    .withPool(
                        LootPool.lootPool()
        ...
        this.add(Blocks.CAVE_VINES, param0 -> BlockLootSubProvider.createCaveVinesDrop(param0));
        this.add(Blocks.CAVE_VINES_PLANT, param0 -> BlockLootSubProvider.createCaveVinesDrop(param0));
        this.add(Blocks.CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.WHITE_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.ORANGE_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.MAGENTA_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.LIGHT_BLUE_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.YELLOW_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.LIME_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.PINK_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.GRAY_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.LIGHT_GRAY_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.CYAN_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.PURPLE_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.BLUE_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.BROWN_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.GREEN_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.RED_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.BLACK_CANDLE, param1 -> this.createCandleDrops(param1));
        this.add(Blocks.BEACON, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.BREWING_STAND, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.CHEST, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.DISPENSER, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.DROPPER, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.ENCHANTING_TABLE, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.FURNACE, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.HOPPER, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.TRAPPED_CHEST, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.SMOKER, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.BLAST_FURNACE, param1 -> this.createNameableBlockEntityTable(param1));
        this.add(Blocks.BARREL, param1 -> this.createNameableBlockEntityTable(param1));
        ...
        this.add(Blocks.SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.BLACK_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.BLUE_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.BROWN_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.CYAN_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.GRAY_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.GREEN_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.LIGHT_BLUE_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.LIGHT_GRAY_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.LIME_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.MAGENTA_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.ORANGE_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.PINK_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.PURPLE_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.RED_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.WHITE_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.YELLOW_SHULKER_BOX, param1 -> this.createShulkerBoxDrop(param1));
        this.add(Blocks.BLACK_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.BLUE_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.BROWN_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.CYAN_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.GRAY_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.GREEN_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.LIGHT_BLUE_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.LIGHT_GRAY_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.LIME_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.MAGENTA_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.ORANGE_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.PINK_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.PURPLE_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.RED_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.WHITE_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(Blocks.YELLOW_BANNER, param1 -> this.createBannerDrop(param1));
        this.add(
            Blocks.PLAYER_HEAD,
            param0 -> LootTable.lootTable()
                    .withPool(
        ...
        this.add(Blocks.BEE_NEST, param0 -> createBeeNestDrop(param0));
        this.add(Blocks.BEEHIVE, param0 -> createBeeHiveDrop(param0));
        this.add(Blocks.OAK_LEAVES, param0 -> this.createOakLeavesDrops(param0, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.SPRUCE_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.BIRCH_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.JUNGLE_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.JUNGLE_SAPLING, JUNGLE_LEAVES_SAPLING_CHANGES));
        this.add(Blocks.ACACIA_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.DARK_OAK_LEAVES, param0 -> this.createOakLeavesDrops(param0, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.CHERRY_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.CHERRY_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.AZALEA_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.FLOWERING_AZALEA_LEAVES, param0 -> this.createLeavesDrops(param0, Blocks.FLOWERING_AZALEA, NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        this.add(Blocks.BEETROOTS, this.createCropDrops(Blocks.BEETROOTS, Items.BEETROOT, Items.BEETROOT_SEEDS, var0));
        LootItemCondition.Builder var1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.WHEAT)
            .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(CropBlock.AGE, 7));
        this.add(Blocks.WHEAT, this.createCropDrops(Blocks.WHEAT, Items.WHEAT, Items.WHEAT_SEEDS, var1));
        ...
        LootItemCondition.Builder var3 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.MANGROVE_PROPAGULE)
            .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(MangrovePropaguleBlock.AGE, 4));
        this.add(
            Blocks.MANGROVE_PROPAGULE,
            this.applyExplosionDecay(
                Blocks.MANGROVE_PROPAGULE, LootTable.lootTable().withPool(LootPool.lootPool().when(var3).add(LootItem.lootTableItem(Items.MANGROVE_PROPAGULE)))
            )
        );
        LootItemBlockStatePropertyCondition.Builder var4 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.TORCHFLOWER_CROP)
        ...
        this.add(
            ...
            this.applyExplosionDecay(
                ...
                LootTable.lootTable()
                    .withPool(
                        LootPool.lootPool()
                            .add(LootItem.lootTableItem(Items.TORCHFLOWER).when(var4).otherwise(LootItem.lootTableItem(Items.TORCHFLOWER_SEEDS)))
                    )
            )
        );
        this.dropSelf(Blocks.SNIFFER_EGG);
        this.add(Blocks.PITCHER_CROP, param0 -> this.createPitcherCropLoot());
        ...
        LootItemCondition.Builder var5 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.POTATOES)
        ...
        this.add(
            ...
            param0 -> this.applyExplosionDecay(
                    param0,
                    LootTable.lootTable()
                        .withPool(
                            LootPool.lootPool()
        ...
        this.add(Blocks.BROWN_MUSHROOM_BLOCK, param0 -> this.createMushroomBlockDrop(param0, Blocks.BROWN_MUSHROOM));
        this.add(Blocks.RED_MUSHROOM_BLOCK, param0 -> this.createMushroomBlockDrop(param0, Blocks.RED_MUSHROOM));
        this.add(Blocks.COAL_ORE, param0 -> this.createOreDrop(param0, Items.COAL));
        this.add(Blocks.DEEPSLATE_COAL_ORE, param0 -> this.createOreDrop(param0, Items.COAL));
        this.add(Blocks.EMERALD_ORE, param0 -> this.createOreDrop(param0, Items.EMERALD));
        this.add(Blocks.DEEPSLATE_EMERALD_ORE, param0 -> this.createOreDrop(param0, Items.EMERALD));
        this.add(Blocks.NETHER_QUARTZ_ORE, param0 -> this.createOreDrop(param0, Items.QUARTZ));
        this.add(Blocks.DIAMOND_ORE, param0 -> this.createOreDrop(param0, Items.DIAMOND));
        this.add(Blocks.DEEPSLATE_DIAMOND_ORE, param0 -> this.createOreDrop(param0, Items.DIAMOND));
        this.add(Blocks.COPPER_ORE, param1 -> this.createCopperOreDrops(param1));
        this.add(Blocks.DEEPSLATE_COPPER_ORE, param1 -> this.createCopperOreDrops(param1));
        this.add(Blocks.IRON_ORE, param0 -> this.createOreDrop(param0, Items.RAW_IRON));
        this.add(Blocks.DEEPSLATE_IRON_ORE, param0 -> this.createOreDrop(param0, Items.RAW_IRON));
        this.add(Blocks.GOLD_ORE, param0 -> this.createOreDrop(param0, Items.RAW_GOLD));
        this.add(Blocks.DEEPSLATE_GOLD_ORE, param0 -> this.createOreDrop(param0, Items.RAW_GOLD));
        this.add(
        ...
        this.add(Blocks.LAPIS_ORE, param1 -> this.createLapisOreDrops(param1));
        this.add(Blocks.DEEPSLATE_LAPIS_ORE, param1 -> this.createLapisOreDrops(param1));
        this.add(
            Blocks.COBWEB, param0 -> createSilkTouchOrShearsDispatchTable(param0, this.applyExplosionCondition(param0, LootItem.lootTableItem(Items.STRING)))
        );
        this.add(
            Blocks.DEAD_BUSH,
            param0 -> createShearsDispatchTable(
                    param0,
                    this.applyExplosionDecay(
                        param0, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F)))
                    )
                )
        );
        this.add(Blocks.NETHER_SPROUTS, param0 -> BlockLootSubProvider.createShearsOnlyDrop(param0));
        this.add(Blocks.SEAGRASS, param0 -> BlockLootSubProvider.createShearsOnlyDrop(param0));
        this.add(Blocks.VINE, param0 -> BlockLootSubProvider.createShearsOnlyDrop(param0));
        this.add(Blocks.GLOW_LICHEN, param0 -> this.createMultifaceBlockDrops(param0, HAS_SHEARS));
        this.add(Blocks.HANGING_ROOTS, param0 -> BlockLootSubProvider.createShearsOnlyDrop(param0));
        this.add(Blocks.SMALL_DRIPLEAF, param0 -> BlockLootSubProvider.createShearsOnlyDrop(param0));
        ...
        this.add(Blocks.ATTACHED_PUMPKIN_STEM, param0 -> this.createAttachedStemDrops(param0, Items.PUMPKIN_SEEDS));
        this.add(
            ...
            param0 -> LootTable.lootTable()
                    .withPool(
                        LootPool.lootPool()
                            .setRolls(ConstantValue.exactly(1.0F))
                            .add(
                                this.applyExplosionCondition(param0, LootItem.lootTableItem(param0))
        ...
        this.add(Blocks.REDSTONE_ORE, param1 -> this.createRedstoneOreDrops(param1));
        this.add(Blocks.DEEPSLATE_REDSTONE_ORE, param1 -> this.createRedstoneOreDrops(param1));
        this.add(
            Blocks.SEA_LANTERN,
            param0 -> createSilkTouchDispatchTable(
                    param0,
                            ...
                            .add(
                                AlternativesEntry.alternatives(
                                    AlternativesEntry.alternatives(
                                            ...
                                            param1 -> LootItem.lootTableItem(Items.SNOWBALL)
                                                    .when(
                                                        LootItemBlockStatePropertyCondition.hasBlockStateProperties(param0)
                                                            .setProperties(
                                                                StatePropertiesPredicate.Builder.properties()
                                                                    .hasProperty(SnowLayerBlock.LAYERS, param1.intValue())
                                                            )
                                                    )
                                                    .apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)param1.intValue())))
                                        )
                                        .when(HAS_NO_SILK_TOUCH),
                                    AlternativesEntry.alternatives(
                                        SnowLayerBlock.LAYERS.getPossibleValues(),
                                        param1 -> (LootPoolEntryContainer.Builder<?>)(param1 == 8
        ...
        this.add(
            ...
            param0 -> createSilkTouchDispatchTable(
                    param0,
                    this.applyExplosionCondition(
                        param0, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                    )
                )
        );
        this.add(
        ...
        this.add(
            ...
            param0 -> createSilkTouchDispatchTable(
                    param0,
                    this.applyExplosionCondition(
                        param0, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F)))
                    )
                )
        );
        this.add(
            ...
            param0 -> createSilkTouchDispatchTable(
                    ...
                    LootItem.lootTableItem(Items.AMETHYST_SHARD)
                        ...
                        .otherwise(
                            this.applyExplosionDecay(
                                param0, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))
                            )
                        )
                )
        );
    ...
    private LootTable.Builder createDecoratedPotTable(Block param0) {
                ...
                LootPool.lootPool()
                    ...
                    .add(
                        DynamicLoot.dynamicEntry(DecoratedPotBlock.SHARDS)
                            ...
                            .otherwise(
                                LootItem.lootTableItem(param0)
                                    .apply(CopyNbtFunction.copyData(ContextNbtProvider.BLOCK_ENTITY).copy("shards", "BlockEntityTag.shards"))
                            )
                    )
            );
    }
                    ...
                    LootPool.lootPool()
                        .add(
                            AlternativesEntry.alternatives(
                                ...
                                param0 -> {
                                    LootItemBlockStatePropertyCondition.Builder var0 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                            Blocks.PITCHER_CROP
                                        )
                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
                                    LootItemBlockStatePropertyCondition.Builder var1 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(
                                            Blocks.PITCHER_CROP
                                        )
                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, param0.intValue()));
                                    return param0 == 4
                                        ? LootItem.lootTableItem(Items.PITCHER_PLANT)
                                            .when(var1)
                                            .when(var0)
