...
public class VanillaChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> param0) {
        ...
        param0.accept(BuiltInLootTables.BASTION_BRIDGE, bastionBridgeLootTable());
        param0.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, bastionHoglinStableLootTable());
        param0.accept(BuiltInLootTables.BASTION_OTHER, bastionOtherLootTable());
        param0.accept(BuiltInLootTables.BASTION_TREASURE, bastionTreasureLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        param0.accept(BuiltInLootTables.END_CITY_TREASURE, endCityTreasureLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.NETHER_BRIDGE, netherBridgeLootTable());
        param0.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
        param0.accept(BuiltInLootTables.SHIPWRECK_MAP, shipwreckMapLootTable());
        param0.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, shipwreckSupplyLootTable());
        param0.accept(BuiltInLootTables.SHIPWRECK_TREASURE, shipwreckTreasureLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, strongholdCorridorLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, strongholdLibraryLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.WOODLAND_MANSION, woodlandMansionLootTable());
        param0.accept(
        ...
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_CHAMBER_DISPENSER, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_DISPENSER, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_WATER_DISPENSER, LootTable.lootTable());
        param0.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_POT, LootTable.lootTable());
        spawnerLootTables(param0);
    }

    public static void spawnerLootTables(BiConsumer<ResourceLocation, LootTable.Builder> param0) {
        param0.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        param0.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
    }
