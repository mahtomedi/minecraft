...
public class UpdateOneTwentyOneBlockLoot extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(Blocks.TUFF_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.TUFF_BRICK_SLAB, param1 -> this.createSlabItemTable(param1));
        this.add(Blocks.POLISHED_TUFF_SLAB, param1 -> this.createSlabItemTable(param1));
        ...
        this.add(Blocks.COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.EXPOSED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WEATHERED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WAXED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, param1 -> this.createDoorTable(param1));
