            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.GOLD_BLOCK).setWeight(25).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F)))
                        )
                        .add(
                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.SPECTRAL_ARROW)
                                .setWeight(16)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 15.0F)))
                        )
