            ...
            LootTable.lootTable()
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(5).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 9.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.MELON_SEEDS).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F)))
                        )
                        .add(
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.GOLD_BLOCK).setWeight(16).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.GOLDEN_CARROT)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(8.0F, 17.0F)))
                        )
                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.SPECTRAL_ARROW)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(10.0F, 22.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.GOLDEN_CARROT)
                                .setWeight(12)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(6.0F, 17.0F)))
                        )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.ENCHANTED_GOLDEN_APPLE).setWeight(2).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1)))
                        )
                )
                .withPool(
                    LootPool.lootPool()
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.ROTTEN_FLESH)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 8.0F)))
                        )
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.BEETROOT_SEEDS)
                                .setWeight(5)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 10.0F)))
                        )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.GOLD_NUGGET).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 3.0F)))
                        )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.DIAMOND_HORSE_ARMOR))
                        .add(
                            LootItem.lootTableItem(Items.BOOK).apply(EnchantWithLevelsFunction.enchantWithLevels(ConstantIntValue.exactly(30)).allowTreasure())
                        )
                )
        );
        param0.accept(
            ...
            LootTable.lootTable()
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.TRIPWIRE_HOOK)
                                .setWeight(3)
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.ROTTEN_FLESH)
                                .setWeight(5)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 24.0F)))
                        )
            ...
            LootTable.lootTable()
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.OAK_PLANKS)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 12.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.DARK_OAK_LOG)
                                .setWeight(3)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 3.0F)))
                        )
                )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.OAK_SAPLING).setWeight(5).apply(SetItemCountFunction.setCount(RandomValueBounds.between(3.0F, 7.0F)))
                        )
                        .add(LootItem.lootTableItem(Items.SADDLE).setWeight(3))
                        .add(LootItem.lootTableItem(Items.IRON_HORSE_ARMOR))
                        .add(LootItem.lootTableItem(Items.GOLDEN_HORSE_ARMOR))
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.WATER_BUCKET).setWeight(1).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 3.0F)))
                        )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.ROTTEN_FLESH).setWeight(7).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.LAPIS_LAZULI).setWeight(1).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F)))
                        )
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.OAK_SAPLING).setWeight(5).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 2.0F)))
                        )
                )
        );
        param0.accept(
                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.SWEET_BERRIES)
                                .setWeight(5)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 7.0F)))
                        )
                        .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F))))
                        .add(
                            LootItem.lootTableItem(Items.PUMPKIN_SEEDS)
            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(LootItem.lootTableItem(Items.BREAD).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F))))
                        .add(
                            LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 5.0F)))
                        )
                        .add(LootItem.lootTableItem(Items.EMERALD).setWeight(2).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F))))
                        .add(
                ...
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.IRON_NUGGET)
                                .setWeight(40)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(9.0F, 18.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.GOLD_NUGGET)
                                .setWeight(15)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 24.0F)))
                        )
