            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Blocks.GOLD_BLOCK).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 4.0F)))
                        )
                        .add(
                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.SPECTRAL_ARROW)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 20.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.PIGLIN_BANNER_PATTERN).setWeight(10).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1)))
                        )
