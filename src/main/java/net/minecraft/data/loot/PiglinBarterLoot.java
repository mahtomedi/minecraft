            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.WARPED_FUNGI).setWeight(5).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 2.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.CRIMSON_FUNGI)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 4.0F)))
                        )
                        .add(
