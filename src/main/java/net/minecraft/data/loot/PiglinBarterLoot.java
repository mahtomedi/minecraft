                    ...
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.IRON_NUGGET)
                                .setWeight(10)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(9.0F, 36.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.GLOWSTONE_DUST)
                                .setWeight(20)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(5.0F, 12.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.MAGMA_CREAM).setWeight(20).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 6.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.ENDER_PEARL).setWeight(20).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 8.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.FIRE_CHARGE).setWeight(40).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0F, 5.0F)))
                        )
