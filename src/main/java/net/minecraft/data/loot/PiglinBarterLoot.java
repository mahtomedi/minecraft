            ...
            LootTable.lootTable()
                .withPool(
                    LootPool.lootPool()
                        ...
                        .add(
                            LootItem.lootTableItem(Items.MAGMA_CREAM).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0F, 6.0F)))
                        )
                        .add(
                            LootItem.lootTableItem(Items.ENDER_PEARL).setWeight(10).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 8.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.SHROOMLIGHT)
                                .setWeight(20)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(6.0F, 10.0F)))
                        )
                        ...
                        .add(
                            LootItem.lootTableItem(Items.WARPED_FUNGUS)
                                .setWeight(20)
                                .apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0F, 10.0F)))
                        )
                        .add(
