...
public class EndFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> param0) {
        FeatureUtils.register(param0, END_SPIKE, Feature.END_SPIKE, new SpikeConfiguration(false, ImmutableList.of(), null));
        FeatureUtils.register(param0, END_GATEWAY_RETURN, Feature.END_GATEWAY, EndGatewayConfiguration.knownExit(ServerLevel.END_SPAWN_POINT, true));
        FeatureUtils.register(param0, END_GATEWAY_DELAYED, Feature.END_GATEWAY, EndGatewayConfiguration.delayedExitSearch());
        FeatureUtils.register(param0, CHORUS_PLANT, Feature.CHORUS_PLANT);
        FeatureUtils.register(param0, END_ISLAND, Feature.END_ISLAND);
    }
}
