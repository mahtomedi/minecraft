...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> param0) {
        ...
        FeatureUtils.register(param0, BIRCH, Feature.TREE, createBirch().build());
        FeatureUtils.register(
            param0,
            ACACIA,
            Feature.TREE,
        ...
        FeatureUtils.register(param0, FANCY_OAK, Feature.TREE, createFancyOak().build());
        FeatureUtils.register(param0, JUNGLE_TREE_NO_VINE, Feature.TREE, createJungleTree().ignoreVines().build());
        FeatureUtils.register(
            param0,
            MEGA_JUNGLE_TREE,
            Feature.TREE,
        ...
        FeatureUtils.register(
            ...
            new TreeConfiguration.TreeConfigurationBuilder(
                    ...
                    new UpwardsBranchingTrunkPlacer(
                        2, 1, 4, UniformInt.of(1, 4), 0.5F, UniformInt.of(0, 1), var0.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)
                    ),
                    ...
                    Optional.of(
                        new MangroveRootPlacer(
                            ...
                            new MangroveRootPlacement(
                                var0.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH),
        ...
        FeatureUtils.register(
            ...
            new TreeConfiguration.TreeConfigurationBuilder(
                    BlockStateProvider.simple(Blocks.MANGROVE_LOG),
                    new UpwardsBranchingTrunkPlacer(
                        4, 1, 9, UniformInt.of(1, 6), 0.5F, UniformInt.of(0, 1), var0.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)
                    ),
                    BlockStateProvider.simple(Blocks.MANGROVE_LEAVES),
                    new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70),
                    Optional.of(
