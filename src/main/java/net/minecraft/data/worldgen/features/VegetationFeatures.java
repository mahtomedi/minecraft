...
public class VegetationFeatures {
    ...
    public static final ConfiguredFeature<NoneFeatureConfiguration, ?> VINES = FeatureUtils.register(
        "vines", Feature.VINES.configured(FeatureConfiguration.NONE)
    );
        ...
        Feature.RANDOM_PATCH
            .configured(
                FeatureUtils.simplePatchConfiguration(
                    Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.BROWN_MUSHROOM)))
                )
            )
    );
    public static final ConfiguredFeature<?, ?> PATCH_RED_MUSHROOM = FeatureUtils.register(
        ...
        Feature.RANDOM_PATCH
            .configured(
                FeatureUtils.simplePatchConfiguration(
                    Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.RED_MUSHROOM)))
                )
            )
    );
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> PATCH_SUNFLOWER = FeatureUtils.register(
        ...
        Feature.RANDOM_PATCH
            .configured(
                FeatureUtils.simplePatchConfiguration(
                    Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.SUNFLOWER)))
                )
            )
    );
                    ...
                    () -> Feature.SIMPLE_BLOCK
                            ...
                            .filtered(
                                BlockPredicate.allOf(
                                    ...
                                    BlockPredicate.not(BlockPredicate.matchesBlock(Blocks.PODZOL, new BlockPos(0, -1, 0)))
                                )
                            )
                )
            )
    ...
    public static final ConfiguredFeature<RandomPatchConfiguration, ?> PATCH_LARGE_FERN = FeatureUtils.register(
        ...
        Feature.RANDOM_PATCH
            .configured(
                FeatureUtils.simplePatchConfiguration(
                    Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.LARGE_FERN)))
                )
            )
    );
                ...
                new SimpleRandomFeatureConfiguration(
                    List.of(
                        () -> Feature.RANDOM_PATCH
                                .configured(
                                    FeatureUtils.simplePatchConfiguration(
                                        Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.LILAC)))
                                    )
                                )
                                .placed(),
                        () -> Feature.RANDOM_PATCH
                                .configured(
                                    FeatureUtils.simplePatchConfiguration(
                                        Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.ROSE_BUSH)))
                                    )
                                )
                                .placed(),
                        () -> Feature.RANDOM_PATCH
                                .configured(
                                    FeatureUtils.simplePatchConfiguration(
                                        Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.PEONY)))
                                    )
                                )
                                .placed(),
    ...
    public static final ConfiguredFeature<RandomFeatureConfiguration, ?> BIRCH_TALL = FeatureUtils.register(
        ...
        Feature.RANDOM_SELECTOR
            .configured(
                new RandomFeatureConfiguration(
                    List.of(new WeightedPlacedFeature(TreePlacements.SUPER_BIRCH_BEES_0002, 0.5F)), TreePlacements.BIRCH_BEES_0002_PLACED
                )
            )
    );
    ...
    public static final ConfiguredFeature<RandomFeatureConfiguration, ?> TREES_BIRCH_AND_OAK = FeatureUtils.register(
        ...
        Feature.RANDOM_SELECTOR
            .configured(
                new RandomFeatureConfiguration(
                    List.of(
                        new WeightedPlacedFeature(TreePlacements.BIRCH_BEES_0002_PLACED, 0.2F),
    ...
    public static final ConfiguredFeature<RandomFeatureConfiguration, ?> TREES_OLD_GROWTH_SPRUCE_TAIGA = FeatureUtils.register(
        ...
        Feature.RANDOM_SELECTOR
            .configured(
                new RandomFeatureConfiguration(
                    List.of(
                        new WeightedPlacedFeature(TreePlacements.MEGA_SPRUCE_CHECKED, 0.33333334F),
    ...
    private static RandomPatchConfiguration grassPatch(BlockStateProvider param0, int param1) {
        return FeatureUtils.simpleRandomPatchConfiguration(param1, Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(param0)).onlyWhenEmpty());
    }
}
