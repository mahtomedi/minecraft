...
public class MiscOverworldFeatures {
    ...
    public static final ConfiguredFeature<DiskConfiguration, ?> DISK_CLAY = FeatureUtils.register(
        ...
        Feature.DISK
            .configured(
                new DiskConfiguration(
                    Blocks.CLAY.defaultBlockState(), UniformInt.of(2, 3), 1, List.of(Blocks.DIRT.defaultBlockState(), Blocks.CLAY.defaultBlockState())
                )
            )
    );
    ...
    public static final ConfiguredFeature<SpringConfiguration, ?> SPRING_LAVA_FROZEN = FeatureUtils.register(
        ...
        Feature.SPRING
            .configured(
                new SpringConfiguration(Fluids.LAVA.defaultFluidState(), true, 4, 1, ImmutableSet.of(Blocks.SNOW_BLOCK, Blocks.POWDER_SNOW, Blocks.PACKED_ICE))
            )
    );
