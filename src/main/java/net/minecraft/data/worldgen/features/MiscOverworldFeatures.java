...
public class MiscOverworldFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> param0) {
        FeatureUtils.register(param0, ICE_SPIKE, Feature.ICE_SPIKE);
        ...
        FeatureUtils.register(param0, FOREST_ROCK, Feature.FOREST_ROCK, new BlockStateConfiguration(Blocks.MOSSY_COBBLESTONE.defaultBlockState()));
        FeatureUtils.register(param0, ICEBERG_PACKED, Feature.ICEBERG, new BlockStateConfiguration(Blocks.PACKED_ICE.defaultBlockState()));
        FeatureUtils.register(param0, ICEBERG_BLUE, Feature.ICEBERG, new BlockStateConfiguration(Blocks.BLUE_ICE.defaultBlockState()));
        FeatureUtils.register(param0, BLUE_ICE, Feature.BLUE_ICE);
        FeatureUtils.register(
            param0,
            LAKE_LAVA,
            Feature.LAKE,
        ...
        FeatureUtils.register(param0, FREEZE_TOP_LAYER, Feature.FREEZE_TOP_LAYER);
        FeatureUtils.register(
            param0,
            DISK_GRASS,
            Feature.DISK,
        ...
        FeatureUtils.register(param0, BONUS_CHEST, Feature.BONUS_CHEST);
        FeatureUtils.register(param0, VOID_START_PLATFORM, Feature.VOID_START_PLATFORM);
        FeatureUtils.register(param0, DESERT_WELL, Feature.DESERT_WELL);
        FeatureUtils.register(
            param0,
