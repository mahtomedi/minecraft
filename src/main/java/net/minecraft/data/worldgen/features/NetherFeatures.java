...
public class NetherFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> param0) {
        ...
        FeatureUtils.register(param0, SMALL_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(ConstantInt.of(1), UniformInt.of(1, 4)));
        FeatureUtils.register(param0, LARGE_BASALT_COLUMNS, Feature.BASALT_COLUMNS, new ColumnFeatureConfiguration(UniformInt.of(2, 3), UniformInt.of(5, 10)));
        FeatureUtils.register(
            param0,
            BASALT_BLOBS,
        ...
        FeatureUtils.register(param0, GLOWSTONE_EXTRA, Feature.GLOWSTONE_BLOB);
        ...
        FeatureUtils.register(param0, CRIMSON_FOREST_VEGETATION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(var0, 8, 4));
        FeatureUtils.register(param0, CRIMSON_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(var0, 3, 1));
        ...
        FeatureUtils.register(param0, WARPED_FOREST_VEGETION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(var1, 8, 4));
        FeatureUtils.register(param0, WARPED_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(var1, 3, 1));
        FeatureUtils.register(
            param0, NETHER_SPROUTS, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(BlockStateProvider.simple(Blocks.NETHER_SPROUTS), 8, 4)
        );
        FeatureUtils.register(
            param0,
        ...
        FeatureUtils.register(param0, TWISTING_VINES, Feature.TWISTING_VINES, new TwistingVinesConfig(8, 4, 8));
        FeatureUtils.register(param0, TWISTING_VINES_BONEMEAL, Feature.TWISTING_VINES, new TwistingVinesConfig(3, 1, 2));
        FeatureUtils.register(param0, WEEPING_VINES, Feature.WEEPING_VINES);
        FeatureUtils.register(
            param0,
            PATCH_CRIMSON_ROOTS,
        ...
        FeatureUtils.register(param0, BASALT_PILLAR, Feature.BASALT_PILLAR);
        FeatureUtils.register(
            param0,
            SPRING_LAVA_NETHER,
            Feature.SPRING,
