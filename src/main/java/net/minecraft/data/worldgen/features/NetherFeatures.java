...
public class NetherFeatures {
        ...
        Feature.RANDOM_PATCH
            .configured(
                FeatureUtils.simplePatchConfiguration(
                    Feature.SIMPLE_BLOCK.configured(new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.CRIMSON_ROOTS)))
                )
            )
    );
    ...
    public static final ConfiguredFeature<SpringConfiguration, ?> SPRING_NETHER_CLOSED = FeatureUtils.register(
        ...
        Feature.SPRING.configured(new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 5, 0, ImmutableSet.of(Blocks.NETHERRACK)))
    );
    public static final ConfiguredFeature<SpringConfiguration, ?> SPRING_NETHER_OPEN = FeatureUtils.register(
        "spring_nether_open",
        Feature.SPRING.configured(new SpringConfiguration(Fluids.LAVA.defaultFluidState(), false, 4, 1, ImmutableSet.of(Blocks.NETHERRACK)))
    );
