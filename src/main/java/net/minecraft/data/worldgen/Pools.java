...
public class Pools {
    ...
    public static Holder<StructureTemplatePool> register(StructureTemplatePool param0) {
    ...
    public static Holder<StructureTemplatePool> bootstrap(Registry<StructureTemplatePool> param0) {
