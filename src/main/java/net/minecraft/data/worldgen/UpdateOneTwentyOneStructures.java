        ...
        param0.register(
            ...
            new JigsawStructure(
                Structures.structure(
                    var0.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS),
                    Arrays.stream(MobCategory.values())
                        .collect(
                            Collectors.toMap(
                                param0x -> param0x,
                                param0x -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedRandomList.create())
                            )
                        ),
                    GenerationStep.Decoration.UNDERGROUND_STRUCTURES,
                    TerrainAdjustment.BURY
                ),
                var1.getOrThrow(TrialChambersStructurePools.START),
                Optional.empty(),
                20,
