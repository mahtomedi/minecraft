...
public class SurfaceBuilders {
    ...
    private static <SC extends SurfaceBuilderConfiguration> ConfiguredSurfaceBuilder<SC> register(String param0, ConfiguredSurfaceBuilder<SC> param1) {
        return BuiltinRegistries.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, param0, param1);
    }
}
