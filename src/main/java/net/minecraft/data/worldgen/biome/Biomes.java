...
public abstract class Biomes {
    ...
    private static Biome register(int param0, ResourceKey<Biome> param1, Biome param2) {
        TO_NAME.put(param0, param1);
        return BuiltinRegistries.registerMapping(BuiltinRegistries.BIOME, param0, param1, param2);
    }

    public static ResourceKey<Biome> byId(int param0) {
        return TO_NAME.get(param0);
    }
