...
public class SurfaceRuleData {
    ...
    public static SurfaceRules.RuleSource overworld() {
        ...
        SurfaceRules.RuleSource var13 = SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.POWDER_SNOW_UNDER, 0.45, 0.58), POWDER_SNOW);
        SurfaceRules.RuleSource var14 = SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.POWDER_SNOW_SURFACE, 0.35, 0.6), POWDER_SNOW);
        ...
        SurfaceRules.ConditionSource var17 = SurfaceRules.noiseCondition(Noises.SURFACE, -0.909, -0.5454);
        SurfaceRules.ConditionSource var18 = SurfaceRules.noiseCondition(Noises.SURFACE, -0.1818, 0.1818);
        SurfaceRules.ConditionSource var19 = SurfaceRules.noiseCondition(Noises.SURFACE, 0.5454, 0.909);
