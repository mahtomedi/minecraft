...
public class OrePlacements {
    public static final PlacedFeature ORE_MAGMA = PlacementUtils.register(
        "ore_magma",
        OreFeatures.ORE_MAGMA.placed(commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(27), VerticalAnchor.absolute(36))))
    );
    ...
    public static final PlacedFeature ORE_REDSTONE = PlacementUtils.register(
        "ore_redstone",
        OreFeatures.ORE_REDSTONE.placed(commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15))))
    );
    ...
    public static final PlacedFeature ORE_DIAMOND = PlacementUtils.register(
        ...
        OreFeatures.ORE_DIAMOND_SMALL
            .placed(commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))))
    );
    public static final PlacedFeature ORE_DIAMOND_LARGE = PlacementUtils.register(
        "ore_diamond_large",
        OreFeatures.ORE_DIAMOND_LARGE
            .placed(rareOrePlacement(9, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))))
    );
    public static final PlacedFeature ORE_DIAMOND_BURIED = PlacementUtils.register(
        "ore_diamond_buried",
        OreFeatures.ORE_DIAMOND_BURIED
            .placed(commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))))
    );
    public static final PlacedFeature ORE_LAPIS = PlacementUtils.register(
        "ore_lapis",
        OreFeatures.ORE_LAPIS.placed(commonOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(32))))
    );
    ...
    public static final PlacedFeature ORE_INFESTED = PlacementUtils.register(
        "ore_infested",
        OreFeatures.ORE_INFESTED.placed(commonOrePlacement(14, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(63))))
    );
