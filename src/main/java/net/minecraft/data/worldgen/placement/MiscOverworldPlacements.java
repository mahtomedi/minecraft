...
public class MiscOverworldPlacements {
    ...
    public static final PlacedFeature FOREST_ROCK = PlacementUtils.register(
        "forest_rock",
        MiscOverworldFeatures.FOREST_ROCK.placed(CountPlacement.of(2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())
    );
    ...
    public static final PlacedFeature DESERT_WELL = PlacementUtils.register(
        ...
        MiscOverworldFeatures.DESERT_WELL
            .placed(RarityFilter.onAverageOnceEvery(1000), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())
    );
