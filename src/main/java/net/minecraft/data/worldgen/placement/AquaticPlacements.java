...
public class AquaticPlacements {
    ...
    public static final PlacedFeature SEA_PICKLE = PlacementUtils.register(
        ...
        AquaticFeatures.SEA_PICKLE
            .placed(RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome())
    );
    ...
    public static final PlacedFeature KELP_WARM = PlacementUtils.register(
        "kelp_warm",
        AquaticFeatures.KELP
            .placed(NoiseBasedCountPlacement.of(80, 80.0, 0.0), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_TOP_SOLID, BiomeFilter.biome())
    );
    ...
    public static List<PlacementModifier> seagrassPlacement(int param0) {
