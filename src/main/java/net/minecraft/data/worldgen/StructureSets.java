...
public interface StructureSets {
    ...
    static Holder<StructureSet> bootstrap(Registry<StructureSet> param0) {
        return param0.holders().iterator().next();
    }
    ...
    static Holder<StructureSet> register(ResourceKey<StructureSet> param0, Holder<Structure> param1, StructurePlacement param2) {
