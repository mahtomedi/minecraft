...
public class Features {
    ...
    public static final ConfiguredFeature<?, ?> DISK_GRAVEL = register(
        ...
        Feature.DISK
            .configured(
                new DiskConfiguration(Features.States.GRAVEL, UniformInt.of(2, 3), 2, ImmutableList.of(Features.States.DIRT, Features.States.GRASS_BLOCK))
            )
            .decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
    );
    public static final ConfiguredFeature<?, ?> DISK_SAND = register(
        ...
        Feature.DISK
            .configured(
                new DiskConfiguration(Features.States.SAND, UniformInt.of(2, 4), 2, ImmutableList.of(Features.States.DIRT, Features.States.GRASS_BLOCK))
            )
            .decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE)
            .count(3)
    );
    ...
    public static final ConfiguredFeature<?, ?> ORE_GOLD = register(
        "ore_gold",
        Feature.ORE.configured(new OreConfiguration(ORE_GOLD_TARGET_LIST, 9, 0.5F)).depthAverage(VerticalAnchor.absolute(-16), 48).squared().count(6)
    );
    ...
    public static final ConfiguredFeature<?, ?> ORE_DIAMOND = register(
        "ore_diamond",
        Feature.ORE.configured(new OreConfiguration(ORE_DIAMOND_TARGET_LIST, 8, 0.5F)).depthAverage(VerticalAnchor.bottom(), 80).squared().count(4)
    );
    ...
    public static final class Decorators {
        ...
        public static final ConfiguredDecorator<?> DARK_OAK_DECORATOR = HEIGHTMAP.decorated(
