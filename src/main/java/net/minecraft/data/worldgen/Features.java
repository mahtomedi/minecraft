...
public class Features {
    ...
    public static final ConfiguredFeature<?, ?> SMALL_DRIPSTONE_FEATURE = register(
        "small_dripstone",
        Feature.SMALL_DRIPSTONE.configured(new SmallDripstoneConfiguration(5, 10, 2, 0.2F)).range(-64, 60).squared().count(UniformInt.of(40, 80))
    );
    public static final ConfiguredFeature<?, ?> UNDERWATER_MAGMA = register(
        "underwater_magma",
        Feature.UNDERWATER_MAGMA.configured(new UnderwaterMagmaConfiguration(5, 1, 0.5F)).squared().range(-64, 40).count(UniformInt.of(4, 6))
    );
