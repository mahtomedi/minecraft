...
public class Structures {
            ...
            structure(
                ...
                Arrays.stream(MobCategory.values())
                    .collect(
                        Collectors.toMap(
                            param0 -> param0,
                            param0 -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedRandomList.create())
                        )
                    ),
                GenerationStep.Decoration.UNDERGROUND_DECORATION,
    ...
    public static Holder<? extends Structure> bootstrap(Registry<Structure> param0) {
        return MINESHAFT;
    }

    private static Structure.StructureSettings structure(
        TagKey<Biome> param0, Map<MobCategory, StructureSpawnOverride> param1, GenerationStep.Decoration param2, TerrainAdjustment param3
    ) {
        return new Structure.StructureSettings(biomes(param0), param1, param2, param3);
    }

    private static Structure.StructureSettings structure(TagKey<Biome> param0, GenerationStep.Decoration param1, TerrainAdjustment param2) {
        return structure(param0, Map.of(), param1, param2);
    }

    private static Structure.StructureSettings structure(TagKey<Biome> param0, TerrainAdjustment param1) {
        return structure(param0, Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, param1);
    }

    private static Holder<Structure> register(ResourceKey<Structure> param0, Structure param1) {
        return BuiltinRegistries.register(BuiltinRegistries.STRUCTURES, param0, param1);
    }

    private static HolderSet<Biome> biomes(TagKey<Biome> param0) {
        return BuiltinRegistries.BIOME.getOrCreateTag(param0);
    }
}
