...
public class Structures {
    ...
    public static final Holder<Structure> MINESHAFT = register(
        ...
        new MineshaftStructure(
            biomes(BiomeTags.HAS_MINESHAFT), Map.of(), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, false, MineshaftStructure.Type.NORMAL
        )
    );
    public static final Holder<Structure> MINESHAFT_MESA = register(
        BuiltinStructures.MINESHAFT_MESA,
        new MineshaftStructure(
            biomes(BiomeTags.HAS_MINESHAFT_MESA), Map.of(), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, false, MineshaftStructure.Type.MESA
        )
    );
    ...
    public static final Holder<Structure> SHIPWRECK = register(
        ...
        new ShipwreckStructure(biomes(BiomeTags.HAS_SHIPWRECK), Map.of(), GenerationStep.Decoration.SURFACE_STRUCTURES, false, false)
    );
