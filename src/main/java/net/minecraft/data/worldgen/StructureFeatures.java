...
public class StructureFeatures {
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> FORTRESS = register(
        ...
        StructureFeature.FORTRESS
            .configured(
                ...
                Map.of(
                    MobCategory.MONSTER, new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, NetherFortressFeature.FORTRESS_ENEMIES)
                )
            )
    );
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> BURIED_TREASURE = register(
        ...
        StructureFeature.BURIED_TREASURE.configured(new ProbabilityFeatureConfiguration(0.01F), BiomeTags.HAS_BURIED_TREASURE)
    );
    ...
    public static final Holder<ConfiguredStructureFeature<?, ?>> VILLAGE_SNOWY = register(
        ...
        StructureFeature.VILLAGE.configured(new JigsawConfiguration(SnowyVillagePools.START, 6), BiomeTags.HAS_VILLAGE_SNOWY, true)
    );
    public static final Holder<ConfiguredStructureFeature<?, ?>> VILLAGE_TAIGA = register(
        BuiltinStructures.VILLAGE_TAIGA,
        StructureFeature.VILLAGE.configured(new JigsawConfiguration(TaigaVillagePools.START, 6), BiomeTags.HAS_VILLAGE_TAIGA, true)
    );
    ...
    private static <FC extends FeatureConfiguration, F extends StructureFeature<FC>> Holder<ConfiguredStructureFeature<?, ?>> register(
        ResourceKey<ConfiguredStructureFeature<?, ?>> param0, ConfiguredStructureFeature<FC, F> param1
    ) {
