...
public class ProcessorLists {
    ...
    private static ImmutableList<StructureProcessor> register(String param0, ImmutableList<StructureProcessor> param1) {
        return BuiltinRegistries.register(BuiltinRegistries.PROCESSOR_LIST, param0, param1);
    }
}
