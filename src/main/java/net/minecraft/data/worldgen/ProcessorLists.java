...
public class ProcessorLists {
    ...
    public static void bootstrap(BootstapContext<StructureProcessorList> param0) {
        ...
        register(param0, TRAIL_RUINS_TOWER_TOP_ARCHAEOLOGY, List.of(trailsArchyLootProcessor(BuiltInLootTables.TRAIL_RUINS_ARCHAEOLOGY_COMMON, 2)));
    }

    private static CappedProcessor trailsArchyLootProcessor(ResourceLocation param0, int param1) {
            ...
            new RuleProcessor(
                List.of(
                    new ProcessorRule(
                        ...
                        new AppendLoot(param0)
                    )
                )
            ),
            ConstantInt.of(param1)
        );
    }
}
