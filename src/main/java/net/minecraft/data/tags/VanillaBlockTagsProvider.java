...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    public VanillaBlockTagsProvider(PackOutput param0, CompletableFuture<HolderLookup.Provider> param1) {
    ...
    protected void addTags(HolderLookup.Provider param0) {
        ...
        IntrinsicHolderTagsProvider.IntrinsicTagAppender<Block> var0 = this.tag(BlockTags.REPLACEABLE);
        param0.lookupOrThrow(Registries.BLOCK).filterElements(param0x -> param0x.defaultBlockState().canBeReplaced()).listElementIds().forEach(var0::add);
