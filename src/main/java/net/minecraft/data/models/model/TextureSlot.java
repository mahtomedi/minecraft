...
public final class TextureSlot {
    ...
    private static TextureSlot create(String param0) {
        return new TextureSlot(param0, null);
    }

    private static TextureSlot create(String param0, TextureSlot param1) {
        return new TextureSlot(param0, param1);
    }

    private TextureSlot(String param0, @Nullable TextureSlot param1) {
        this.id = param0;
        this.parent = param1;
    }
