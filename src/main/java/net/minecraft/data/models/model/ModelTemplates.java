...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = IntStream.range(0, 8)
        .mapToObj(param0 -> create("stem_growth" + param0, "_stage" + param0, TextureSlot.STEM))
        .toArray(param0 -> new ModelTemplate[param0]);
    ...
    private static ModelTemplate create(TextureSlot... param0) {
        return new ModelTemplate(Optional.empty(), Optional.empty(), param0);
    }

    private static ModelTemplate create(String param0, TextureSlot... param1) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + param0)), Optional.empty(), param1);
    }

    private static ModelTemplate createItem(String param0, TextureSlot... param1) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + param0)), Optional.empty(), param1);
    }

    private static ModelTemplate create(String param0, String param1, TextureSlot... param2) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + param0)), Optional.of(param1), param2);
    }
}
