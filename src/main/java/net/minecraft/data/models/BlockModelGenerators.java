...
public class BlockModelGenerators {
    ...
    public static final List<Pair<BooleanProperty, Function<ResourceLocation, Variant>>> MULTIFACE_GENERATOR = List.of(
        Pair.of(BlockStateProperties.NORTH, param0 -> Variant.variant().with(VariantProperties.MODEL, param0)),
        Pair.of(
            BlockStateProperties.EAST,
            param0 -> Variant.variant()
                    .with(VariantProperties.MODEL, param0)
    ...
    private static BlockStateGenerator createNorthWestMirroredCubeGenerator(
        ...
        ResourceLocation var0 = ModelTemplates.CUBE_NORTH_WEST_MIRRORED_ALL.create(param0, param2, param3);
        return createSimpleBlock(param0, var0);
    }
    ...
    private void createBrushableBlock(Block param0) {
                ...
                MultiVariantGenerator.multiVariant(param0)
                    .with(
                        PropertyDispatch.property(BlockStateProperties.DUSTED)
                            .generate(
                                param1 -> {
                                    String var0 = "_" + param1;
                                    ResourceLocation var1x = TextureMapping.getBlockTexture(param0, var0);
                                    return Variant.variant()
                                        .with(
                                            VariantProperties.MODEL,
                                            ModelTemplates.CUBE_ALL
                                                .createWithSuffix(param0, var0, new TextureMapping().put(TextureSlot.ALL, var1x), this.modelOutput)
                                        );
                                }
                            )
                    )
            );
        this.delegateItemModel(param0, TextureMapping.getBlockTexture(param0, "_0"));
    }
    ...
    private static PropertyDispatch.C4<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> configureDoorHalf(
        ...
        return param0.select(Direction.EAST, param1, DoorHingeSide.LEFT, false, Variant.variant().with(VariantProperties.MODEL, param2))
            ...
            .select(Direction.EAST, param1, DoorHingeSide.RIGHT, false, Variant.variant().with(VariantProperties.MODEL, param4))
            .select(
                Direction.SOUTH,
                param1,
                DoorHingeSide.RIGHT,
                false,
                Variant.variant().with(VariantProperties.MODEL, param4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                Direction.WEST,
                param1,
                DoorHingeSide.RIGHT,
                false,
                Variant.variant().with(VariantProperties.MODEL, param4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
            )
            .select(
                Direction.NORTH,
                param1,
                DoorHingeSide.RIGHT,
                false,
                Variant.variant().with(VariantProperties.MODEL, param4).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
            )
            .select(
                Direction.EAST,
                param1,
            ...
            .select(
                ...
                DoorHingeSide.RIGHT,
                true,
                Variant.variant().with(VariantProperties.MODEL, param5).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270)
            )
            .select(Direction.SOUTH, param1, DoorHingeSide.RIGHT, true, Variant.variant().with(VariantProperties.MODEL, param5))
            .select(
                Direction.WEST,
                param1,
                DoorHingeSide.RIGHT,
                true,
                Variant.variant().with(VariantProperties.MODEL, param5).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90)
            )
            .select(
                Direction.NORTH,
                param1,
                DoorHingeSide.RIGHT,
                true,
                Variant.variant().with(VariantProperties.MODEL, param5).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180)
            );
    }
    ...
    static BlockStateGenerator createCustomFence(
        Block param0, ResourceLocation param1, ResourceLocation param2, ResourceLocation param3, ResourceLocation param4, ResourceLocation param5
    ) {
        return MultiPartGenerator.multiPart(param0)
            ...
            .with(
                ...
                Variant.variant().with(VariantProperties.MODEL, param2).with(VariantProperties.UV_LOCK, false)
            )
            .with(
                Condition.condition().term(BlockStateProperties.EAST, true),
                Variant.variant().with(VariantProperties.MODEL, param3).with(VariantProperties.UV_LOCK, false)
            )
            .with(
                Condition.condition().term(BlockStateProperties.SOUTH, true),
                Variant.variant().with(VariantProperties.MODEL, param4).with(VariantProperties.UV_LOCK, false)
            )
            .with(
                Condition.condition().term(BlockStateProperties.WEST, true),
                Variant.variant().with(VariantProperties.MODEL, param5).with(VariantProperties.UV_LOCK, false)
            );
    }
    ...
    static BlockStateGenerator createFenceGate(
        Block param0, ResourceLocation param1, ResourceLocation param2, ResourceLocation param3, ResourceLocation param4, boolean param5
    ) {
        return MultiVariantGenerator.multiVariant(param0, Variant.variant().with(VariantProperties.UV_LOCK, param5))
    ...
    static BlockStateGenerator createPillarBlockUVLocked(Block param0, TextureMapping param1, BiConsumer<ResourceLocation, Supplier<JsonElement>> param2) {
        ResourceLocation var0 = ModelTemplates.CUBE_COLUMN_UV_LOCKED_X.create(param0, param1, param2);
        ResourceLocation var1 = ModelTemplates.CUBE_COLUMN_UV_LOCKED_Y.create(param0, param1, param2);
        ResourceLocation var2 = ModelTemplates.CUBE_COLUMN_UV_LOCKED_Z.create(param0, param1, param2);
        ResourceLocation var3 = ModelTemplates.CUBE_COLUMN.create(param0, param1, param2);
        return MultiVariantGenerator.multiVariant(param0, Variant.variant().with(VariantProperties.MODEL, var3))
            .with(
                PropertyDispatch.property(BlockStateProperties.AXIS)
                    .select(Direction.Axis.X, Variant.variant().with(VariantProperties.MODEL, var0))
                    .select(Direction.Axis.Y, Variant.variant().with(VariantProperties.MODEL, var1))
                    .select(Direction.Axis.Z, Variant.variant().with(VariantProperties.MODEL, var2))
            );
    }
    ...
    public void createHangingSign(Block param0, Block param1, Block param2) {
        TextureMapping var0 = TextureMapping.particle(param0);
        ResourceLocation var1 = ModelTemplates.PARTICLE_ONLY.create(param1, var0, this.modelOutput);
        this.blockStateOutput.accept(createSimpleBlock(param1, var1));
        this.blockStateOutput.accept(createSimpleBlock(param2, var1));
        this.createSimpleFlatItemModel(param1.asItem());
        this.skipAutoItemBlock(param2);
    }

    void createDoor(Block param0) {
        TextureMapping var0 = TextureMapping.door(param0);
        ResourceLocation var1 = ModelTemplates.DOOR_BOTTOM_LEFT.create(param0, var0, this.modelOutput);
        ResourceLocation var2 = ModelTemplates.DOOR_BOTTOM_LEFT_OPEN.create(param0, var0, this.modelOutput);
        ResourceLocation var3 = ModelTemplates.DOOR_BOTTOM_RIGHT.create(param0, var0, this.modelOutput);
        ResourceLocation var4 = ModelTemplates.DOOR_BOTTOM_RIGHT_OPEN.create(param0, var0, this.modelOutput);
        ResourceLocation var5 = ModelTemplates.DOOR_TOP_LEFT.create(param0, var0, this.modelOutput);
        ResourceLocation var6 = ModelTemplates.DOOR_TOP_LEFT_OPEN.create(param0, var0, this.modelOutput);
        ResourceLocation var7 = ModelTemplates.DOOR_TOP_RIGHT.create(param0, var0, this.modelOutput);
        ResourceLocation var8 = ModelTemplates.DOOR_TOP_RIGHT_OPEN.create(param0, var0, this.modelOutput);
        this.createSimpleFlatItemModel(param0.asItem());
        this.blockStateOutput.accept(createDoor(param0, var1, var2, var3, var4, var5, var6, var7, var8));
    }

    private void copyDoorModel(Block param0, Block param1) {
        ResourceLocation var0 = ModelTemplates.DOOR_BOTTOM_LEFT.getDefaultModelLocation(param0);
        ResourceLocation var1 = ModelTemplates.DOOR_BOTTOM_LEFT_OPEN.getDefaultModelLocation(param0);
        ResourceLocation var2 = ModelTemplates.DOOR_BOTTOM_RIGHT.getDefaultModelLocation(param0);
        ResourceLocation var3 = ModelTemplates.DOOR_BOTTOM_RIGHT_OPEN.getDefaultModelLocation(param0);
        ResourceLocation var4 = ModelTemplates.DOOR_TOP_LEFT.getDefaultModelLocation(param0);
        ResourceLocation var5 = ModelTemplates.DOOR_TOP_LEFT_OPEN.getDefaultModelLocation(param0);
        ResourceLocation var6 = ModelTemplates.DOOR_TOP_RIGHT.getDefaultModelLocation(param0);
        ResourceLocation var7 = ModelTemplates.DOOR_TOP_RIGHT_OPEN.getDefaultModelLocation(param0);
        this.delegateItemModel(param1, ModelLocationUtils.getModelLocation(param0.asItem()));
        this.blockStateOutput.accept(createDoor(param1, var0, var1, var2, var3, var4, var5, var6, var7));
    }
    ...
    private void copyTrapdoorModel(Block param0, Block param1) {
        ResourceLocation var0 = ModelTemplates.TRAPDOOR_TOP.getDefaultModelLocation(param0);
        ResourceLocation var1 = ModelTemplates.TRAPDOOR_BOTTOM.getDefaultModelLocation(param0);
        ResourceLocation var2 = ModelTemplates.TRAPDOOR_OPEN.getDefaultModelLocation(param0);
        this.delegateItemModel(param1, ModelLocationUtils.getModelLocation(param0.asItem()));
        this.blockStateOutput.accept(createTrapdoor(param1, var0, var1, var2));
    }
    ...
    private void createPitcherPlant() {
        Block var0 = Blocks.PITCHER_PLANT;
        this.createSimpleFlatItemModel(var0.asItem());
        ResourceLocation var1 = ModelLocationUtils.getModelLocation(var0, "_top");
        ResourceLocation var2 = ModelLocationUtils.getModelLocation(var0, "_bottom");
        this.createDoubleBlock(var0, var1, var2);
    }

    private void createPitcherCrop() {
        Block var0 = Blocks.PITCHER_CROP;
        this.createSimpleFlatItemModel(var0.asItem());
        PropertyDispatch var1 = PropertyDispatch.properties(PitcherCropBlock.AGE, BlockStateProperties.DOUBLE_BLOCK_HALF).generate((param1, param2) -> {
            return switch(param2) {
                case UPPER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(var0, "_top_stage_" + param1));
                case LOWER -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(var0, "_bottom_stage_" + param1));
            };
        });
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(var0).with(var1));
    }
    ...
    private void createCopperBulb(Block param0) {
        ResourceLocation var0 = ModelTemplates.CUBE_ALL.create(param0, TextureMapping.cube(param0), this.modelOutput);
        ResourceLocation var1 = this.createSuffixedVariant(param0, "_powered", ModelTemplates.CUBE_ALL, TextureMapping::cube);
        ResourceLocation var2 = this.createSuffixedVariant(param0, "_lit", ModelTemplates.CUBE_ALL, TextureMapping::cube);
        ResourceLocation var3 = this.createSuffixedVariant(param0, "_lit_powered", ModelTemplates.CUBE_ALL, TextureMapping::cube);
        this.blockStateOutput.accept(this.createCopperBulb(param0, var0, var2, var1, var3));
    }
        ...
        return MultiVariantGenerator.multiVariant(param0)
            .with(
                PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED)
                    .generate(
                        (param4x, param5) -> param4x
                                ? Variant.variant().with(VariantProperties.MODEL, param5 ? param4 : param2)
                                : Variant.variant().with(VariantProperties.MODEL, param5 ? param3 : param1)
                    )
            );
    }

    private void copyCopperBulbModel(Block param0, Block param1) {
        ResourceLocation var0 = ModelLocationUtils.getModelLocation(param0);
        ResourceLocation var1 = ModelLocationUtils.getModelLocation(param0, "_powered");
        ResourceLocation var2 = ModelLocationUtils.getModelLocation(param0, "_lit");
        ResourceLocation var3 = ModelLocationUtils.getModelLocation(param0, "_lit_powered");
        this.delegateItemModel(param1, ModelLocationUtils.getModelLocation(param0.asItem()));
        this.blockStateOutput.accept(this.createCopperBulb(param1, var0, var2, var1, var3));
    }
    ...
    private void createMuddyMangroveRoots() {
        TextureMapping var0 = TextureMapping.column(
        ...
        ResourceLocation var1 = ModelTemplates.CUBE_COLUMN.create(Blocks.MUDDY_MANGROVE_ROOTS, var0, this.modelOutput);
        this.blockStateOutput.accept(createAxisAlignedPillarBlock(Blocks.MUDDY_MANGROVE_ROOTS, var1));
    }

    private void createMangrovePropagule() {
        this.createSimpleFlatItemModel(Items.MANGROVE_PROPAGULE);
        Block var0 = Blocks.MANGROVE_PROPAGULE;
        PropertyDispatch.C2<Boolean, Integer> var1 = PropertyDispatch.properties(MangrovePropaguleBlock.HANGING, MangrovePropaguleBlock.AGE);
        ResourceLocation var2 = ModelLocationUtils.getModelLocation(var0);

        for(int var3 = 0; var3 <= 4; ++var3) {
            ResourceLocation var4 = ModelLocationUtils.getModelLocation(var0, "_hanging_" + var3);
            var1.select(true, var3, Variant.variant().with(VariantProperties.MODEL, var4));
            var1.select(false, var3, Variant.variant().with(VariantProperties.MODEL, var2));
        }

        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.MANGROVE_PROPAGULE).with(var1));
    }
    ...
    private void createCalibratedSculkSensor() {
        ResourceLocation var0 = ModelLocationUtils.getModelLocation(Blocks.CALIBRATED_SCULK_SENSOR, "_inactive");
        ResourceLocation var1 = ModelLocationUtils.getModelLocation(Blocks.CALIBRATED_SCULK_SENSOR, "_active");
        this.delegateItemModel(Blocks.CALIBRATED_SCULK_SENSOR, var0);
        this.blockStateOutput
            .accept(
    ...
    private void createSculkShrieker() {
        ResourceLocation var0 = ModelTemplates.SCULK_SHRIEKER.create(Blocks.SCULK_SHRIEKER, TextureMapping.sculkShrieker(false), this.modelOutput);
        ResourceLocation var1 = ModelTemplates.SCULK_SHRIEKER
            .createWithSuffix(Blocks.SCULK_SHRIEKER, "_can_summon", TextureMapping.sculkShrieker(true), this.modelOutput);
        this.delegateItemModel(Blocks.SCULK_SHRIEKER, var0);
        this.blockStateOutput
            .accept(MultiVariantGenerator.multiVariant(Blocks.SCULK_SHRIEKER).with(createBooleanModelDispatch(BlockStateProperties.CAN_SUMMON, var1, var0)));
    }
    ...
    private void createSnifferEgg() {
        ...
        Function<Integer, ResourceLocation> var0 = param0 -> {
            String var0x = switch(param0) {
    ...
    private void createMultiface(Block param0) {
        ...
        Condition.TerminalCondition var2 = Util.make(Condition.condition(), param1 -> MULTIFACE_GENERATOR.stream().map(Pair::getFirst).forEach(param2 -> {
        ...
        for(Pair<BooleanProperty, Function<ResourceLocation, Variant>> var3 : MULTIFACE_GENERATOR) {
            BooleanProperty var4 = var3.getFirst();
            Function<ResourceLocation, Variant> var5 = var3.getSecond();
            if (param0.defaultBlockState().hasProperty(var4)) {
                var1.with(Condition.condition().term(var4, true), var5.apply(var0));
                var1.with(var2, var5.apply(var0));
            }
        }
    ...
    private void createSculkCatalyst() {
        ResourceLocation var0 = TextureMapping.getBlockTexture(Blocks.SCULK_CATALYST, "_bottom");
        TextureMapping var1 = new TextureMapping()
            .put(TextureSlot.BOTTOM, var0)
        ...
        ResourceLocation var3 = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.SCULK_CATALYST, "", var1, this.modelOutput);
        ResourceLocation var4 = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.SCULK_CATALYST, "_bloom", var2, this.modelOutput);
        this.blockStateOutput
            .accept(
                MultiVariantGenerator.multiVariant(Blocks.SCULK_CATALYST)
                    .with(
                        PropertyDispatch.property(BlockStateProperties.BLOOM)
                            .generate(param2 -> Variant.variant().with(VariantProperties.MODEL, param2 ? var4 : var3))
                    )
            );
        this.delegateItemModel(Items.SCULK_CATALYST, var3);
    }
        ...
        Map.of(
            ...
            .forEach(
                (param2, param3) -> {
                    ...
                    var2.with(
                        var0x,
                        Variant.variant().with(VariantProperties.MODEL, var1).with(VariantProperties.Y_ROT, param3).with(VariantProperties.UV_LOCK, true)
                    );
    ...
    class BlockFamilyProvider {
        ...
        public BlockModelGenerators.BlockFamilyProvider donateModelTo(Block param0, Block param1) {
            ResourceLocation var0 = ModelLocationUtils.getModelLocation(param0);
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(param1, var0));
            BlockModelGenerators.this.delegateItemModel(param1, var0);
            this.skipGeneratingModelsFor.add(param1);
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider customFence(Block param0) {
            TextureMapping var0 = TextureMapping.customParticle(param0);
            ResourceLocation var1 = ModelTemplates.CUSTOM_FENCE_POST.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var2 = ModelTemplates.CUSTOM_FENCE_SIDE_NORTH.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var3 = ModelTemplates.CUSTOM_FENCE_SIDE_EAST.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var4 = ModelTemplates.CUSTOM_FENCE_SIDE_SOUTH.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var5 = ModelTemplates.CUSTOM_FENCE_SIDE_WEST.create(param0, var0, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createCustomFence(param0, var1, var2, var3, var4, var5));
            ResourceLocation var6 = ModelTemplates.CUSTOM_FENCE_INVENTORY.create(param0, var0, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.delegateItemModel(param0, var6);
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider customFenceGate(Block param0) {
            TextureMapping var0 = TextureMapping.customParticle(param0);
            ResourceLocation var1 = ModelTemplates.CUSTOM_FENCE_GATE_OPEN.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var2 = ModelTemplates.CUSTOM_FENCE_GATE_CLOSED.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var3 = ModelTemplates.CUSTOM_FENCE_GATE_WALL_OPEN.create(param0, var0, BlockModelGenerators.this.modelOutput);
            ResourceLocation var4 = ModelTemplates.CUSTOM_FENCE_GATE_WALL_CLOSED.create(param0, var0, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(param0, var1, var2, var3, var4, false));
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider fenceGate(Block param0) {
            ...
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createFenceGate(param0, var0, var1, var2, var3, true));
            return this;
        }
        ...
        private BlockModelGenerators.BlockFamilyProvider fullBlockVariant(Block param0) {
            ...
            ResourceLocation var1 = var0.create(param0, BlockModelGenerators.this.modelOutput);
            BlockModelGenerators.this.blockStateOutput.accept(BlockModelGenerators.createSimpleBlock(param0, var1));
            return this;
        }
        ...
        public BlockModelGenerators.BlockFamilyProvider generateFor(BlockFamily param0) {
            ...
            param0.getVariants().forEach((param0x, param1) -> {
                if (!this.skipGeneratingModelsFor.contains(param1)) {
    ...
    class WoodProvider {
        ...
        public BlockModelGenerators.WoodProvider logUVLocked(Block param0) {
            BlockModelGenerators.this.blockStateOutput
                .accept(BlockModelGenerators.createPillarBlockUVLocked(param0, this.logMapping, BlockModelGenerators.this.modelOutput));
            return this;
        }
    }
}
