...
public class ModelProvider implements DataProvider {
    ...
    public ModelProvider(DataGenerator param0) {
        this.blockStatePathProvider = param0.createPathProvider(DataGenerator.Target.RESOURCE_PACK, "blockstates");
        this.modelPathProvider = param0.createPathProvider(DataGenerator.Target.RESOURCE_PACK, "models");
    }
