...
public abstract class RealmsScrolledSelectionList extends RealmsGuiEventListener {
    ...
    public RealmsScrolledSelectionList(int param0, int param1, int param2, int param3, int param4) {
        this.proxy = new RealmsScrolledSelectionListProxy(this, param0, param1, param2, param3, param4);
    }
