...
public class BlockTags {
    private static TagCollection<Block> source = new TagCollection<>(param0 -> Optional.empty(), "", false, "");
    ...
    private static Tag<Block> bind(String param0) {
        return new BlockTags.Wrapper(new ResourceLocation(param0));
    }
    ...
    static class Wrapper extends Tag<Block> {
        ...
        public boolean contains(Block param0) {
