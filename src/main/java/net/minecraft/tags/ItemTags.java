...
public class ItemTags {
    private static TagCollection<Item> source = new TagCollection<>(param0 -> Optional.empty(), "", false, "");
    ...
    private static Tag<Item> bind(String param0) {
        return new ItemTags.Wrapper(new ResourceLocation(param0));
    }
    ...
    public static class Wrapper extends Tag<Item> {
        ...
        public boolean contains(Item param0) {
