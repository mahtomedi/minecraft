...
public interface ConfiguredStructureTags {
    ...
    private static TagKey<ConfiguredStructureFeature<?, ?>> create(String param0) {
        return TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation(param0));
    }
}
