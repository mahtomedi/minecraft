...
public class Advancement {
    ...
    public Advancement(
        ...
        if (param2 == null) {
            ...
            Component var2 = var0.deepCopy().withStyle(var1).append("\n").append(param2.getDescription());
            Component var3 = var0.deepCopy().withStyle(param1x -> param1x.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, var2)));
    ...
    public static class Builder {
        ...
        private Builder(
            @Nullable ResourceLocation param0, @Nullable DisplayInfo param1, AdvancementRewards param2, Map<String, Criterion> param3, String[][] param4
        ) {
