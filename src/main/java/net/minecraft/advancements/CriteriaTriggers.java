...
public class CriteriaTriggers {
    ...
    private static <T extends CriterionTrigger<?>> T register(T param0) {
        if (CRITERIA.containsKey(param0.getId())) {
            throw new IllegalArgumentException("Duplicate criterion id " + param0.getId());
        } else {
            CRITERIA.put(param0.getId(), param0);
            return param0;
        }
    }
