...
public class NetworkSummaryEvent extends Event {
    ...
    public NetworkSummaryEvent(String param0) {
        this.remoteAddress = param0;
    }
    ...
    public static final class SumAggregation {
        ...
        public SumAggregation(String param0) {
            this.event = new NetworkSummaryEvent(param0);
            this.event.begin();
        }

        public void trackSentPacket(int param0) {
            this.sentPackets.incrementAndGet();
            this.sentBytes.addAndGet((long)param0);
        }

        public void trackReceivedPacket(int param0) {
            this.receivedPackets.incrementAndGet();
            this.receivedBytes.addAndGet((long)param0);
        }
