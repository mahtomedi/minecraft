...
public class V2832 extends NamespacedSchema {
    ...
    public void registerTypes(Schema param0, Map<String, Supplier<TypeTemplate>> param1, Map<String, Supplier<TypeTemplate>> param2) {
        ...
        param0.registerType(false, References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST, () -> DSL.constType(namespacedString()));
        param0.registerType(
            false,
                                    ...
                                    () -> DSL.optionalFields(
                                            ...
                                            DSL.taggedChoiceLazy(
                                                ...
                                                ImmutableMap.of(
                                                    ...
                                                    () -> DSL.or(
                                                            DSL.fields("preset", References.MULTI_NOISE_BIOME_SOURCE_PARAMETER_LIST.in(param0)),
