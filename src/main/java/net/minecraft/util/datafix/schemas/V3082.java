...
public class V3082 extends NamespacedSchema {
    public V3082(int param0, Schema param1) {
        super(param0, param1);
    }
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema param0) {
        ...
        param0.register(var0, "minecraft:chest_boat", param1 -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(param0))));
        return var0;
    }
}
