...
public class ChunkStructuresTemplateRenameFix extends DataFix {
    ...
    public ChunkStructuresTemplateRenameFix(Schema param0, boolean param1) {
        super(param0, param1);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", var0, param0 -> param0.update(DSL.remainderFinder(), this::fixChildren));
    }

    private Dynamic<?> fixChildren(Dynamic<?> param0) {
        return param0.update("Children", param1 -> param0.createList(param1.asStream().map(param1x -> this.fixTag(param0, param1x))));
    }

    private Dynamic<?> fixTag(Dynamic<?> param0, Dynamic<?> param1) {
        String var0 = param0.get("id").asString("");
        if (RENAMES.containsKey(var0)) {
            Pair<String, ImmutableMap<String, String>> var1 = RENAMES.get(var0);
            if (var1.getFirst().equals(param1.get("id").asString(""))) {
                String var2 = param1.get("Template").asString("");
                param1 = param1.set("Template", param1.createString(var1.getSecond().getOrDefault(var2, var2)));
            }
        }
