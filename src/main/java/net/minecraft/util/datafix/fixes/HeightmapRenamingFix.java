...
public class HeightmapRenamingFix extends DataFix {
    ...
    private Dynamic<?> fix(Dynamic<?> param0) {
        Optional<? extends Dynamic<?>> var0 = param0.get("Heightmaps").get();
        if (!var0.isPresent()) {
            return param0;
        } else {
            Dynamic<?> var1 = var0.get();
            Optional<? extends Dynamic<?>> var2 = var1.get("LIQUID").get();
            if (var2.isPresent()) {
                var1 = var1.remove("LIQUID");
                var1 = var1.set("WORLD_SURFACE_WG", var2.get());
            }

            Optional<? extends Dynamic<?>> var3 = var1.get("SOLID").get();
            if (var3.isPresent()) {
            ...
            Optional<? extends Dynamic<?>> var4 = var1.get("LIGHT").get();
            if (var4.isPresent()) {
                var1 = var1.remove("LIGHT");
                var1 = var1.set("LIGHT_BLOCKING", var4.get());
            }

            Optional<? extends Dynamic<?>> var5 = var1.get("RAIN").get();
            if (var5.isPresent()) {
