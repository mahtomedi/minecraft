...
public class BlockStateData {
    ...
    public static Dynamic<?> upgradeBlockStateTag(Dynamic<?> param0) {
        int var0 = ID_BY_OLD.getInt(param0);
        if (var0 >= 0 && var0 < MAP.length) {
            Dynamic<?> var1 = MAP[var0];
            return var1 == null ? param0 : var1;
        } else {
            return param0;
        }
    }

    public static String upgradeBlock(String param0) {
        int var0 = ID_BY_OLD_NAME.getInt(param0);
        if (var0 >= 0 && var0 < MAP.length) {
            Dynamic<?> var1 = MAP[var0];
            return var1 == null ? param0 : var1.get("Name").asString("");
        } else {
            return param0;
        }
    }

    public static String upgradeBlock(int param0) {
        if (param0 >= 0 && param0 < MAP.length) {
            Dynamic<?> var0 = MAP[param0];
            return var0 == null ? "minecraft:air" : var0.get("Name").asString("");
        } else {
            return "minecraft:air";
        }
    }

    public static Dynamic<?> parse(String param0) {
        try {
            return new Dynamic<>(NbtOps.INSTANCE, TagParser.parseTag(param0.replace('\'', '"')));
        } catch (Exception var2) {
            LOGGER.error("Parsing {}", param0, var2);
