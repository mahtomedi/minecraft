                ...
                if (var0x.isPresent() && Objects.equals(var0x.get().getSecond(), "minecraft:banner")) {
                    ...
                    if (var2x.isPresent()) {
                        ...
                        if (var4x.isPresent()) {
                            ...
                            if (var7.get("Base").asNumber().isPresent()) {
                                var1x = var1x.set("Damage", var1x.createShort((short)(var7.get("Base").asInt(0) & 15)));
                                Optional<? extends Dynamic<?>> var8 = var6.get("display").get();
                                if (var8.isPresent()) {
                                    Dynamic<?> var9 = var8.get();
                                    if (Objects.equals(
                                        var9, var9.emptyMap().merge(var9.createString("Lore"), var9.createList(Stream.of(var9.createString("(+NBT"))))
                                    )) {
