...
public class EntityTheRenameningFix extends SimplestEntityRenameFix {
    ...
    public EntityTheRenameningFix(Schema param0, boolean param1) {
        super("EntityTheRenameningBlock", param0, param1);
    }

    @Override
    protected String rename(String param0) {
        if (param0.startsWith("minecraft:bred_")) {
            param0 = "minecraft:" + param0.substring("minecraft:bred_".length());
        }
