...
public enum ConnectionProtocol {
    ...
    private ConnectionProtocol(String param0, ConnectionProtocol.ProtocolBuilder param1) {
        this.id = param0;
        this.flows = param1.buildCodecs(this);
    }

    @VisibleForDebug
    public Int2ObjectMap<Class<? extends Packet<?>>> getPacketsByIds(PacketFlow param0) {
        return this.flows.get(param0).packetsByIds();
    }
    ...
    public ConnectionProtocol.CodecData<?> codec(PacketFlow param0) {
        return this.flows.get(param0);
    }
    ...
    public static class CodecData<T extends PacketListener> implements BundlerInfo.Provider {
        ...
        public CodecData(ConnectionProtocol param0, PacketFlow param1, ConnectionProtocol.PacketSet<T> param2) {
            this.protocol = param0;
            this.flow = param1;
            this.packetSet = param2;
        }
        ...
        public int packetId(Packet<?> param0) {
            return this.packetSet.getId(param0.getClass());
        }
        ...
        Int2ObjectMap<Class<? extends Packet<?>>> packetsByIds() {
            Int2ObjectMap<Class<? extends Packet<?>>> var0 = new Int2ObjectOpenHashMap<>();
            this.packetSet.classToId.forEach((param1, param2) -> var0.put(param2.intValue(), param1));
            return var0;
        }

        @Nullable
        public Packet<?> createPacket(int param0, FriendlyByteBuf param1) {
            return this.packetSet.createPacket(param0, param1);
        }

        public boolean isValidPacketType(Packet<?> param0) {
            return this.packetSet.isKnownPacket(param0.getClass());
        }
    }

    static class PacketSet<T extends PacketListener> {
        private static final Logger LOGGER = LogUtils.getLogger();
        final Object2IntMap<Class<? extends Packet<? super T>>> classToId = Util.make(new Object2IntOpenHashMap<>(), param0 -> param0.defaultReturnValue(-1));
        ...
        public <P extends Packet<? super T>> ConnectionProtocol.PacketSet<T> addPacket(Class<P> param0, Function<FriendlyByteBuf, P> param1) {
        ...
        public boolean isKnownPacket(Class<?> param0) {
            return this.classToId.containsKey(param0) || this.extraClasses.contains(param0);
        }

        @Nullable
        public Packet<?> createPacket(int param0, FriendlyByteBuf param1) {
            Function<FriendlyByteBuf, ? extends Packet<? super T>> var0 = this.idToDeserializer.get(param0);
    ...
    static class ProtocolBuilder {
        ...
        public Map<PacketFlow, ConnectionProtocol.CodecData<?>> buildCodecs(ConnectionProtocol param0) {
            Map<PacketFlow, ConnectionProtocol.CodecData<?>> var0 = new EnumMap<>(PacketFlow.class);

            for(PacketFlow var1 : PacketFlow.values()) {
                ConnectionProtocol.PacketSet<?> var2 = this.flows.get(var1);
                if (var2 == null) {
                    throw new IllegalStateException("Missing packets for flow " + var1 + " in protocol " + param0);
                }

                var0.put(var1, new ConnectionProtocol.CodecData<>(param0, var1, var2));
            }
