...
public class ClientboundSoundEntityPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundSoundEntityPacket(Holder<SoundEvent> param0, SoundSource param1, Entity param2, float param3, float param4, long param5) {
        this.sound = param0;
        this.source = param1;
    ...
    public ClientboundSoundEntityPacket(FriendlyByteBuf param0) {
        this.sound = param0.readById(BuiltInRegistries.SOUND_EVENT.asHolderIdMap(), SoundEvent::readFromNetwork);
    ...
    public void write(FriendlyByteBuf param0) {
        param0.writeId(BuiltInRegistries.SOUND_EVENT.asHolderIdMap(), this.sound, (param0x, param1) -> param1.writeToNetwork(param0x));
